...
$sql_consulta="select * from base_gestao where status_tp <> '3' and $novavar2 ORDER BY termino_efetivo ASC";
...
echo "<script type=\"text/javascript\">
      document.location.replace('../../tp/gestao/pedidos_pendentes_sup.php');
	  </script>";
        exit;
?>
</body>
