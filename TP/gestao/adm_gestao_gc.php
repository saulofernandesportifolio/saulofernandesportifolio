   ...
   <?php include("../../tp/menu.php") ?>
     ...
     <div id="caixa" >
        <div id="conteudo" >
            ...
            <form action="carregar_base_gestao_gc.php"  method="post" enctype="multipart/form-data" name="form1">
                
                <table id="table_conteudo"  align="center" border="0">
                             
                	<tr>
                        <td id="t_td">* Selecionar Base GC gestão:</td>
                         </tr>
                         <tr>
                         <td>
                        ...
                        <td><a href="../Planilhas/modelo/Modelo_base_GC_Gestao.zip">Modelo da base GC</a></td>
                        <td></td>
                	</tr>
