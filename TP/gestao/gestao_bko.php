    ...
    <div id="caixa" style="height:610px;">
        ...
        <div id="conteudo" >
            ...
            <form action="gestao_update_cadastro.php" method="post">
			 ...
			 if ($acao == ''){
			     echo "<input name='acao' type='text'  class='input' maxlength='1010'>";
			   }else echo "<input name='acao' type='text' readonly='readonly' class='input' value='$acao' maxlength='100'>";
			?>
             </td>
			 ...
			 if ($status == ''){
                echo "
				<select name='status' class='combo_padrao' >
				<option value='Já cadastrado'>Já cadastrado</option>
				<option value='Login criado'>Login criado</option>
				<option value='Nenhum registro encontrado'>Nenhum registro encontrado</option>
				</select>
				";
			   }else echo "<input name='status' type='text' readonly='readonly' class='input' value='$status' maxlength='100'>";
			?>
             </td>
             </tr>
			...
			?>
			 ...
			 <?php 
			if ($gc == ''){
               echo "<input name='gc' type='text'  class='input'>";
			   }else echo "<input name='gc' type='text' readonly='readonly' class='input' value='$gc'>";
				?>
             </td>
             </tr>
			...
			if ($login_gestao == ''){
			 ...
			 <?php 
			 if ($senha == ''){
                echo "<input name='senha' type='text'  class='input' value='1234' maxlength='10'>";
             ...
             <td colspan="3"	>
			<textarea name="comentario_antigo" readonly="" cols="56" style="width:470" rows="3">
			<?php echo $comentario; ?>
            </textarea>
            </td>
            </tr>
            ...
            <option value="4">Erro Sistemico</option>
