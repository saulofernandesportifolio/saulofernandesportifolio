...
//Testa se o perfil está correto.
	...
	if($_SESSION["carregar_base_gestao"] == 0){  
   ...
   <?php include("../../tp/menu.php") ?>
     ...
     <div id="caixa" >
        <div id="conteudo" >
            ...
            <form action="carregar_base_gestao.php"  method="post" enctype="multipart/form-data" name="form1">
                
                <table id="table_conteudo"  align="center" border="0">
                   	<tr>
                        <td id="t_td">* Selecionar Base Gestão a ser Carregada:</td>
                        </tr>
                        <tr>
                        <td>
                  ...
                  <tr>
                        <td><a href="../Planilhas/modelo/Modelo_base_Gestao.zip">Modelo da base Gestão</a></td>                       <td></td>
                  </tr>
