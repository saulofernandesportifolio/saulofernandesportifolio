...
<div id="principal">
   ...
   include "../conexao.php";
	...
	$data_dia= date("y/m/d"); 
	?>
<form name="form1" method="post" action="retornar_para_visao_gestao.php">
...
<font color="#333333" size="2" face="Arial, Helvetica, sans-serif">Data Final</font>:</td>
 ...
 <td><input type="text" name="numero_pedido" size="10" maxlength="20" /></td>
 </tr>
...
<tr bordercolor="#FFFFFF"> 
 ...
 <td>
     <?php
					...
					$query= "SELECT * FROM usuarios WHERE operador_gestao = 1 and bi <> 1 order by nome";
