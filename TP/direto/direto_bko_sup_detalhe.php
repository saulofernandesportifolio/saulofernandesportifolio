       ...
       <div id="conteudo">        
            ...
            <form name="formulario" action="rever_direto_valida.php" method="post">
                ...
                <table id="table_conteudo"  align="center" border="0">
					...
					include "../../tp/conexao.php";
					$query= "SELECT * FROM funcionarios_emp WHERE tipo = 'Bko' ORDER BY nome";
                	...
                	<tr>
               		...
               		<tr>
                       <td id="t_td">Analista da atividade:</td>
                        <td colspan="3"><span id="spryselect7">                   		
                    <?php
                    if  ($analista_da_atividade == ""){ 
					$analista_da_atividade = 'Selecione';                 		
					echo "<select name='analista_da_atividade' class='combobox_padrao_grande'>";
                    echo "<option  value=$analista_da_atividade>$analista_da_atividade</option>";
					//seleciona a base de dados para uso
					include "../../tp/conexao.php";
					$query= "SELECT * FROM funcionarios_emp WHERE tipo = 'Bko' ORDER BY nome";
                    $result = mysql_query($query) or die (mysql_error());
					...
					echo "</select>";                   
					}else echo "<input name='analista_da_atividade' type='text'readonly='readonly' value='$analista_da_atividade' class='combobox_padrao_grande' maxlength='20'>"
					
					?>
                    
                    <br><span class="selectInvalidMsg">Selecione um analista válido.</span></span>
...
var spryselect7 = new Spry.Widget.ValidationSelect("spryselect7", {invalidValue:"Selecione", isRequired:false});
