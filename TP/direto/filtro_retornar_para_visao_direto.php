...
<div id="principal">
   ...
   include "../conexao.php";
	...
	$data_dia= date("y/m/d"); 
	?>
<form name="form1" method="post" action="retornar_para_visao_direto.php">
...
<p>&nbsp;</p>
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td width="74%"><p align="justify"><font color="#003366">
        ...
        <option value="regional='Sul' OR regional='SP' OR regional='CO/N' OR regional='Leste' OR regional='Norte' OR regional='NE' OR regional='MG'" selected="selected">Todos</option>
        <option value="regional='Sul'">SUL</option>
        <option value="regional='SP'">SP</option>
		<option value="regional='CO/N'">CO</option>
...
<!-- Inserido em 07/10/2013 por solicitação via chamado (nº 100)-->
  <tr bordercolor="#FFFFFF">
    <td height="24"><font color="#333333" size="2" face="Arial, Helvetica, sans-serif">Status:</font></td>
    <td><p align="justify"><font color="#003366"></font><font color="#666666" size="2" face="Georgia, Times New Roman, Times, serif">
      <select name="disc_status_tp" id="disc_status_tp">
        <option value="disc_status_tp='Aberta' OR disc_status_tp='Em Tratamento' OR disc_status_tp='Tratado'" selected="selected">Todos</option>
        <option value="disc_status_tp='Aberta'">Aberta</option>
        <option value="disc_status_tp='Tratando'">Em Tratamento</option>
         <option value="disc_status_tp='Tratado'">Tratado</option>
         </select>
      </font><font color="#003366">
...
<tr bordercolor="#FFFFFF"> 
 ...
 <td>
     <?php
					...
					$query= "SELECT * FROM usuarios WHERE operador_direto = 1 and bi <> 1";
