...
//echo $login;
$sql_verifca = "SELECT * FROM ilha_reversao_direto_bko WHERE fila=2 and usuario='$login' ORDER BY criado_em ASC";
...
{       
		...
		document.location.replace('../../tp/direto/direto_filtro.php');
		</script>";
        exit;
}
$sql_pedidos = "SELECT * FROM ilha_reversao_direto_bko WHERE fila=2 and usuario='$login' ORDER BY criado_em ASC";
