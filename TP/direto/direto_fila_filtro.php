...
{
echo "<script>alert('Nenhuma regional selecionada.'); document.location.replace('../../tp/direto/direto_filtro.php'); </script>\n";
exit;
}
//Regional
$nome = $_SESSION["nome"];
...
$sql_consulta="UPDATE ilha_reversao_direto_bko SET fila = 2,data_tramite ='$data_dia' ,usuario = '$login2', nome2 ='$nome', tramite = 'Tratando', turno = '$turno' WHERE (fila = 1) and ($novavar2) and ($novavar3)ORDER BY criado_em ASC";
...
echo "<script type=\"text/javascript\">document.location.replace('../../tp/direto/pedidos_direto_bko.php');
		</script>";
        exit;
