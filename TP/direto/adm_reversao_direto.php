...
//Testa se o perfil está correto.
	...
	if($_SESSION["carrega_base_direto"] == 0){  
   ...
   <?php include("../../tp/menu.php") ?>
     ...
     <div id="caixa" >
        <div id="conteudo" >
            ...
            <form action="carregar_base_direto.php"  method="post" enctype="multipart/form-data" name="form1">
                
                <table id="table_conteudo"  align="center" border="0">
                             
                	<tr>
                        <td id="t_td">* Selecionar Base direto a ser Carregada:</td>
                         </tr>
                         <tr>
                         <td>
                     ...
                     <td><a href="../../tp/planilhas/modelo/modelo_base_direto.zip">Modelo de planilha</a></td>
                        <td></td>
                </tr>
                <tr align="left">
                    	<td colspan="1">
