...
<div id="principal">
   ...
   include "../conexao.php";
	...
	$data_dia= date("y/m/d"); 
	?>
<form name="form1" method="post" action="exporta_base.php" >
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td><p align="justify"><font color="#003366"></font><font color="#666666" size="2" face="Georgia, Times New Roman, Times, serif">
      <select name="tipodata" id="tipodata">
        ...
        <option value="dt_entrada">Data entrada</option>
        <option value="dt_retorno2">Data retorno</option>
        <option value="dt_atualizacao">Data atualização</option>
      </select>
