...
$consulta = "SELECT DISTINCT bc.id_contestacao, 
                            bc.n_pedido, 
                            bc.revisao,
                            ...
                            cop.turno as ds_turno_tratamento,
                            ...
                            CASE WHEN bc.usuario_att IS NULL THEN ' ' WHEN bc.usuario_att THEN b.nome END as ds_usuario_att,                         
                            ctp.item as ds_tp_pedido,
                            bc.reanalize_completa, 
                            bc.parecer as Parecer_do_colaborador, 
                            bc.texto as Retorno_do_email,
                            bc.tipo_contestado,
                            bc.canal
                    ...
                    WHERE cqc.id  = bc.qtd_contestacoes
                      ...
                      AND (b.id    = bc.usuario_att OR bc.usuario_att IS NULL)
...
if($num == 0){
   ...
   if($resultado==true){
      ...
      $myArr=array( $linha['n_pedido'],
                    ...
                    $linha['parecer'],
                    $linha['texto'],
                    $linha['tipo_contestado'],
                    $linha['ds_usuario_att'],
                    $linha['dt_atualizacao'],
                    $linha['ds_turno_tratamento'],
                    $linha['canal']
	 );
         $excel->writeLine($myArr);
     }
