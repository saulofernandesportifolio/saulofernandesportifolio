...
<div id="principal">
    ...
    <div id="caixa">
      <div id="conteudo">   
        ...
        <form action="cadastro_contestacao.php" method="POST">  
        <div align="center">
            Numero do pedido:<br />
            <input onkeyup="valida(this, 'pedido');pesquisa();" id="n_pedido" name="n_pedido" />
        </div>
        <p><strong>Pedidos contestados:</strong></p>
