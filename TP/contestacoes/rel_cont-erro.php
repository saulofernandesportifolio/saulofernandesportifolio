   ...
   <?php 
    ...
    <div id="caixa" style="height:460px;">
        <div id="conteudo">
            ...
            <center><font><strong>Resumo de contestações por erro</strong></font></center>
            <?php
                $sql = 'call pivotwizard("cme.item", "c.item", "1", "base_contestacoes bc, cont_contestacao c, cont_motivos_erro cme", "bc.contestacao=c.id AND bc.motivo=cme.id");';
