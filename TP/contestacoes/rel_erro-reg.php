   ...
   <?php 
    ...
    <div id="caixa" style="height:460px;">
        <div id="conteudo">
            ...
            <?php
                $sql = 'call pivotwizard("cme.item", "cur.regional", "1", "base_contestacoes bc, cont_motivos_erro cme, cont_uf_regional cur", "bc.motivo=cme.id AND bc.regional=cur.item");';
