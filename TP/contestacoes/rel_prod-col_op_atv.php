...
<div id="principal">
   ...
   <?php 
    ...
    <div id="caixa" style="height:460px;">
        ...
        $sql ='call pivotwizard("u.nome", "date_format(bc.data_do_recebimento,\'%d/%M\')", "1", "base_contestacoes_atividades bc, usuarios u","bc.analista_contestacao = \''."$user".'\' and u.id = \''."$user".'\' and bc.data_do_recebimento like \'%'."$dt_filtro".'%\' ");';
