   ...
   <?php 
    ...
    <div id="caixa" style="height:460px;">
        <div id="conteudo">
            ...
            <center><font><strong>Resumo de erros por regional</strong></font></center>
            <?php
            mysql_query("SET lc_time_names = 'pt_BR';");
                $sql = 'call pivotwizard("cme.item", "cur.regional", "1", "base_contestacoes_atividades bc, cont_motivos_erro_input cme, cont_uf_regional cur", "bc.tipo2=cme.id AND bc.regional=cur.item");';
