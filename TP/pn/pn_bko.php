   ...
   <?php include("../../tp/menu.php") ?>
    ...
    <div id="caixa" >
        ...
        <div id="conteudo" >
            ...
            <form action="pn_valida_Portabilidade.php?id=<?php echo "$id"?>" method="post">
                ...
                <tr>
                     ...
                     <tr>
                      ...
                      <?php      if( $tratamento <> "Corrigido" and  $tratamento <> "Em tratamento" ){
                        ...
                        <tr>
                        <td></td>
                      <td colspan="3"><input name="enviar" type="submit" value="Enviar" class="botao_padrao">
               		  <input name="limpar" type="reset" value="Limpar" class="botao_padrao">
                      <input type="button" name="Submit2" value="Voltar" class="botao_padrao" onClick="javascript: history.go(-1);"></td>
