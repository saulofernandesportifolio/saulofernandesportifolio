...
$sql1 = "SELECT * FROM controle_pn_bko WHERE id_pn = '$id'";
...
?>
    ...
    <form name="form1" method="post" action="retornar_para_visao_pn3.php">
    ...
    <input name="login" type="hidden"  value="<?php echo $_SESSION["login"];?>" />
	   ...
	   <table bgcolor="D6CA98" align="left" border="0">
        ...
        <td id="t_td" width="4%"><strong><font color="#000000" size="2">
...
$sql = "SELECT * FROM controle_pn_bko WHERE id_pn = '$id' ORDER BY data_inicial DESC";
...
//Pesquisa e retorna os campos declarado nas variáveis.
		...
		while ($dado=mysql_fetch_array($acao))
			{
              ...
              <td> 
             <input name="ling[]" type="checkbox" id="ling[]" value="<?php echo "$id_pn" ?>" checked readonly="True">
              </td>
      ...
      <td></td>
		...
		$turno2 ="0";
		?>
		"window.location='retornar_para_visao_pn.php?regional=<?php echo $regional ?>&tramite=<?php echo $tramite?>&turno2=<?php echo $turno2 ?>'"/><input type="submit" name="Submit" value="Retornar" />
