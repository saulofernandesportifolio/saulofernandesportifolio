...
<div id="principal">
   ...
   include "../conexao.php";
	...
	$data_dia= date("y/m/d"); 
	?>
<form name="form1" method="post" action="gerar_excel_pn.php">
...
<p>&nbsp;</p>
  ...
  <tr bordercolor="#FFFFFF"> 
      <td colspan="2"> 
        <div align="center">
      <hr noshade="noshade" />
          <font color="#000000" size="2" face="Arial, Helvetica, sans-serif" class="regra2"><strong>FILTRO PN</strong></font> 
          <hr noshade="noshade" />
    </div></td>
  </tr>
     <tr bordercolor="#FFFFFF"> 
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td width="74%"><p align="justify"><font color="#003366">
        ...
        <option value="regional='Sul' OR regional='SP' OR regional='CO' OR regional='Leste' OR regional='Norte' OR regional='NE' OR regional='MG' OR regional='VPE'" selected="selected">Todos</option>
        ...
        <option value="regional='VPE'">VPE</option>
        </select>
      </font></p></td>
  </tr>
  <tr bordercolor="#FFFFFF">
...
$filename = '../../TP/bi/relatorios/Base_PN.xls';
