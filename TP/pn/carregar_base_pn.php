...
<html>
<head>
<title>TQ - Tramite Qualidade</title>
...
$sql_valida2 = "DELETE FROM controle_pn_bko WHERE status_pedido ='Concluído Manualmente' OR status_pedido ='Portabilidade Negada' OR status_pedido ='Erro Criação Conta Atlys' OR status_pedido = 'Erro Criação Cliente Atlys' OR status_pedido ='Concluído' OR status_pedido ='Em trâmite' OR status_pedido ='Cancelado SEFAZ' OR status_pedido ='Validando'";
$acao_valida2 = mysql_query($sql_valida2) or die (mysql_error());
  ...
  $sql_valida2="UPDATE controle_pn_bko SET canal ='Tele - Vendas' WHERE codigo_adabas like '129%' or codigo_adabas  like '128%'"; 
 $acao_valida2 = mysql_query($sql_valida2) or die (mysql_error());	
 
$sql_atualiza11="UPDATE controle_pn_bko, carteira_vpe SET controle_pn_bko.canal = 'VPE' WHERE controle_pn_bko.codigo_adabas = carteira_vpe.carteira";
$sql_atu11 = "$sql_atualiza11";
//echo $sql_atu;
$acao_vpe11 = mysql_query($sql_atu11) or die (mysql_error()); 
