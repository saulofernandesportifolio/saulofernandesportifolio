...
$sql_verifca = "SELECT * FROM controle_pn_bko WHERE fila = 2 and login = '$login' ORDER BY data_inicial ASC";
...
{       
		...
		document.location.replace('../../tp/pn/pn_filtro.php');
		</script>";
        exit;
}
		
$sql_pedidos = "SELECT * FROM controle_pn_bko WHERE fila = 2 and login = '$login' ORDER BY data_inicial ASC";
