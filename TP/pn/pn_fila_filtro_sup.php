...
{
echo "<script>alert('Nenhuma erro selecionado.'); document.location.replace('../../tp/pn/pn_filtro_sup.php'); </script>\n";
exit;
}
if (empty($_POST["regional"]))
{
echo "<script>alert('Nenhuma regional selecionada.'); document.location.replace('../../tp/pn/pn_filtro_sup.php'); </script>\n";
exit;
}
...
$sql_consulta="SELECT * FROM controle_pn_bko WHERE ($novavar2) and ($novavar) and ($novavar3) ORDER BY data_inicial";
...
echo "<script type=\"text/javascript\">
       document.location.replace('../../tp/pn/pedidos_pn_bko_sup.php');
 		</script>";
        exit;
?>
</body>
