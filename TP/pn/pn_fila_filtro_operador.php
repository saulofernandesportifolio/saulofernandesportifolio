...
$sql_consulta="SELECT *  FROM controle_pn_bko WHERE (fila = 2) and (login ='$login')and ($novavar2) and ($novavar) and ($novavar3) ORDER BY data_inicial";
...
echo "<script type=\"text/javascript\">
       document.location.replace('../../tp/pn/pedidos_pn_bko_operador.php');
 		</script>";
        exit;
