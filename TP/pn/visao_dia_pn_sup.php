...
set_time_limit($tempo);
  ...
  include("../../tp/conexao.php");
  $atv_op2="SELECT * FROM controle_pn_bko WHERE data_tramite2 ='$dt_dia'";
...
?>
           ...
           <p id="p_padrao" align="center">Visão Pn Dia: <?php echo $dt_dia2 ?></p>
            <hr width="104%">       
             <?php
			 //tabela por regional - inicio
			 
						include("../../tp/conexao.php");
				$atv_op="SELECT * FROM controle_pn_bko WHERE data_tramite2 ='$dt_dia'";
               ...
               $atv_op="SELECT COUNT(numero_pedido)as numero_pedido,data_inicial,login,disc_status_tp,regional FROM controle_pn_bko WHERE data_tramite2 = '$dt_dia' GROUP BY regional";
                        $acao_op=mysql_query($atv_op,$conecta);
		...
		while ($dado= mysql_fetch_array($acao_op))
				...
				$atv_op="SELECT * FROM controle_pn_bko WHERE data_tramite2 ='$dt_dia' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(numero_pedido)as numero_pedido,data_inicial,login,disc_status_tp,status_pedido FROM controle_pn_bko WHERE data_tramite2 = '$dt_dia' GROUP BY status_pedido";
                        $acao_op=mysql_query($atv_op,$conecta);
			  ...
			  //tabela erro - inicio
				...
				$atv_op="SELECT * FROM controle_pn_bko WHERE data_tramite2 ='$dt_dia' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(numero_pedido)as numero_pedido,data_inicial,login,disc_status_tp,erro FROM controle_pn_bko WHERE data_tramite2 = '$dt_dia' GROUP BY erro";
                        $acao_op=mysql_query($atv_op,$conecta);
			  ...
			  //tabela por disc_status_tp (tipo)- inicio
				...
				$atv_op="SELECT * FROM controle_pn_bko WHERE data_tramite2 ='$dt_dia' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(numero_pedido)as numero_pedido,data_inicial,login,disc_status_tp FROM controle_pn_bko WHERE data_tramite2 = '$dt_dia' GROUP BY disc_status_tp";
                        $acao_op=mysql_query($atv_op,$conecta);
			  ...
			  //tabela por tramite- inicio
				...
				$atv_op="SELECT * FROM controle_pn_bko WHERE data_tramite2 = '$dt_dia' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(numero_pedido)as numero_pedido,data_inicial,login,disc_status_tp,tramite FROM controle_pn_bko WHERE data_tramite2 = '$dt_dia' GROUP BY tramite";
                        $acao_op=mysql_query($atv_op,$conecta);
		...
		while ($dado= mysql_fetch_array($acao_op))
			...
			//tabela por operador - inicio
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(numero_pedido)as numero_pedido, regional,login,disc_status_tp,data_inicial,tramite,nome2,data_tramite2,turno FROM controle_pn_bko WHERE data_tramite2 = '$dt_dia' and tramite = 'Tratando' or data_tramite2 = '$dt_dia' and tramite = 'Tratado' or data_tramite2 = '$dt_dia' and tramite = 'Aguardando' GROUP BY login, disc_status_tp DESC";
                        $acao_op=mysql_query($atv_op,$conecta);
