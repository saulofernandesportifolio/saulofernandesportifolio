...
<div id="principal">
   ...
   <?php include("../../tp/menu.php") ?>
    ...
    <div id="caixa">
      ...
      <div id="conteudo">
            ...
            <p id="p_padrao">Usuário: <?php echo $nome; ?>.</p><br>
   ...
   include "../conexao.php";
	...
	$data_dia= date("y/m/d"); 
	?>
<form name="form1" method="post" action="gerar_excel_treinamento.php">
...
<p>&nbsp;</p>
  ...
  <tr bordercolor="#FFFFFF"> 
      <td colspan="2"> 
        <div align="center">
      <hr noshade="noshade" />
          <font color="#000000" size="2" face="Arial, Helvetica, sans-serif" class="regra2"><strong>FILTRO TREINAMENTO</strong></font> 
          <hr noshade="noshade" />
    </div></td>
  </tr>
     <tr bordercolor="#FFFFFF"> 
   ...
   <tr bordercolor="#FFFFFF">
    <td height="24"><font color="#333333" size="2" face="Arial, Helvetica, sans-serif">Planilha:</font></td>
    <td><p align="justify"><font color="#003366"></font><font color="#666666" size="2" face="Georgia, Times New Roman, Times, serif">
    <select name="planilha">
        <option value="controle_de_questionamentos">Controle de questionamentos</option>
...
$filename = '../../TP/bi/relatorios/Base_treinamento.xls';

if (file_exists($filename)) {
    //echo "O arquivo $filename existe";
	unlink("relatorios/Base_DIRETO.xls");
} else {
