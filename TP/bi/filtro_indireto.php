...
<div id="principal">
   ...
   include "../conexao.php";
	...
	$data_dia= date("y/m/d"); 
	?>
<form name="form1" method="post" action="gerar_excel_indireto.php">
...
<p>&nbsp;</p>
  ...
  <tr bordercolor="#FFFFFF"> 
      <td colspan="2"> 
        <div align="center">
      <hr noshade="noshade" />
          <font color="#000000" size="2" face="Arial, Helvetica, sans-serif" class="regra2"><strong>FILTRO INDIRETO</strong></font> 
          <hr noshade="noshade" />
    </div></td>
  </tr>
     <tr bordercolor="#FFFFFF"> 
...
$filename = '../../TP/bi/relatorios/Base_INDIRETO.xls';

if (file_exists($filename)) {
    //echo "O arquivo $filename existe";
	unlink("relatorios/Base_INDIRETO.xls");
} else {
