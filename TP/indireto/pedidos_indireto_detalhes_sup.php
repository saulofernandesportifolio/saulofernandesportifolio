...
$atv_op="SELECT * FROM ilha_reversao_indireto_bko WHERE turno = '$turno1' and usuario = '$login_usuario1' and tramite = '$tramite1' and data_tramite like '%$dt_dia%'";
}else $atv_op="SELECT * FROM ilha_reversao_indireto_bko WHERE turno = '$turno1' and usuario = '$login_usuario1' and tramite = '$tramite1' and data_tramite like '%$dt_dia'";
...
echo "<table id = \"conteudo_pn\" align=\"center\" border=\"0\" bgcolor=\"#999999\">
		...
		<td id=\"t_td\" width=\"5%\">
         ...
         <td id=\"t_td\" width=\"3%\"><font color=\"#000000\">
...
$criado_em = "";
 ...
 if($cor == "#CCCCCC"){
				...
				echo "<tr bgcolor=\"$cor\">
                  ...
                  <td id=\"t_td\" bgcolor=\"$cor\"><font size=\"2\"><a href=\"../../tp/indireto/indireto_bko_sup_detalhe.php?&id=$id\">$pedido</font></a></td>
				  ...
				  <td id=\"t_td\" bgcolor=\"$cor\"><font size=\"2\">$cliente</font></td>
	               </tr>";
				}
				  echo "</table>";   
