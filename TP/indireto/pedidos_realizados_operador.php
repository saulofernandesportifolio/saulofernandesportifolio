...
<?php          
        ...
        <td id=\"t_td\" width=\"19%\">
        <strong><font color=\"#000000\">Descricão do erros</font></strong>
        </td>
		</tr>
		";
...
//Pesquisa e retorna os campos declarado nas variáveis.
		...
		$sql_consulta="Select * from ilha_reversao_indireto_bko where usuario='$login' and fila ='3' and data_tramite ='$data_hoje'";
		//echo $sql_consulta;
		...
		while ($dado=mysql_fetch_array($acao_op))
			{
				...
				echo "<tr bgcolor=\"$cor\">
                  	...
                  	<td id=\"t_td\" bgcolor=\"$cor\">$tipo_erro</td>
				  	<td id=\"t_td\" bgcolor=\"$cor\">$descricao_do_erro</td>
