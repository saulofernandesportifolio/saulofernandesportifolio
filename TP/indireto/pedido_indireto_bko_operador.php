...
include "../../tp/indireto/indireto_fila_operador.php";
...
echo "<table id = \"conteudo_pn\" align=\"center\" border=\"0\" bgcolor=\"#999999\">
		...
		<td id=\"t_td\" width=\"20%\">
		 ...
		 <td id=\"t_td\" width=\"45%\"><font color=\"#000000\">
...
$criado_em = "";
 ...
 if($cor == "#CCCCCC"){
				...
				echo "<tr bgcolor=\"$cor\">
                  ...
                  <td id=\"t_td\" bgcolor=\"$cor\"><font size=\"2\"><a href=\"../../tp/indireto/reversao_indireto.php?&id=$id\">$pedido</font></a></td>
