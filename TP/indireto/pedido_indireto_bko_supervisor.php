...
echo "<meta HTTP-EQUIV='refresh' CONTENT='1;URL=pedidos_indireto_bko.php'>";
...
include "../../tp/indireto/indireto_fila_supervisor.php";
...
$criado_em = "";
 ...
 if($cor == "#CCCCCC"){
				...
				echo "<tr bgcolor=\"$cor\">
                  ...
                  <td id=\"t_td\" bgcolor=\"$cor\"><font size=\"2\"><a href=\"../../tp/indireto/reversao_indireto_supervisor.php?&id=$id\">$pedido</font></a></td>
