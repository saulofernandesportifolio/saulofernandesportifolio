   ...
   include("../../tp/menu.php") ?>
	    ...
	    <div id="caixa" style="height:460px;">
            ...
            <p id="p_padrao">Treinamento - Operador : <?php echo $_SESSION["nome"]; ?>.</p>
              ...
              <form name="formulario" action="treinamento_valida_update_controle_questionamentos.php" method="post">
              ...
              <table id="table_conteudo"  align="center" border="0">
                  ...
                  <td id="t_td">Comentário</td>
                   <td id="t_td" colspan="3">
                     <label for="antigo_comentario"></label>
   <textarea name="antigo_comentario" readonly id="antigo_comentario" cols="56" rows="5"><?php echo $comentario; ?></textarea></td>
                 </tr> 	
                  <tr>
                  <td id="t_td">Novo Comentário</td>
                   ...
                   <td id="t_td" colspan="3"><input name="destinatario" readonly value="<?php echo $destinatario; ?>"type="text"  class="combobox_padrao_grande"></td>
                   </tr> 
                   <tr>
                   ...
                   <td id="t_td"><span id="spryselect4">
                    ...
                    <td><input name="id" id="id" value ="<?php echo $id1 ?>" type="text" style="visibility:hidden"></td>
                </tr>
