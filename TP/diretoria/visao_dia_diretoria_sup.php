...
set_time_limit($tempo);
  ...
  include("../../tp/conexao.php");
  $atv_op2="SELECT * FROM base_diretoria WHERE data_tramite ='$dt_dia'";
...
?>
           ...
           <p id="p_padrao" align="center">Visão Dia: <?php echo $dt_dia2 ?></p>
            <hr width="104%">       
             <?php
			 //tabela por regional - inicio
			 
						include("../../tp/conexao.php");
				$atv_op="SELECT * FROM base_diretoria WHERE data_tramite ='$dt_dia'";
               ...
               $atv_op="SELECT COUNT(pedido)as pedido,disc_status_tp,ofensor FROM base_diretoria WHERE data_tramite = '$dt_dia' GROUP BY ofensor";
                        $acao_op=mysql_query($atv_op,$conecta);
		...
		while ($dado= mysql_fetch_array($acao_op))
				...
				$atv_op="SELECT * FROM base_diretoria WHERE data_tramite ='$dt_dia' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(pedido)as pedido,disc_status_tp,diretoria FROM base_diretoria WHERE data_tramite = '$dt_dia' GROUP BY diretoria";
                        $acao_op=mysql_query($atv_op,$conecta);
			  ...
			  //tabela por motivo - inicio
				...
				$atv_op="SELECT * FROM base_diretoria WHERE data_tramite ='$dt_dia' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(pedido)as pedido,disc_status_tp,erro FROM base_diretoria WHERE data_tramite = '$dt_dia' GROUP BY erro";
                        $acao_op=mysql_query($atv_op,$conecta);
			  ...
			  //tabela por motivo - inicio
				...
				$atv_op="SELECT * FROM base_diretoria WHERE data_tramite ='$dt_dia' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(pedido)as pedido,disc_status_tp,motivo_erro FROM base_diretoria WHERE data_tramite = '$dt_dia' GROUP BY motivo_erro";
                        $acao_op=mysql_query($atv_op,$conecta);
		...
		while ($dado= mysql_fetch_array($acao_op))
			...
			//tabela por operador - inicio
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(pedido)as pedido,disc_status_tp,tramite,nome2,data_tramite,turno FROM base_diretoria WHERE data_tramite = '$dt_dia' and tramite = 'Tratando' or data_tramite= '$dt_dia' and tramite = 'Tratado' or data_tramite = '$dt_dia' and tramite = 'Aguardando' GROUP BY disc_status_tp, nome2  DESC";
                        $acao_op=mysql_query($atv_op,$conecta);
