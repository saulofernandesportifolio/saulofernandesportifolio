...
<div id="principal">
   ...
   <?php include("../../tp/menu.php") ?>
    ...
    <div id="caixa">
      ...
      <div id="conteudo">
            ...
            <p id="p_padrao">Diretoria - Usuário: <?php echo $nome; ?>.</p><br>
   ...
   include "../conexao.php";
	...
	$data_dia= date("y/m/d"); 
	?>
<form name="form1" method="post" action="gerar_excel_diretoria.php">
...
<p>&nbsp;</p>
  ...
  <tr bordercolor="#FFFFFF"> 
      <td colspan="2"> 
        <div align="center">
      <hr noshade="noshade" />
          <font color="#000000" size="2" face="Arial, Helvetica, sans-serif" class="regra2"><strong>FILTRO DIRETORIA</strong></font> 
          <hr noshade="noshade" />
    </div></td>
  </tr>
     <tr bordercolor="#FFFFFF"> 
  ...
  <tr bordercolor="#FFFFFF">
    <td width="26%" height="24"><font color="#333333" size="2" face="Arial, Helvetica, sans-serif">Diretoria:</font></td>
    <td width="74%"><p align="justify"><font color="#003366">
        <select name="diretoria" id="diretoria">
        <option value="diretoria='Diretoria 1' OR diretoria='Diretoria 2' OR diretoria='Diretoria 3' OR diretoria='Soluções'" selected="selected">Todos</option>
        <option value="diretoria='Diretoria 1'">Diretoria 1</option>
        <option value="diretoria='Diretoria 2'">Diretoria 2</option>
		<option value="diretoria='Diretoria 3'">Diretoria 3</option>
        <option value="diretoria='Soluções'">Soluções</option>
        </select>
      </font></p></td>
  </tr>
  <tr bordercolor="#FFFFFF">
