...
$id1 = $id;
//Carimba pedido com o usuario
$nome  = $_SESSION["nome"];
$login = $_SESSION["login"];
$turno = $_SESSION["turno"];
$id    = $_GET['id'];

$sql_carimba="UPDATE base_erros 
                SET fila = 2, 
                    base_erros.usuario ='$login', 
                    base_erros.nome2 = '$nome', 
                    base_erros.tramite = 'Tratando', 
                    base_erros.turno='$turno', 
                    disc_status_tp ='Aberto' 
                WHERE id='$id'";

include("../conexao.php");
mysql_query($sql_carimba) or die (mysql_error());
...
<form action="erros_update_cadastro.php" method="post">
         ...
         <table id="table_conteudo"  align="center" border="0">
                  ...
                  <tr>
                     <td id="t_td">Ofensor</td>
                        ...
                        if($ofensor == ""){
                          ...
                          }else echo "<input name='ofensor' type='text' readonly='readonly' value='$ofensor' class='textbox_padrao' maxlength='20' id='id_filtro'>"
                          ?>
                        </td>
                        ...
                        <td id="t_td"><span id="sprytextfield2">
						  ...
						  }else echo "<input name='adabas' type='text' readonly='readonly' value='$adabas' class='textbox_padrao' maxlength='20' id='id_filtro'>"
						  ?>
                    </tr>
                      <tr>
                        <td id="t_td" >Comentário</td>
                        <td colspan="3"	>
							<textarea name="comentario_antigo" readonly readonlycols="56" style="width:516"rows="5">
				...
				if (trim($motivo_erros == "")){
				   ...
				   if ($tipo == "Falha Geral de Comunicação"){
                	echo'<td>Motivo do Erro:</td>
            		<td colspan="3"	>
               	  	<span id="spryselect2">
                    <select name="motivo" style="width:516" class="combobox_padrao_grande" id="motivo">
				    ...
				    if ($tipo == "Pendente de Prosseguir"){
                	echo'<td>Motivo do Erro:</td>
            		<td colspan="3"	>
               	  	<span id="spryselect2">
                    <select name="motivo" style="width:516" class="combobox_padrao_grande" id="motivo">
               ...
               ?>
                <tr>
                    ...
                    <td id="t_td" colspan="2"><select name="operador" id="operador">
