...
<div id="principal">
   ...
   include "../conexao.php";
	...
	$data_dia= date("y/m/d"); 
	?>
<form name="form1" method="post" action="gerar_excel_erros.php">
...
<p>&nbsp;</p>
  <table width="34%" border="1" align="center">
      ...
      <td colspan="2"> 
        <div align="center">
      <hr noshade="noshade" />
          <font color="#000000" size="2" face="Arial, Helvetica, sans-serif" class="regra2"><strong>FILTRO ERROS</strong></font> 
          <hr noshade="noshade" />
    </div></td>
  </tr>
     <tr bordercolor="#FFFFFF"> 
...
<?php
$filename = '../../TP/bi/relatorios/Base_ERROS.xls';

if (file_exists($filename)) {
   // echo "O arquivo $filename existe";
	unlink("relatorios/Base_ERROS.xls");
} else {
