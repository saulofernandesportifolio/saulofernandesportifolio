...
?>
    ...
    <form name="form1" method="post" action="retornar_para_visao_erros3.php">
...
//Pesquisa e retorna os campos declarado nas variáveis.
      ...
      <td></td>
        ...
        <td>
         ...
         <input type="button" name="Submit2" value="Cancelar" onClick="history.go(-2)"/><input type="submit" name="Submit" value="Retornar" />
