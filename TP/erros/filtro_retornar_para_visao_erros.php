...
<form name="dados" method="post" action="retornar_para_visao_erros.php" onSubmit="return enviardados();">
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td><p align="justify"><font color="#003366"></font><font color="#666666" size="2" face="Georgia, Times New Roman, Times, serif">
      <select name="disc_status_tp" id="disc_status_tp">
        <option value="disc_status_tp='Aberto' OR disc_status_tp='Em Tratamento' OR disc_status_tp='Tratado'" selected="selected">Todos</option>
        <option value="disc_status_tp='Aberto'">Aberto</option>
        <option value="disc_status_tp='Em Tratamento'">Em Tratamento</option>
...
<font color="#333333" size="2" face="Arial, Helvetica, sans-serif">Data Final</font>:</td>
 ...
 <td><input type="text" name="numero_pedido" size="10" /></td>
 </tr>
