...
?>
    ...
    <form name="form1" method="post" action="priorizar_pedido_erros2.php">
...
//Pesquisa e retorna os campos declarado nas variáveis.
        ...
        <td> </td>
        <td>
          <input type="button" name="Submit2" value="Voltar" onClick="window.location='erros_filtro_prioriza.php'"/><input type="submit" name="Submit" value="Avançar" />
          </td>
          </tr>
