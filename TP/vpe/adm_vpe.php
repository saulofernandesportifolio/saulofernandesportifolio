   ...
   <?php include("../../tp/menu.php") ?>
    ...
    <div id="caixa" >
        ...
        <div id="conteudo" >
            ...
            <form action="carregar_base_vpe.php"  method="post" enctype="multipart/form-data" name="form1">
                
                <table id="table_conteudo"  align="center" border="0">
                             
                	<tr>
                        <td id="t_td">* Selecionar Base VPE a ser Carregada:</td>
                         </tr>
                         <tr>
                         <td>
