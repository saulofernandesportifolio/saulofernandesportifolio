...
set_time_limit($tempo);
 ...
 $dt_dia = date("Y-m-");
  ...
  //echo $dt_dia ;
   ...
   include("../../tp/conexao.php");
  $atv_op2="SELECT * FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%'";
...
?>                     
         ...
         <p id="p_padrao" align="center">Visão Sap Geral Mês : <?php echo $dt_mes ?></p>
        <hr width="104%">          
             <?php
			 //tabela por regional - inicio
			 
					include("../../tp/conexao.php");
				$atv_op="SELECT * FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%'";
                        ...
                        $atv_op="SELECT COUNT(pedido)as pedido,data_cadastro,login,disc_status_tp,regional FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%' GROUP BY regional";
                        $acao_op=mysql_query($atv_op,$conecta);
		...
		while ($dado= mysql_fetch_array($acao_op))
				...
				$atv_op="SELECT * FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(pedido)as pedido,data_cadastro,login,disc_status_tp,tipo_de_solicitacao FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%' GROUP BY tipo_de_solicitacao";
                        $acao_op=mysql_query($atv_op,$conecta);
			  ...
			  //tabela por motivo - inicio
				...
				$atv_op="SELECT * FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(pedido)as pedido,data_cadastro,login,disc_status_tp,motivo FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%' GROUP BY motivo";
                        $acao_op=mysql_query($atv_op,$conecta);
			  ...
			  //tabela por disc_status_tp (tipo)- inicio
				...
				$atv_op="SELECT * FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(pedido)as pedido,data_cadastro,login,disc_status_tp FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%' GROUP BY disc_status_tp";
                        $acao_op=mysql_query($atv_op,$conecta);
			  ...
			  //tabela por tramite- inicio
				...
				$atv_op="SELECT * FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%' ";
					...
					$dado= mysql_fetch_array($acao_op);
                        ...
                        $atv_op="SELECT COUNT(pedido)as pedido,data_cadastro,login,disc_status_tp,tramite FROM diario_sap_bko WHERE data_tramite like '%$dt_dia%' GROUP BY tramite";
                        $acao_op=mysql_query($atv_op,$conecta);
...
//Pesquisa e retorna os campos declarado nas variáveis.
		...
		while ($dado= mysql_fetch_array($acao_op))
			...
			//tabela por operador - inicio
                       ...
                       $atv_op="SELECT COUNT(pedido)as pedido, regional,login,disc_status_tp,data_cadastro,tramite,nome2,data_tramite,turno FROM diario_sap_bko WHERE data_tramite like '$dt_dia%' and (tramite = 'Tratando' or tramite = 'Tratado' or tramite = 'Aguardando') GROUP BY login, disc_status_tp,data_tramite DESC";
                        $acao_op=mysql_query($atv_op,$conecta);
						  // echo $atv_op;       
...
<a href="javascript:abrir('pedidos_sap_detalhes_sup.php?&login_usuario=<?php echo $nome2 ?>&tramite=<?php echo $disc_status_tp ?>&turnoo=<?php echo $turnoo ?>&pesquisa_data=<?php echo $pesquisa_data ?>');"><?php echo $pedido ?></a>
