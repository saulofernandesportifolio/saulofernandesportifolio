...
$sql_verifca = "SELECT * FROM diario_sap_bko WHERE fila = 2 and login = '$login' ORDER BY data_cadastro ASC";
...
$sql_pedidos = "SELECT * FROM diario_sap_bko WHERE fila = 2 and login = '$login' ORDER BY data_cadastro ASC";
