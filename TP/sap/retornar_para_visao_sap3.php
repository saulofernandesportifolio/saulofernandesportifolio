...
<div id="principal">
   ...
   include "../conexao.php";
	$tempo1 = 0;
	 ...
	 set_time_limit($tempo1);
 	date_default_timezone_set("Brazil/East");
	$data_dia1= date("y/m/d");
...
{ 	 
$sql_update ="UPDATE diario_sap_bko SET fila = 1,
                                        login = 'Aguardando Operador',
										nome2 = 'Aguardando Operador',
										tramite ='Aguardando',
										status_tp = 1,
										turno ='ND',
										data_tramite = '$data_dia1'
										WHERE id_sap= '$id'";

$acao = mysql_query($sql_update) or die (mysql_error());
}
echo "<script>alert('Pedido Sap Retornado para fila.'); 
