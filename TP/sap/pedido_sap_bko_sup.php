		...
		while ($dado=mysql_fetch_array($acao_pedidos))
			{
				...
				echo "<tr bgcolor=\"$cor\">
                  	...
                  	<td id=\"t_td\" bgcolor=\"$cor\"><a href=\"sap_bko_sup.php?&id_sap=$id_sap\">$pedido</a></td>
                  	<td id=\"t_td\" bgcolor=\"$cor\"><a href=\"sap_bko_sup.php?&id_sap=$id_sap\">$ov</td>
                  	<td id=\"t_td\" bgcolor=\"$cor\"><a href=\"sap_bko_sup.php?&id_sap=$id_sap\">$cliente</td>
