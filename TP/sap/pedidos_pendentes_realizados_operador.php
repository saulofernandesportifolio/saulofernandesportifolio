...
<?php          
		...
		<td id=\"t_td\" width=\"5%\">
        <strong><font color=\"#000000\">OV</font></strong>
        </td>
        <td id=\"t_td\" width=\"15%\">
...
//Pesquisa e retorna os campos declarado nas variáveis.
		...
		$sql_consulta="Select * from diario_sap_bko where login='$login' and data_cadastro ='$data_hoje'";
		//echo $sql_consulta;
