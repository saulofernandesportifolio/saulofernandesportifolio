...
$sql_consulta="UPDATE diario_sap_bko SET fila = 2, login ='$login', nome2 = '$nome', tramite = 'Tratando',turno='$turno', disc_status_tp = 'Aberto' WHERE (fila = 1) and (login = 'Aguardando Operador') and (nome2 = 'Aguardando Operador') and (tramite = 'Aguardando') and ($novavar2) and ($novavar) ORDER BY data_cadastro ASC";
