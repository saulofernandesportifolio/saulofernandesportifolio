(function(g) {
    ...
    if ("undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) j =
        ...
        var x = d.document,
            ...
            A = function(a) {
                return /^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(a.type) ? new Blob(["ï»¿", a], {
                    type: a.type
                }) : a
            },
            B = function(a, b) {
    ...
    l.ext.buttons.copyHtml5 = {
        ...
        action: function(a, b, e, c) {
            ...
            a = g("<span>" + b.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>âŒ˜</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") + "</span>").append(e);
