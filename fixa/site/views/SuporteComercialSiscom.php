...
<div id="div_form_solicitacao" class="bradius wrapper" style="margin-left: 25%;" >
	<form 
		action="principal.php?t=controles/SuporteComercialSiscomController.php" method="POST">
		<fieldset id="fieldset_style">
			...
			<input type="hidden" value="insereSolicitacaoSuporteComercialSiscom" name="opcao" id="opcao"></input>
