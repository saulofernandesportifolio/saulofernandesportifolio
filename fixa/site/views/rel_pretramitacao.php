...
$(document).ready(function() {
  ...
  document.title = 'Pré-Tramitação' + ' ' + getCurrentDate();
...
<table border="0" id="tabela3"  width="auto" class="display table_tramitacao">
        <thead>
            <tr>
               <th>Data</th>
               <th>Analista</th>
               <th>Protocolo Solicitação(Siscom/Nº Pact Siscom)</th>
               <th>Categ. Prod.</th>
               <th>Devolução</th>
               <th>Canal Entrada</th>
               <th>Data Receb. da Solicitação</th>
               <th>Nº Pact Siscom</th>
               <th>Prod.</th>
