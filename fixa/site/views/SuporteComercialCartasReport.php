...
<select 
    name="mesRelatorioSCCartas" 
    id="mesRelatorioSCCartas"  
...
$(document).ready(function() {
  ...
  document.title = 'SC Cartas' + ' ' + getCurrentDate();
...
<div>
  <h2 class="titulo_table_result">SC Cartas</h2>
  <table border="0" id="tabela3"  width="auto" class="display table_tramitacao">
        <thead>
            <tr>
               ...
               <th>Data de Envio ao Cliente</th>
               <th>Endereço Envio</th>
               <th>Obs</th>
               <th>Status</th>
