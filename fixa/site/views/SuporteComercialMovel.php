...
<div id="div_form_solicitacao" class="bradius wrapper" style="margin-left: 25%;" >
	<form 
		action="principal.php?t=controles/SuporteComercialMovelController.php" method="POST">
		<fieldset id="fieldset_style">
			...
			<input type="hidden" value="insereSolicitacaoSuporteComercialMovel" name="opcao" id="opcao"></input>
			<h2>Suporte Comercial Siscom</h2> 
			<table id="form_apoio">
				<tr>
					<td>
						<div class="div_forms">
					...
					<td>
						<div class="div_forms">
							...
							<select name="categoria_produto" id="categoria_produto"	class="txt bradius"	required>
									...
									<option value="VOZ_DADOS">VOZ+DADOS</option>
					        	</select>
						</div>
					</td>
				</tr>
				...
				<tr>
					<td>
						<div class="div_forms">
							...
							<select name="simulacao" id="simulacao" class="txt bradius" required>
									<option></option>
