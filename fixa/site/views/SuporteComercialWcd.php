...
<div id="div_form_solicitacao" class="bradius wrapper" style="margin-left: 25%;" >
	<form 
		action="principal.php?t=controles/SuporteComercialWcdController.php" method="POST">
		<fieldset id="fieldset_style">
			...
			<input type="hidden" value="insereSolicitacaoSuporteComercialWcd" name="opcao" id="opcao"></input>
			<h2>Suporte Comercial Wcd</h2> 
			<table id="form_apoio">
				<tr>
					<td>
						<div class="div_forms">
