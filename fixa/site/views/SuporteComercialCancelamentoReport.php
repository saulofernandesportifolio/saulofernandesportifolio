...
<select 
    name="mesRelatorioSCCancelamento" 
    id="mesRelatorioSCCancelamento"  
...
$(document).ready(function() {
  ...
  document.title = 'SC Cancelamento' + ' ' + getCurrentDate();
...
<div>
  <h2 class="titulo_table_result">SC Cancelamento</h2>
