...
<select 
    name="mesRelatorioSCPendencia" 
    id="mesRelatorioSCPendencia"  
...
$(document).ready(function() {
  ...
  document.title = 'SC Pendencia' + ' ' + getCurrentDate();
...
<div>
  <h2 class="titulo_table_result">SC Pendência</h2>
