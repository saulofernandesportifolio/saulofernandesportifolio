        ...
        <div class="col-md-auto col-md-offset-auto">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    @include('login.erros')
                    <form class="navbar-form navbar-left" role="search" action="{{ url('/contestacao/busca_fechado') }}" method="post">
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($protocolos as $protocolo)
                                    ...
                                    <td>{{ $protocolo->sla }}</td>
                                      ...
                                      @endif
                                    <td>
                                     <button type="button" class="btn btn-success" onclick="window.location='{{ url('/contestacao/visualiza_fechado/'.$protocolo->id) }}'">
