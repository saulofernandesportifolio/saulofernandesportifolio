...
<div class="container">
   ...
   <div class="row">
       <div class="col-md-100 col-md-offset-100">
           <div class="panel">
               <div class="panel-heading">Protocolo - Histórico Fechados
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   @if(!empty($motivop))
                       <button id="opcao" type="button" class="btn btn-success col-md-offset-8" onclick="#"><i class="glyphicon glyphicon-chevron-down"></i> Exibir Histórico</button>
                   @endif
               </div>
                   ...
                   <div class="table-responsive aligncenter">
                    ...
                    <br><br>
                        <div class="form-group">
                            <div class="col-md-10">
                                @foreach($protocolos as $protocolo)
                                  <form class="form-horizontal" role="form" action="{{ url('/contestacao/reabrir') }}" method="post">
                                      {{ csrf_field() }}
                                  ...
                                  @else
                                    <button type="button" class="btn btn-success" onclick="window.location='{{ url('/contestacao/fechado') }}'">
                                    <i class="glyphicon glyphicon-arrow-left"></i> Voltar</button>
                                  @endif
                                  </form>
