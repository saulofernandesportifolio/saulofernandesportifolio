...
$sql_user = "SELECT nome FROM usuarios WHERE login = '$usuario'";
...
<table width="899" border="1" cellpadding="0" cellspacing="0">
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF"> 
    ...
    <td width="476"> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif">Matricula: 
        </font><font color="#FFFFFF"><?php echo "<font size='1,5' face='Arial' color='#333'>$usuario"?></font><font size="2" face="Arial, Helvetica, sans-serif"> 
        </font></div></td>
