                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select id="cliente" name="cliente" class="form-control">
                                          ...
                                          @if($cli1 <> '%')
                                           @foreach($cli as $clie)
                                             <option value="{{ $clie->id }}" selected>{{ $clie->cliente }}</option>
                                           @endforeach
                    ...
                    <div class="row">
                        <div class="table-responsive aligncenter">
                                ...
                                @foreach($equi as $eq)
                                    <tr align="center">
                                        ...
                                        @if(!isset($eq->status_geral))
                                                ...
                                                <td class="small"><button type="button" class="btn btn-success-sm" onclick="window.location='{{ url('/ocorrencia/new/'.$eq->id) }}'" ><i class="fas fa-plus-square"></i></button></td>
                                        @else
                                        @if($eq->status_geral == "A1")
                                                <td class="small"><button type="button" class="btn btn-warning" onclick="window.location='{{ url('/ocorrencia/visualiza/'.$eq->idocorrencia) }}'">Alarme 1</button></td>
                                                <td class="small"><button type="button" class="btn btn-success-sm" onclick="window.location='{{ url('/ocorrencia/new/'.$eq->id) }}'" ><i class="fas fa-plus-square"></i></button></td>
                                        @elseif($eq->status_geral == "A2")
                                                <td class="small"><button type="button" class="btn btn-danger" onclick="window.location='{{ url('/ocorrencia/visualiza/'.$eq->idocorrencia) }}'">Alarme 2</button></td>
                                                <td class="small"><button type="button" class="btn btn-success-sm" onclick="window.location='{{ url('/ocorrencia/new/'.$eq->id) }}'" ><i class="fas fa-plus-square"></i></button></td>
                                        @elseif($eq->status_geral == "A0")
                                                <td class="small"><button type="button" class="btn btn-success" onclick="window.location='{{ url('/ocorrencia/visualiza/'.$eq->idocorrencia) }}'">Normal</button></td>
                                                <td class="small"><button type="button" class="btn btn-success-sm" onclick="window.location='{{ url('/ocorrencia/new/'.$eq->id) }}'" ><i class="fas fa-plus-square"></i></button></td>
                                        @elseif($eq->status_geral == "")
                                                <td class="small"><button type="button" class="btn btn-success">Normal</button></td>
                                                <td class="small"><button type="button" class="btn btn-success-sm" onclick="window.location='{{ url('/ocorrencia/new/'.$eq->id) }}'" ><i class="fas fa-plus-square"></i></button></td>
                                        @elseif($eq->status_geral == "A4")
                                                <td class="small"><button type="button" class="btn btn-primary" onclick="window.location='{{ url('/ocorrencia/visualiza/'.$eq->idocorrencia) }}'">Não Monitorado</button></td>
                                                <td class="small"><button type="button" class="btn btn-success-sm" onclick="window.location='{{ url('/ocorrencia/new/'.$eq->id) }}'" ><i class="fas fa-plus-square"></i></button></td>
                                        @endif
                                    </tr>
                                    @endif
                            ...
                            @if (isset($data_f))
                                ...
                                <?php echo $equi->appends($data_f)->render(); ?>
