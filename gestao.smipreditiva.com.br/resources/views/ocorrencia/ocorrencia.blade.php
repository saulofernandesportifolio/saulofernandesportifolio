        ...
        @include('login.erros')
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <form role="form" action="{{ url('/ocorrencia/salvar') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <br>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <label class="small" for="obs_outros">Observações:</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <label class="small" for="desalinhamento">Desalinhamento</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <label class="small" for="rigidez">Rigidez/Fixação</label>
                                ...
                                <div class="col-md-5">
                                    <div class="form-check">
                                        <label class="small" for="rec_rigidez">Descreva as recomendações para rigidez/Fixação</label>
