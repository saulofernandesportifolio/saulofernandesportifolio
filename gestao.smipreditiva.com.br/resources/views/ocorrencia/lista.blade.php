                    ...
                    <div class="table-responsive aligncenter">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($ocorrencias as $oc)
                                <tr align="center">
                                        <td class="small">{{ $oc->ocorrencia }} <button type="button" class="btn btn-primary-sm" onclick="window.location='{{ url('/ocorrencia/visualiza/'.$oc->id) }}'">
                                    ...
                                    @elseif($oc->folgas_desgaste == "A3")
                                        <td><image class="imagem_sinal" src="{{ url('/img/sinal_vermelho.jpg') }}" height="30" width="15" title="{{ $oc->folgas_desgaste }}" ></image></td>
                                    @elseif(empty($oc->folgas_desgaste) || $oc->folgas_degaste == "A0")
