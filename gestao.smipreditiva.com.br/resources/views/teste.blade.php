                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <select id="cliente" name="cliente" class="form-control" style="height:30px;">
                                        <option value="0" selected>Todos clientes</option>
                                        @foreach($cli as $clie)
                                ...
                                <div class="col-md-2">
                                    <select id="ano" name="ano" class="form-control" style="width:140px;">
