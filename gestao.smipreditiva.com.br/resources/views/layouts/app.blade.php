                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            @if(Session::get('perfil') == 1 )
                                ...
                                <li><a href="{{ url('/ocorrencia/consultafeed/') }}"><i class="glyphicon glyphicon-file"></i> Feedbacks</a></li>
                            @endif

                                @if(Session::get('perfil') == 2 )
                                    <li><a href="{{ url('/cliente/dash') }}"><i class="glyphicon glyphicon-signal"></i> Resumo Ocorrências</a></li>
                                    <li><a href="{{ url('/cliente/consultafeed/') }}"><i class="glyphicon glyphicon-file"></i> Feedbacks</a></li>
                                @endif
                        </ul>
                    </li>
                @endif
            ...
            <ul class="nav navbar-nav">
                ...
                @if(Session::get('perfil') == 1
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ url('adm/importar') }}"><i class="fa fa-file-excel-o"></i> Importar Equipamentos</a></li>
                        </ul>
                    </li>
                @endif
            </ul>
