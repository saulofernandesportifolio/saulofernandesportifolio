...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel">
                <div class="panel-heading">Criação Conta</div>

                <div class="panel-body">

                        <div class="form-group">
                             <div class="col-md-6">
                             Este e-mail foi-lhe enviado por ter solicitado a recuperação de senha
                             </div>
                        </div>
                    <div class="form-group">
                        <div class="col-md-6">
                        ...
                        <div class="form-group">
                             <div class="col-md-6">
                              Nova Senha: <strong>{{ $nova_senha }}</strong>
                             </div>
                       </div>
                    <div class="form-group">
                        <div class="col-md-6">
                            Abaixo link para acesso ao site Sistema Ocorrência, utilize o usuario e senha para logar ao sistema.
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-6">
