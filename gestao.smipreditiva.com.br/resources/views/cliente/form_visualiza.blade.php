...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <div class="row">
                                ...
                                <img src="/public/graficos/{{$ocorrencia->grafico}}" alt="{{ $ocorrencia->grafico }}" height="200" width="700">
                        ...
                        @else
                            ...
                            <div class="row">
                                ...
                                <img src="/public/graficos/{{$ocorrencia->grafico2}}" alt="{{ $ocorrencia->grafico2 }}" height="200" width="700">
                        ...
                        <div class="row">
                                ...
                                <button type="button" class="btn btn-primary-sm" onclick="window.location='{{ url('/cliente/feedback/'.$ocorrencia->id) }}'">
                                    <i class="fas fa-chalkboard-teacher"></i> Inserir Feedback</button>
                            ...
                            @if($ocorrencia->status == 1)
                                <br>
                            <form role="form" action="{{ url('/cliente/resalvar/'.$ocorrencia->id) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <h6><strong> Classificar ocorrência</strong></h6>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <label class="small" for="status">Status Ocorrência</label>
                                    ...
                                    <div class="col-md-5">
                                        <label class="small" for="analise">Analise</label>
                                        <textarea class="form-control" rows="3" name="analise" id="analise"></textarea>
                            ...
                            @else
                                ...
                                <h5><strong>Detalhes Fechamento</strong></h5>
                                <br>
                                    ...
                                    <div class="col-md-8">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $ocorrencia->usuario_ult_alteracao }}</td>
                                                <td><strong>Anotações</strong></td>
                                                <td>{{ $ocorrencia->analise }}</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Data Alteração</strong></td>
                                                <td>{{ $ocorrencia->data_ult_alt }}</td>
                                                <td><strong>Hora Alteração</strong></td>
                                                <td>{{ $ocorrencia->hora_ult_alt }}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
    ...
    <script>
        ...
        function abrePopup()
        {
            window.open("{{ url('/cliente/analise/viusualizafeedback/'.$ocorrencia->id) }}", "nome", "width=1000, height=800");
        }
    </script>
