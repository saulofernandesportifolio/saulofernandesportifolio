...
class HomeContaController extends Controller
{
    //
    public function index()
    {
        ...
        $equi = DB::table('equipamentos')
            ...
            ->where('equipamentos.cliente',Session::get('cliente'))
            ->orderBY('ocorrencias.status_geral')
            ->simplePaginate(20);
        ...
        //COUNT CARDS
        $semt = $jan_normal + $fev_normal + $mar_normal + $abr_normal + $mai_normal + $jun_normal + $jul_normal + $ago_normal +
            $set_normal + $out_normal + $nov_normal + $dez_normal;
        ...
        $cli = Cliente::where('cliente',Session::get('cliente'))->get();
        ...
        $ano=date('Y');
        $cli1 = '%';
        return view('contas.home',['ocorrencias' => $ocorrencias, 'ocorrencias1' => $ocorrencias1,'ano'=>$ano,
            ...
            'equi' => $equi,
            'cnt_nmojan' => '0', 'cnt_nmofev' => '0', 'cnt_nmomar' => '0', 'cnt_nmoabr' => '0',
            'cnt_nmomai' => '0','cnt_nmojun' => '0','cnt_nmojul' => '0','cnt_nmoago' => '0',
            'cnt_nmoset' => '0', 'cnt_nmoout' => '0', 'cnt_nmonov' => '0', 'cnt_nmodez' => '0',
    ...
    public function busca(Request $request)
    {
        ...
        $cli = DB::table('clientes')->select('id', 'cliente', 'contato')->where('cliente',  Session::get('cliente'))->get();
        $cli2 = DB::table('clientes')->select('id', 'cliente', 'contato')->where('cliente', Session::get('cliente'))->get();
        //count de ocorrencias e feedbacks para montagem dos graficos
        $ocorrencias = DB::table('ocorrencias')->select('mes')->where('cliente',Session::get('cliente'))->distinct()->get();
        $ocorrencias1 = DB::table('ocorrencias')->select('ano')->where('cliente',Session::get('cliente'))->distinct()->orderBy('ano', 'desc')->get();

        /***************janeiro**************************/
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Janeiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgjan = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Janeiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgjan = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Fevereiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgfev = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Fevereiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgfev = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Março'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgmar = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Março'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgmar = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Abril'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgabr = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Abril'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgabr = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Maio'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgmai = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Maio'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgmai = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Junho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgjun = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Junho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgjun = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Julho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgjul = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Julho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgjul = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Agosto'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgago = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Agosto'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgago = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Setembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgset = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Setembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgset = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Outubro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgout = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Outubro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgout = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Novembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgnov = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Novembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgnov = $cnt_abertas;
        ...
        //total de ocorrencias
        $cnt_total = DB::table('ocorrencias')
            ->where([['ano','=',$request->ano],['mes','=','Dezembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_totalgdez = $cnt_total;

        $cnt_abertas = DB::table('ocorrencias')
            ->where([['status','=',1],['ano','=',$request->ano],['mes','=','Dezembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $cnt_abertasgdez = $cnt_abertas;
        ...
        $jan_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Janeiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $jan_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Janeiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $jan_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Janeiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $jan_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Janeiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $eq = DB::table('equipamentos')
            ->where('cliente','LIKE',Session::get('cliente'))
            ->count();
        ...
        $oc_cj = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Janeiro'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $fev_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Fevereiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $fev_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Fevereiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $fev_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Fevereiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $fev_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Fevereiro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cf = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Fevereiro'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $mar_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Março'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $mar_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Março'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $mar_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Março'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $mar_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Março'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cm = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Março'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $abr_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Abril'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $abr_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Abril'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $abr_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Abril'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $abr_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Abril'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cab = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Abril'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $mai_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Maio'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $mai_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Maio'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $mai_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Maio'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $mai_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Maio'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cma = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Maio'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $jun_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Junho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $jun_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Junho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $jun_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Junho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $jun_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Junho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cjun = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Junho'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $jul_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Julho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $jul_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Julho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $jul_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Julho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $jul_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Julho'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cjul = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Julho'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        /***************Agosto**************************************************************************/
        $ago_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Agosto'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $ago_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Agosto'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $ago_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Agosto'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $ago_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Agosto'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cago = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Agosto'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $set_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Setembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $set_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Setembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $set_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Setembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $set_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Setembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cset = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Setembro'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $out_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Outubro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $out_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Outubro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $out_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Outubro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $out_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Outubro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cout = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Outubro'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $nov_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Novembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $nov_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Novembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $nov_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Novembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $nov_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Novembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cnov = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Novembro'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $dez_normal = DB::table('ocorrencias')
            ->where([['status_geral','=','A0'],['ano','=',date("Y")],['mes','=','Dezembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $dez_ala1 = DB::table('ocorrencias')
            ->where([['status_geral','=','A1'],['ano','=',date("Y")],['mes','=','Dezembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $dez_ala2 = DB::table('ocorrencias')
            ->where([['status_geral','=','A2'],['ano','=',date("Y")],['mes','=','Dezembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();

        $dez_ala4 = DB::table('ocorrencias')
            ->where([['status_geral','=','A4'],['ano','=',date("Y")],['mes','=','Dezembro'],['cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_cdez = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['ocorrencias.mes','=','Dezembro'],['equipamentos.cliente','LIKE',Session::get('cliente')]])
            ->count();
        ...
        $oc_tt = DB::table('equipamentos')
            ...
            ->where([['ocorrencias.ano','=',date("Y")],['equipamentos.cliente', 'LIKE', Session::get('cliente')]])
            ->count();
