...
function ValidaEntrada(objeto, tipo){
    ...
    switch (tipo){
      ...
      case 'atividade_pedido':
        ...
        case 'text':
            regex = /^[A-Za-zÀ-ú]{1}([ÃãÂâÁáÀàçéÉóÓõÕÔôÍíÚú,?!;:_$#*&>.<%\{\[\(\)\]\}@¨=+ºª°€\"\'\\/ A-Za-zÀ-ú0-9-]?)+$/;
            break;
        case 'indexQ':
    ...
    if(!resultado){
        ...
        document.getElementById("bt_enviar").style.backgroundColor = "#000"; 
        document.getElementById("bt_enviar").disabled = true;
        ...
        while(block.match('_block_' +objeto.id)){
            ...
            document.getElementById("bt_enviar").style.backgroundColor = "#337ab7";
