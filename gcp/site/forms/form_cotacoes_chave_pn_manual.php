...
<input type="text" name="datarecebimento" id="datarecebimento"  maxlength="10" class="txt2data bradius" onblur="ValidaEntrada(this,'date');" onkeypress="Formatadata(this,event);" /></label>
<label style="padding-left: 5px;">Hora do recebimento:&nbsp;
<input  onblur="valida(this,'text');" onkeypress="HoraMinuto(event,this);" id="horarecebimento" name="horarecebimento" maxlength="5" class="txt2hora bradius" /> </label>             
...
<input type="text" name="dataretorno" id="dataretorno"  maxlength="10" class="txt2data bradius"  onkeypress="Formatadata(this,event);" /></label>
<label style="padding-left: 5px;">Hora do retorno:&nbsp;
<input  onkeypress="HoraMinuto(event,this);" id="horaretorno" name="horaretorno" maxlength="5" class="txt2hora bradius" /> </label> 
...
<textarea type="text" name="emailretorno" id="emailretorno" class="txt2textarea bradius" onblur=""></textarea>
</label>
</p>
<br/>
