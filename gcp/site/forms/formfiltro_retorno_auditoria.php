...
<script type="text/javascript">
    function PreventMultipleSubmit9(){
      document.getElementById("entrar8").disabled=true;
      document.getElementById("entrar8").style.backgroundColor = "#000";
    }
...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/formretornar_distribuicao_cotacao_auditoria.php" method="POST" 
    onsubmit="PreventMultipleSubmit9();showLoader8();">
      ...
      <br/>
      &nbsp;&nbsp;&nbsp;&nbsp; 
      <input type="submit" class="sb2 bradius" name="entrar8" id="entrar8" value="       OK       "  />
...
<div align="center" class="barraloaderimg">
 ...
 <img id="loader8" src="site/forms/img/load.gif" width="300" height="50" />
