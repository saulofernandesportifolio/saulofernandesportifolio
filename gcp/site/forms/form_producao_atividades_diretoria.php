...
$sql_cota = "SELECT * FROM cip_nv.base_diretoria_atv b 
                 WHERE  b.operador_diretoria ='$nome' 
                 and b.data_tratamento= '$data_dia'                
...
<thead>
<tr>
<th colspan="8" class="trcabecalho2 bradius">Produ&ccedil;&atilde;o Diretoria - Atividade</th>
</tr>
<tr>
...
<tr>
    <th class="trcabecalho2 bradius">Atividades:</th>
