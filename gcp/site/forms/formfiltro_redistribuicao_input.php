...
<script type="text/javascript">
    function PreventMultipleSubmit2(){
      document.getElementById("entrar").disabled=true;
      document.getElementById("entrar").style.backgroundColor = "#000";
    }
...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/formredistribuicao_cotacao_input.php" method="POST" 
    onsubmit="PreventMultipleSubmit2();showLoader();">
      ...
      <input type="submit" class="sb2 bradius" name="entrar" id="entrar" value="       OK       "  />
        <input type="button" class="sb2 bradius" name="cancelar2" value="Cancelar" onclick="window.location='principal.php?&filtro=%&filtro2=%&filtro3=%&t=forms/formhome_operacao.php'" />
...
<div align="center" class="barraloaderimg">
 ...
 <img id="loader" src="site/forms/img/load.gif" width="300" height="50"/>
