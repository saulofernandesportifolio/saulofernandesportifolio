...
$selecsla="SELECT b.id_cotacao FROM cip_nv.tbl_cotacao a 
           ...
           WHERE (b.status_cip_input=7 OR b.status_cip_input=8) ";
...
//include('sql.sla_visao_auditoria.php');

echo" <script> 
       document.location.replace('principal.php?&t=forms/sql.sla_visao_auditoria.php');
      </script>
      ";                                        
    exit();
