...
<div class="divrel bradius">
    <form id="form_rel" name="dados" method="post" action="principal.php?t=forms/gera_relatorio_contestacao.php">
      <br />
        <p align="center"><b><font color="#FF0000">Obs.:&nbsp;Para baixar a base consolidada deixar o campo data inicial e data final em branco.</font></b></p>
          <br />
        <h3 align="center">
            <strong>Gerar Relat&#243;rio contesta&ccedil;&atilde;o</strong>
        </h3>
        <p align="center">&nbsp;</p>
        <p>
            <strong>Tipo</strong>: 
            ...
            <font color="464646" size="2" face="Arial, Helvetica, sans-serif">Data do recebibemto</font>
            <input name="pesquisa" id="5" type="radio" value="3" onclick="HabCamposrel()" />
            <font color="464646" size="2" face="Arial, Helvetica, sans-serif">Data tratamento</font>
            <input name="pesquisa" id="3" type="radio" value="5" onclick="HabCamposrel()"/>
    ...
    <br />
        ...
        <span id="oculta" style="display:''">
            <p>
                ...
                <select name="substatus" id="substatus"  class="txt2comboboxpadrao bradius">
                    ...
                    //conecta no SGBD MySQL
                      ...
                      //seleciona a base de dados para uso
                       $query= "SELECT * FROM cip_nv.tbl_substatus where setor ='auditoria' ORDER BY setor";
             ...
             <br />
              <p>
              <strong>Turno:</strong> &nbsp;
                <select name="turno2" id="turno2"  class="txt2comboboxpequeno bradius">
                    <option value="%">Todos</option>
                    <?php
                    //conecta no SGBD MySQL
                      ...
                      //seleciona a base de dados para uso
                       $query= "SELECT * FROM cip_nv.tbl_turno  WHERE id NOT IN (4) ORDER BY  turno ";
                       $result= mysql_query($query,$conecta);
                       while($dado= mysql_fetch_array($result)){
        ...
        <?php 
         ...
         ?>
            ...
            <input type="button" name="Submit2" value="Voltar" class="sb2 bradius" onclick="window.location='principal.php?&t=forms/relatorio_contestacao_principal.php'" />
      </p>
       <br />
    </form>
</div>
