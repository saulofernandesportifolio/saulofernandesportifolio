...
$data_1=arrumadata($_POST['data_1']);
 
$data_2=arrumadata($_POST['data_2']);
...
$data = date("d-m-Y");
   ...
   //Você pode colocar aqui o nome do arquivo que você deseja salvar.
    $excel=new ExcelWriter("site/forms/relatorios/relatorio_contestacao_$data.$cpf.xls");
...
//Escreve o nome dos campos de uma tabela
   $myArr=array( 
      ...
      'QTD ERROS',
	    ...
	    'DATA RETORNO',
	    'HORA RETORNO',
	    'DATA ATUALIZACAO CONTESTACAO',
	    'USUARIO ATUALIZACAO CONTESTACAO',
	    'DATA TRATAMENTO CONTESTACAO',
	    'HORA TRATAMENTO CONTESTACAO',
	    'ANALISTA CONTESTACAO',
      'REMETENTE',
      'RETORNO DO EMAIL',
      'ADABAS',     
      'CONTESTACAO',
...
$lg2=$_POST['substatus'];
 ...
 $sql_servico="CALL cip_nv.exportar_top_nv_contestacao("."'{$data_1}'".","."'{$data_2}'".","."'{$lg2}'".","."'{$turno}'".")";
...
$sql_servico="CALL cip_nv.exportar_top_nv_contestacao2("."'{$data_1}'".","."'{$data_2}'".","."'{$lg2}'".","."'{$turno}'".")";
...
$lg2=$_POST['substatus'];
 ...
 $sql_servico="CALL cip_nv.exportar_top_nv_contestacao3("."'{$data_1}'".","."'{$data_2}'".","."'{$lg2}'".","."'{$turno}'".")";
     ...
     if($consulta_servico ==true){
      ...
      while($linha = mysql_fetch_array($consulta_servico)){
        ...
        if($linha['turno'] == 1)
          ...
          if($linha['turno_ofensor'] == 1)
                    { 
                        $linha['turno_ofensor']="Diurno";
                    }
                    elseif($linha['turno_ofensor'] == 2)
                        { 
                        $linha['turno_ofensor']=utf8_encode("Intermediário");
                        } 
                    elseif($linha['turno_ofensor'] == 3)
                        { 
                        $linha['turno_ofensor']="Noturno";
                        }                
...
if(arrumadata($linha['data_envio_email']) == '00/00/0000' && $linha['hora_envio_email'] == '00:00:00'){
    ...
    if(arrumadatahora($linha['dt_atualizacao']) == '00/00/0000 00:00:00' || $linha['dt_atualizacao'] == '0000-00-00 00:00:00'){
      ...
      $myArr=array( $linha['n_da_cotacao'],
                    ...
                    arrumadata($linha['data_do_recebimento']),
	                  ...
	                  $linha['hora_retorno'],
	                  arrumadatahora($linha['dt_atualizacao']),
	                  $linha['usuario_att'],
  ...
  <?php
    ...
    "<hr>
      <div align='center'>
            <a  target=\"_blank\" href=\"site/forms/relatorios/relatorio_contestacao_$data.$cpf.xls\">
...
$somefile="site/forms/relatorios/relatorio_contestacao_$data_1.$cpf.xls";
