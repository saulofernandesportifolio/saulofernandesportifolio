...
$linha_atv['contestacao_status_cip'];
...
<input  onblur="valida(this,'text');" onkeypress="HoraMinuto(event,this);" id="hora_do_recebimento" name="hora_do_recebimento" maxlength="5" class="txt2hora bradius" value="<?php echo substr($linha_atv['hora_do_recebimento'],0,5); ?>"/> 
</label>
...
<input  onblur="valida(this,'text');" onkeypress="HoraMinuto(event,this);" id="hora_retorno" name="hora_retorno" maxlength="5" class="txt2hora bradius" value="<?php echo substr($linha_atv['hora_retorno'],0,5); ?>"/> 
</label>
</p>
<br />
<p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius">
...
<option value="<?php echo $linha_atv['remetente'] ?>"><?php echo $linha_atv['remetente']; ?></option>
<?php
...
<br />
  <p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius">
    ...
    <option value="<?php echo $linha_atv['nome_ofensor'] ?>"><?php echo $linha_atv['nome_ofensor']; ?> </option>
    </select>
...
<input name="excluirrerros" type="button" value="Para excluir erros clik aqui" onclick="javascript:abrir('site/forms/form_exclui_cotacoes_contestacao_ofensor.php?id_contestacao_cotacao=<?php echo $linha_atv['id_contestacao_cotacao']; ?>');" >
<input name="atualizastatus" type="button" value="Para atualizar o status por erro clik aqui" onclick="javascript:abrir('site/forms/form_atualizar_cotacoes_contestacao_status.php?id_contestacao_cotacao=<?php echo $linha_atv['id_contestacao_cotacao']; ?>');" >
</label></p>
