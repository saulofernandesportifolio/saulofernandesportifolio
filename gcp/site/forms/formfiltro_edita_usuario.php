...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/formeditar_usuarios.php" method="POST">
        <h3 align="center" style="background: #337ab7"><font color="#FFFFFF">SELECIONE O FILTRO EDITAR</font></h3><br />
        <div class="acomodar">
       ...
       <?php
        ...
        $query= "SELECT * FROM cip_nv.tbl_supervisor WHERE projeto NOT IN('saiu','GERENTE','B.I') AND tipo_supervisor IN ('TOP','VPG/TOP')  ORDER BY nome";
