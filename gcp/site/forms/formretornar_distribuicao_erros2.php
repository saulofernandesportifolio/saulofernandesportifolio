...
<form name="form1" method="post" action="principal.php?&t=controles/sql_retornardistribuicao_erros4.php" id="frm-filtro">
...
$sql ="SELECT * FROM bd_erros_pn.base_erros a 
       WHERE a.id = '$id'    
