...
$sql_cota = "SELECT a.id_cotacao,
                ...
                WHERE   b.analista_contestacao ='{$_COOKIE['idtbl_usuario']}' 
                OR b.usuario_att ='{$_COOKIE['idtbl_usuario']}'
                  and b.data_tratamento = '$data_dia'  OR SUBSTRING(b.dt_atualizacao,1,10) =  '$data_dia'             
         ORDER BY a.n_da_cotacao ASC LIMIT 0,20000 ";
...
<tbody>
  ...
  <?php echo $linha_op["n_da_cotacao"]; ?></td>
  <td class="trcabecalho2 bradius">
