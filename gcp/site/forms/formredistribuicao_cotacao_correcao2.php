...
<form name="form1" method="post" action="principal.php?&t=controles/sql_redistribuicao_cotacao_correcao4.php" id="frm-filtro">
...
$sql = "SELECT  a.id_cotacao,
                ...
                WHERE carteira LIKE '$canal' and 
                      b.status_cip_correcao NOT IN (20,27) and a.id_cotacao='$id_cotacao' 
