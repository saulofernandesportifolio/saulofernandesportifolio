...
<form name="form1" method="post" action="principal.php?&t=controles/sql_redistribuicao_cotacao_analise4.php" id="frm-filtro">
...
$sql = "SELECT a.id_cotacao,
                ...
                WHERE  b.status_cip_analise NOT IN (3,27) and b.id_cotacao='$id_cotacao' 
          ORDER BY b.dt_distribuicao,a.revisao,a.n_da_cotacao DESC LIMIT 0,20000 ";
