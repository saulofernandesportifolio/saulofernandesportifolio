...
$data = date("d-m-Y");
   ...
   //Você pode colocar aqui o nome do arquivo que você deseja salvar.
    $excel=new ExcelWriter("site/forms/relatorios/relatorio_chave_pn_historico_$data.$cpf.xls");
...
if(empty($data_1) && empty($data_2) && $_POST['pesquisa'] == 1){
  ...
  $sql_servico="CALL bd_erros_pn.exportar_top_nv_chavevpe_pn_historico("."'{$data_1}'".","."'{$data_2}'".")";
...
$sql_servico="CALL bd_erros_pn.exportar_top_nv_chavevpe_pn_historico("."'{$data_1}'".","."'{$data_2}'".")";
 ...
 $sql_servico="CALL bd_erros_pn.exportar_top_nv_chave2vpe_pn_historico("."'{$data_1}'".","."'{$data_2}'".")";
   ...
   echo"
     ...
     if($consulta_servico ==true){
      ...
      $myArr=array(
                   ...
                   $linha['solicitante'],
                   $linha['qtd_linha'],
                   $linha['motivo_tratativa'],
                   $linha['submotivo_tratativa'],
                   arrumadata($linha['data_da_nova_janela']),
                   $linha['email_solicitante'],
                   $linha['email_retorno'],
                   $linha['fila'],
                   $linha['disc_status_fila'],
                   $linha['usuario'],
                   arrumadata($linha['data_tratativa']),
                   $linha['hora_tratativa'],
                   $linha['cpf'],
                   arrumadatahora($linha['inicio_tratativa']),
                   $linha['linha_pn'],
                   arrumadata($linha['data_janela_linha'])
                    );
         $excel->writeLine($myArr);
  ...
  <?php
    ...
    "<hr>
      <div align='center'>
            <a  target=\"_blank\" href=\"site/forms/relatorios/relatorio_chave_pn_historico_$data.$cpf.xls\">
...
$somefile="site/forms/relatorios/relatorio_chave_pn_historico_$data_1.$cpf.xls";
