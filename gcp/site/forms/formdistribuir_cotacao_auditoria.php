...
a.visao_ilha,
a.vencimento_ilha
FROM cip_nv.tbl_cotacao a INNER JOIN cip_nv.tbl_auditoria b ON b.id_cotacao=a.id_cotacao 
AND ( b.status_cip_auditoria= 13 OR b.status_cip_auditoria= 14 )";
...
//$sql="CALL visao_auditoria_distribuicao("."'13'".","."'{$carteira}'".")";

//$sql="CALL visao_auditoria_distribuicao("."'27'".")";


if($carteira == '%'){
 $sql="CALL cip_nv.visao_auditoria_distribuicao_TODOS("."'13'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}elseif($carteira == 'GOV'){
 $sql="CALL cip_nv.visao_auditoria_distribuicao_GOV("."'13'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}elseif($carteira == 'TOP'){
 $sql="CALL cip_nv.visao_auditoria_distribuicao_TOP("."'13'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}elseif($carteira == 'VIP'){
 $sql="CALL cip_nv.visao_auditoria_distribuicao_VIP("."'13'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}elseif($carteira == 'TOPVIP'){
 $sql="CALL cip_nv.visao_auditoria_distribuicao_TOP_VIP("."'13'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}
...
<form name="form1" action="principal.php?&t=forms/formdistribuir_cotacao_auditoria2.php" method="post" id="frm-filtro">

<p align="center"><b><font color="#337ab7" size="5" face="Gotham Light">Análise de input</font></b></p>
<br />
...
?>
     ...
     <td>
      ...
      <td class="tdconteudo">
        <a href="javascript:abrirrevisao('site/forms/formdetalhes_visao_cotacao_revisoesanteriores.php?cotacao_principal=<?php echo $cotacao_principal; ?>&setor=<?php echo 'Auditoria' ?>');">
      ...
      <td class="tdconteudo"><?php echo "<font size='1' color='$cor' face='Arial'>$oferta_smart_vivo</font>" ?></td>
       ...
       <td><a href="principal.php?id_cotacao=<?php echo $id_cotacao ?>&cart=<?php echo $carteira ?>&t=forms/formdistribuir_cotacao_servico1_auditoria.php"><font size='1' color='$cor' face='Arial'>ABRIR</font></a>
   
   
    </td>
	<td>
    <a href="principal.php?id_cotacao=<?php echo $id_cotacao ?>&t=controles/sql_excluir_distribuicao_cotacao_auditoria.php"><font size='1' color='$cor' face='Arial'>EXCLUIR</font></a></td>   
...
<?php
 ...
 <input type="hidden" name="cart" value="<?php echo $carteira; ?>"/>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&t=forms/formfiltro_distribuicao_auditoria.php'" class="sb2 bradius" />
