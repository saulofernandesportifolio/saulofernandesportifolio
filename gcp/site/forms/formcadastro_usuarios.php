...
<form style="background:#D4D4D4;" class="bradius" action="principal.php?&t=controles/sql_cadastro_usuario4.php" method="post" enctype="multipart/form-data" name="form1" >
  <p align="center"><b><font color="#337ab7" size="3" face="Gotham Light">Cadastro Usu&aacute;rio <?php echo $page2; ?></font></b></p>
      <br />
 ...
 <p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius">
  <label style="padding-left: 5px;">
    ...
    <?php if( $canal == "%") {?>
      ...
      <?php if($perfil == 1 || $perfil == 4 || $perfil == 21 ){?>
...
<label style="padding-left: 5px;">
  ...
  //seleciona a base de dados para uso
   $query= "SELECT * FROM cip_nv.tbl_supervisor 
        WHERE projeto NOT IN('saiu','GERENTE','B.I') AND tipo_supervisor IN ('TOP','VPG/TOP')  ORDER BY nome";
