...
$data = date("d-m-Y");
   ...
   //Você pode colocar aqui o nome do arquivo que você deseja salvar.
    $excel=new ExcelWriter("site/forms/relatorios/relatorio_erros_pn_$data.$cpf.xls");
...
if(empty($data_1) && empty($data_2) && $_POST['pesquisa'] == 1){
  ...
  $data_2=date('Y-m-d');
   ...
   $sql_servico="CALL bd_erros_pn.exportar_top_nv_errosvpe_pn("."'{$data_1}'".","."'{$data_2}'".")";
...
$sql_servico="CALL bd_erros_pn.exportar_top_nv_errosvpe_pn("."'{$data_1}'".","."'{$data_2}'".")";
 ...
 $sql_servico="CALL bd_erros_pn.exportar_top_nv_erros2vpe_pn("."'{$data_1}'".","."'{$data_2}'".")";
 ...
 if( $num_teste == 0){
  ...
  <?php
    ...
    "<hr>
      <div align='center'>
            <a  target=\"_blank\" href=\"site/forms/relatorios/relatorio_erros_pn_$data.$cpf.xls\">
...
$somefile="site/forms/relatorios/relatorio_erros_pn_$data_1.$cpf.xls";
