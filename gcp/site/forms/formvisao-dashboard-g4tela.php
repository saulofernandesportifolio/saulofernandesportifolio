...
<meta http-equiv="refresh" content="5;url=formvisao_tela4.php"/>
...
<body style="background-image:url(../img/imagem_visao_cip3.png); background-repeat: no-repeat; background-size: 155%">
...
function geraTabela($rs, $headers,$data_1,$data_2)
   {
      ...
      $s.="<tr>";
      $s.="<th colspan='8' bgcolor='#FFFFFF'><p align='center'><font color='#337ab7' size='8'>Analise de input</font></p></th>";
      $s.="</tr>";
      $s.= "<tr>";
...
/* Executa a query */
$rs = mysql_query("SELECT Fora_do_Prazo,Dentro_do_Prazo,Vence_Hoje,Vence_D1,Vence_D2,Vence_DM2 FROM cip_nv.tbl_acumulada_venc WHERE Tipo_de_Processo ='3.Analise de input' GROUP BY Tipo_de_Processo ");
