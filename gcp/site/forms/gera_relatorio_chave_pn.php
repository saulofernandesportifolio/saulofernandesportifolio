...
$data = date("d-m-Y");
   ...
   //Você pode colocar aqui o nome do arquivo que você deseja salvar.
    $excel=new ExcelWriter("site/forms/relatorios/relatorio_chave_pn_$data.$cpf.xls");
...
if(empty($data_1) && empty($data_2) && $_POST['pesquisa'] == 1){
  ...
  $sql_servico="CALL bd_erros_pn.exportar_top_nv_chavevpe_pn("."'{$data_1}'".","."'{$data_2}'".")";
...
$sql_servico="CALL bd_erros_pn.exportar_top_nv_chavevpe_pn("."'{$data_1}'".","."'{$data_2}'".")";
 ...
 $sql_servico="CALL bd_erros_pn.exportar_top_nv_chave2vpe_pn("."'{$data_1}'".","."'{$data_2}'".")";
  ...
  <?php
    ...
    "<hr>
      <div align='center'>
            <a  target=\"_blank\" href=\"site/forms/relatorios/relatorio_chave_pn_$data.$cpf.xls\">
...
$somefile="site/forms/relatorios/relatorio_chave_pn_$data_1.$cpf.xls";
