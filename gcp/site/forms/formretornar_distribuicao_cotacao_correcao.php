...
$data_2=arrumadata2($_POST['data_2']);
 ...
 $sql="CALL cip_nv.visao_correcao_retorno("."'{$_POST['statuscorrecao']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="form1" action="principal.php?&t=forms/formretornar_distribuicao_cotacao_correcao2.php" method="post" id="frm-filtro">
...
?>
 ...
 <?php
  ...
  <input type="hidden" name="statuscorrecao" value="<?php echo $_POST['statuscorrecao'];?>"/>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&t=forms/formhome_operacao.php'" class="sb2 bradius" />
