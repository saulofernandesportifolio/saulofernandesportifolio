...
echo "
       <script type=\"text/javascript\">
        ...
        document.location.replace('principal.php?t=forms/formfiltro_retorno_input.php');
      </script>
 ";
  exit();     
...
$sql="CALL cip_nv.visao_input_retorno("."'{$_POST['statusinput']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="form1" action="principal.php?&t=forms/formretornar_distribuicao_cotacao_input2.php" method="post" id="frm-filtro">
 ...
 <p>Voc&ecirc; tem um total de <?php echo "$num_ cota&ccedil;&otilde;es"?> 
  ...
  <br />
   ...
   <br /><br /><br /><br />
    ...
    <tr>
    <th>
    <?php if ($status_cip == 30 || $status_cip == 11  || $status_cip == 17 ){ ?>
    <input type="checkbox" name="checkbox" id="checkbox" value="1" onclick="return selecionar_todas(this.checked);" disabled="true" /> 
    <?php }else{ ?>
...
<input type="hidden" name="statusinput" value="<?php echo $_POST['statusinput'];?>"/>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&t=forms/formfiltro_redistribuicao_input.php'" class="sb2 bradius" />
