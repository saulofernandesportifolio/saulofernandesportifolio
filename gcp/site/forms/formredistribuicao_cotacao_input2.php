...
<form name="form1" method="post" action="principal.php?&t=controles/sql_redistribuicao_cotacao_input4.php" id="frm-filtro">
...
$sql = "SELECT  a.id_cotacao,
                ...
                WHERE b.status_cip_input NOT IN (7,27) and a.id_cotacao='$id_cotacao' 
             GROUP BY b.dt_distribuicao,a.revisao,a.n_da_cotacao DESC LIMIT 0,20000 ";
...
while($linha_atv = mysql_fetch_assoc($acao))
{
  ...
  $usuario_input        = $linha_atv["idtbl_usuario_input"];
...
?>
     ...
     <td>
      ...
      <td class="tdconteudo"><?php echo "<font size='1' color='$cor' face='Arial'>$CLIENTE TIPO</font>" ?></td>
...
<p>
  <input type="hidden" name="status_cip_input" value="<?php echo $status_cip ?>">
