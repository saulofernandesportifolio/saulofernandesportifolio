...
echo "
       <script type=\"text/javascript\">
        ...
        document.location.replace('principal.php?t=forms/formfiltro_retorno_auditoria.php');
      </script>
 ";
  exit();     
...
$sql="CALL cip_nv.visao_auditoria_retorno("."'{$_POST['statusauditoria']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="form1" action="principal.php?&t=forms/formretornar_distribuicao_cotacao_auditoria2.php" method="post" id="frm-filtro">

<p align="center"><b><font color="#337ab7" size="5" face="Gotham Light">Análise de input</font></b></p>
<br />

<p><font color="#337ab7" size="3" face="Gotham Light"><strong>Lista de Cotações a retornar para distribuir</strong></font></p>
<br />
<?php
...
<input type="hidden" name="statusauditoria" value="<?php echo $_POST['statusauditoria'];?>"/>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&t=forms/formfiltro_retorno_auditoria.php'" class="sb2 bradius" />
