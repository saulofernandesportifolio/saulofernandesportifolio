...
$selecsla="SELECT b.id_cotacao FROM cip_nv.tbl_cotacao a 
           ...
           WHERE (b.status_cip_correcao =20 OR b.status_cip_correcao =21) ";
...
//include('sql.sla_visao_chamado.php');

echo" <script> 
       document.location.replace('principal.php?&t=forms/sql.sla_visao_chamado.php');
      </script>
      ";                                        
    exit();
