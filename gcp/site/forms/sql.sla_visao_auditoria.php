...
$selecsla="SELECT b.id_cotacao FROM cip_nv.tbl_cotacao a 
           ...
           WHERE (b.status_cip_auditoria =13 OR b.status_cip_auditoria =14) ";
...
//include('sql.sla_visao_correcao.php');

echo" <script> 
       document.location.replace('principal.php?&t=forms/sql.sla_visao_correcao.php');
      </script>
      ";                                        
    exit();
