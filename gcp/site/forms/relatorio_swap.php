...
if($perfil != 1 && $perfil != 4 && $perfil != 7 && $perfil != 20 && $perfil != 18 && $perfil != 21 && $perfil != 22 && $perfil != 23){
...
<div class="divrel bradius">
    <form id="form_rel" name="dados" method="post" action="principal.php?t=forms/gera_relatorio_swap.php">
      <br />
        <p align="center"><b><font color="#FF0000">Obs.:&nbsp;Para baixar a base consolidada deixar o campo data inicial e data final em branco.</font></b></p>
          <br />
        <h3 align="center">
            <strong>Gerar Relat&#243;rio Swap</strong>
        </h3>
        <p align="center">&nbsp;</p>
        <p>
            <strong>Tipo</strong>: 
             <input name="pesquisa" id="1" type="radio" value="1" onclick="HabCamposrel()" checked=""/>
            ...
            <font color="464646" size="2" face="Arial, Helvetica, sans-serif">Data da solicitação</font>
       ...
       <p>
        ...
        <p>
         ...
         ?>
            ...
            <input type="button" name="Submit2" value="Voltar" class="sb2 bradius" onclick="window.location='principal.php?t=forms/relatorio_swap_principal.php'" />
      </p>
       <br />
    </form>
</div>
