...
$sql_cotaanalise="CALL cip_nv.fila_analise("."'{$_COOKIE['idtbl_usuario']}'".","."'{$data_1}'".","."'{$data_2}'".")";

$acao_cotacoesanalise = mysql_query($sql_cotaanalise,$conecta) or die (mysql_error());
...
<p><b><font color="#000000" size="2" face="Gotham Light">
  Voc&ecirc; tem um total de <?php echo "$num_analise cota&ccedil;&otilde;es"?> 
...
?>
  <tr bgcolor="#f5f5f5"> 
    ...
    <a href='principal.php?id_cotacao=$id_cotacao&id_analise=$id_analise&t=forms/form_cotacoes_analise.php'>$cotacao_principal</a></font>"; ?></td>
