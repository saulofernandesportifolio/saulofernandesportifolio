...
<form action="principal.php?&t=controles/erros_valida_cadastro.php"  method="POST">
...
<label style="padding-left: 5px;">Status do Pedido:&nbsp;
 <select name="status_do_pedido" id="status_do_pedido" class="txt2comboboxpadrao bradius" onblur="ValidaEntrada(this,'combo');">
                ...
                <option value="Aprov.com falha">Aprov.com falha</option>
              </select></label>
</p>
<br/>
<p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius">
...
?>
 ...
 <input name="cancelar" type="button" value="Cancelar" class="sb2 bradius" onclick="window.location='principal.php?t=forms/form_fila_cotacao_erros_vpe.php'"/>
