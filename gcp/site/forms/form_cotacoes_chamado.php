...
AND (tbl_chamado.status_cip_chamado=31 OR tbl_chamado.status_cip_chamado=33 OR tbl_chamado.status_cip_chamado=32) 
...
return $data2;
 ...
 $sql_verifca = "SELECT a.id_cotacao,
                ...
                ON a.id_cotacao=b.id_cotacao and a.id_cotacao='$id_cotacao' AND b.id_chamado='$id_chamado' AND b.setor_origem='$setor_origem' 
...
<input type="hidden" name="id_cotacaoteste" value="<?php echo $id_cotacao ?>" />
