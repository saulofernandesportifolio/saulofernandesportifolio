...
$idcont=(int) $_GET['idcont'];
 
$sql_verifca = "SELECT 
                b.regional,
                b.uf,
                b.cotacao_atividade_pedido,
                b.criado_em,
                b.segmento,
                b.revisao,
                b.criado_por,
                ...
                b.data_do_enviovivo,
                b.hora_do_enviovivo, 
                b.data_do_retornovivo,
                b.hora_do_retornovivo, 
                b.contestacao_status_cip,
                b.data_da_correcao,
                b.hora_da_correcao,
                b.data_ret_correcao,
                b.hora_ret_correcao
                 FROM  cip_nv.base_contestacoes_cotacao_manual b 
                ...
                LEFT JOIN cip_nv.tbl_turno g ON g.id_filtro=b.turno_ofensor 
                LEFT JOIN cip_nv.cont_contestacao h ON h.id=b.contestacao    
                WHERE  b.id_contestacao_cotacao ='$idcont'
         GROUP BY b.cotacao_atividade_pedido,b.criado_em ASC LIMIT 0,20000 ";
...
<form action="principal.php?&t=controles/valida_cadastromanual_att_contestacao.php"  method="POST">
...
<label style="padding-left: 5px;">cotacao_atividade_pedido:&nbsp;<?php echo  $cotacao_atividade_pedido; ?></a></label>
...
<input  onblur="valida(this,'text');" onkeypress="Formatahora(this,event);" id="hora_do_recebimento" name="hora_do_recebimento" maxlength="5" class="txt2hora bradius" value="<?php echo $linha_atv['hora_do_recebimento']; ?>"/> 
</label>
...
<input  onblur="valida(this,'text');" onkeypress="Formatahora(this,event);" id="hora_retorno" name="hora_retorno" maxlength="5" class="txt2hora bradius" value="<?php if($linha_atv['hora_retorno'] == '00:00:00') { echo $linha_atv['hora_retorno']=''; }else{ echo $linha_atv['hora_retorno']; } ?>" /> </label>
</p>
<br />
<p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius">
<label style="padding-left: 5px;">Remetente:&nbsp;
 <input  onblur="valida(this,'text')" id="remetente" name="remetente" class="txtgrande bradius" value="<?php echo $linha_atv['remetente']; ?>" /></label>
...
<input name="cadastrarerros" type="button" value="Para cadastrar mais erros clik aqui" onclick="javascript:abrir('site/forms/form_cotacoes_contestacao_tipo_de_erros2manual.php?id_contestacao_cotacao=<?php echo $linha_atv['id_contestacao_cotacao']; ?>');" >
<input name="excluirrerros" type="button" value="Para excluir erros clik aqui" onclick="javascript:abrir('site/forms/form_exclui_cotacoes_contestacao_ofensormanual.php?id_contestacao_cotacao=<?php echo $linha_atv['id_contestacao_cotacao']; ?>');" >
<input name="atualizastatus" type="button" value="Para atualizar o status por erro clik aqui" onclick="javascript:abrir('site/forms/form_atualizar_cotacoes_contestacao_status_1.php?id_contestacao_cotacao=<?php echo $linha_atv['id_contestacao_cotacao']; ?>');" >
</label></p>
...
<p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius">
<label style="padding-left: 5px;">Data envio e-mail:&nbsp;
<input  onblur="valida(this,'text');" onkeypress="Formatadata(this,event);" id="data_envio_email" name="data_envio_email" maxlength="10" class="txt2data bradius" value="<?php echo arrumadata($linha_atv['data_envio_email']); ?>"/></label>
<label style="padding-left: 5px;">Hora envio e-mail:&nbsp;
<input  onblur="valida(this,'text');" onkeypress="HoraMinuto(event,this);" id="hora_envio_email" name="hora_envio_email" maxlength="5" class="txt2hora bradius" value="<?php echo substr($linha_atv['hora_envio_email'],0,5); ?>"/> 
</label>
</p>   
 <br />
<p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius">
<label style="padding-left: 5px;">Status Cip:&nbsp;
    
      
<?php if($linha_atv['contestacao_status_cip'] == '1'){ 
         $sel="checked";
         $sel2="";
         $sel22="none";
         $selc="";
 ...
 }if($linha_atv['contestacao_status_cip'] == '2'){  
         $sela="checked";
         $sel2="none";
         $sel22="none";
         $sel="";
         $selc="";
 }if($linha_atv['contestacao_status_cip'] == '3'){ 
         $selb="checked";
         $sel2="none";
         $sel22="none";
         $sel="";
 ...
 }if($linha_atv['contestacao_status_cip'] == '4'){ 
         $selc="checked";
         $sel22="";
         $sel2="none";
 ...
 ?>
 <input name="contestacao_status_cip" type="radio" id="1" value="1" onclick="HabCampos()" <?php echo $sel; ?>/>Pendente de correção   
 <input name="contestacao_status_cip" type="radio" id="2" value="2" onclick="HabCampos()" <?php echo $sela; ?>/>Tratando
 <input name="contestacao_status_cip" type="radio" id="3" value="3" onclick="HabCampos()" <?php echo $selb; ?>/>Tratado
 <input name="contestacao_status_cip" type="radio" id="4" value="4" onclick="HabCampos()" <?php echo $selc; ?>/>Pendente qualidade 
</label>    
  
</p>
<br />
<label id="campos" style="display:<?php echo $sel2; ?>">
 <p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius"> 
<label style="padding-left: 5px;">Envio correção:&nbsp;
<input  onblur="ValidaEntrada('date',this);" onkeypress="Formatadata(this,event);" id="data_da_correcao" name="data_da_correcao" maxlength="10" class="txt2data bradius" value="<?php if($linha_atv['data_da_correcao'] == '0000-00-00'){ echo $linha_atv['data_da_correcao']=''; }else{ echo arrumadata($linha_atv['data_da_correcao']); } ?>" placeholder="  Digitar Data "/></label>
<label style="padding-left: 5px;">Envio correção:&nbsp;
<input  onblur="ValidaEntrada('hora',this);" onkeypress="HoraMinuto(event,this);" id="hora_da_correcao" name="hora_da_correcao" maxlength="5" class="txt2hora bradius" value="<?php if($linha_atv['hora_da_correcao'] == '00:00:00'){ echo $linha_atv['hora_da_correcao']=''; }else{ echo substr($linha_atv['hora_da_correcao'],0,5);} ?>" placeholder="Dig. Hora"/> 
</label>
<label style="padding-left: 5px;">Retorno correção:&nbsp;
<input  onblur="valida(this,'text');" onkeypress="Formatadata(this,event);" id="data_ret_correcao" name="data_ret_correcao" maxlength="10" class="txt2data bradius" value="<?php if($linha_atv['data_ret_correcao'] == '0000-00-00'){ echo $linha_atv['data_ret_correcao']=''; }else{ echo arrumadata($linha_atv['data_ret_correcao']); } ?>" placeholder="  Digitar Data "/></label>
<label style="padding-left: 5px;">Retorno correção:&nbsp;
<input  onblur="valida(this,'text');" onkeypress="HoraMinuto(event,this);" id="hora_ret_correcao" name="hora_ret_correcao" maxlength="5" class="txt2hora bradius" value="<?php if($linha_atv['hora_ret_correcao'] == '00:00:00'){ echo $linha_atv['hora_ret_correcao']='';}else{ echo substr($linha_atv['hora_ret_correcao'],0,5);} ?>" placeholder="Dig. Hora"/> 
</label>     
</p>
<br />     
</label>  

<label id="campos2" style="display:<?php echo $sel22; ?>">
 <p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius"> 
<label style="padding-left: 5px;">Envio qualidade:&nbsp;
<input  onblur="ValidaEntrada('date',this);" onkeypress="Formatadata(this,event);" id="data_do_enviovivo" name="data_do_enviovivo" maxlength="10" class="txt2data bradius" value="<?php if($linha_atv['data_do_enviovivo'] == '0000-00-00'){ echo $linha_atv['data_do_enviovivo']=''; }else{ echo arrumadata($linha_atv['data_do_enviovivo']);} ?>" placeholder="  Digitar Data "/></label>
<label style="padding-left: 5px;">Envio qualidade:&nbsp;
<input  onblur="ValidaEntrada('hora',this);" onkeypress="HoraMinuto(event,this);" id="hora_do_enviovivo" name="hora_do_enviovivo" maxlength="5" class="txt2hora bradius" value="<?php if($linha_atv['hora_do_enviovivo'] == '00:00:00'){ echo $linha_atv['hora_do_enviovivo']=''; }else{ echo substr($linha_atv['hora_do_enviovivo'],0,5); } ?>" placeholder="Dig. Hora"/> 
</label>
<label style="padding-left: 5px;">Ret. qualidade:&nbsp;
<input  onblur="valida(this,'text');" onkeypress="Formatadata(this,event);" id="data_do_retornovivo" name="data_do_retornovivo" maxlength="10" class="txt2data bradius" value="<?php if($linha_atv['data_do_retornovivo'] == '0000-00-00'){ echo $linha_atv['data_do_retornovivo']=''; }else{ echo arrumadata($linha_atv['data_do_retornovivo']);} ?>" placeholder="  Digitar Data "/></label>
<label style="padding-left: 5px;">Ret. qualidade:&nbsp;
<input  onblur="valida(this,'text');" onkeypress="HoraMinuto(event,this);" id="hora_do_retornovivo" name="hora_do_retornovivo" maxlength="5" class="txt2hora bradius" value="<?php if($linha_atv['hora_do_retornovivo'] == '00:00:00'){ echo $linha_atv['hora_do_retornovivo']=''; }else{ echo substr($linha_atv['hora_do_retornovivo'],0,5); } ?>" placeholder="Dig. Hora"/> 
</label>     
</p>
<br />     
      </label>
