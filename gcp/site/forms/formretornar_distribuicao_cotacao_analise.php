...
$data_2=arrumadata2($_POST['data_2']);
  ...
  $sql="CALL cip_nv.visao_analise_retorno("."'{$_POST['statusanalise']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="myform" action="principal.php?&t=forms/formretornar_distribuicao_cotacao_analise2.php" method="post" id="frm-filtro">
...
<input type="hidden" name="statusanalise" value="<?php echo $_POST['statusanalise'];?>"/>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?t=forms/formfiltro_retorno_analise.php'" class="sb2 bradius" />
