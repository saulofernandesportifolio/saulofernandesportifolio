...
<div class="divrel bradius">
    <form id="form_rel" name="dados" method="POST" action="site/forms/gera_relatorio_bi.php?idtbl_usuario=<?php echo $idtbl_usuario ?>">
      <br />
 ...
 <br />
        ...
        <?php 
         ...
         ?>
<input type="hidden" name="idtbl_usuario" value="<?php echo $_COOKIE['idtbl_usuario'] ?>" />

            <input type="submit" name="bt_enviar" id="bt_enviar" value="Gerar" class="sb2 bradius" />
            <input type="button" name="Submit2" value="Voltar" class="sb2 bradius" onclick="window.location='principal.php?&t=forms/formhome_operacao.php'" />
      </p>
       <br />
    </form>
</div>
