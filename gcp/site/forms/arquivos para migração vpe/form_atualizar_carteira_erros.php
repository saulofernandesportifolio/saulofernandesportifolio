...
if($perfil != 1 && $perfil != 4 && $perfil != 19 && $perfil != 17){
...
<div id="resolucao">
    ...
    <div style="margin-left: 30px;"><input type="button" class="sb3 bradius" name="novo" id="novo" value="Novo" onclick="window.location='principal.php?&t=forms/form_cadastro_carteira_erros.php'" /></div>
    <br />  
    <form action="principal.php?t=forms/form_atualizar_carteira2_erros.php" method="POST">
        <h3 align="center" style="background: #735D25"><font color="#FFFFFF">Aualizar Carteira Erros</font></h3><br />
        <div class="acomodar">
        <p>CNPJ:</p><br />
         <p>
