...
<div id="resolucao">
  <div id="filtro" class="form bradius">
    <form action="principal.php?t=forms/form_fila_cotacao_top_tt_chamado.php" method="POST">
        <h3 align="center" style="background: #735D25"><font color="#FFFFFF">SELECIONE O FILTRO TT</font></h3><br />
        <div class="acomodar">
        <p>Filtrar:
          <select name="tratativach" id="tratativach">
          <option value="%" selected="selected">Selecione</option>
          <option value="31">Aguardando chamado</option>
