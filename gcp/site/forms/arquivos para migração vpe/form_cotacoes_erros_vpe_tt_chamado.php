...
return $data2;
      ...
      $sql_erros = "SELECT DISTINCT a.idch,
                                  b.id,                                 
                                  b.pedido,
                                  a.comentario,
                                  b.comentario_vivocorp,
                                  b.tipo,
                                  b.motivo_erro,
				  b.cliente,
                                  b.status,
				  ...
				  b.transferencia_titularidade,
                                  ...
                                  b.criado_por,
                                  b.nome_do_gestor,
                                  a.idtbl_usuario_chamado
                      FROM bd_erros_pn.base_erros_top_tt_chamado a 
                      INNER JOIN bd_erros_pn.base_erros_top_tt b 
                      ON b.id=a.id  
                      WHERE a.idch ='$idch'";
...
<form action="principal.php?&t=controles/erros_update_cadastro_vpe_tt_chamado.php"  method="POST">
...
<label style="padding-left: 5px;">Status&nbsp;
                           <select name="status_tp" class="txt2comboboxpequenino bradius" disabled="true">
...
<input name="id1" type="hidden"  class="input" value="<?php echo "$idch" ?>">
<input name="id2" type="hidden"  class="input" value="<?php echo "$id" ?>">
...
?>
<input name="comentarioantigo" type="hidden"  value="<?php echo $comentario ?>" />
 ...
 <input name="cancelar" type="button" value="Cancelar" class="sb2 bradius" onclick="window.location='principal.php?t=forms/form_fila_cotacao_erros_top_tt_chamado.php'"/>
