...
<div id="resolucao">
   ...
   <form action="principal.php?t=forms/formretornar_distribuicao_erros_top_tt.php" method="POST" 
   onsubmit="PreventMultipleSubmit7();showLoader6();">
        <h3 align="center" style="background: #735D25"><font color="#FFFFFF">SELECIONE O FILTRO ERROS</font></h3><br />
        <div class="acomodar3">
         <p>Status:
...
<div align="center">
 ...
 <img id="loader6" src="site/forms/img/carregando6.gif" />
