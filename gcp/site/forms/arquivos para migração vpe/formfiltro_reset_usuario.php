...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/formreset_usuarios.php" method="POST">
        <h3 align="center" style="background: #735D25"><font color="#FFFFFF">SELECIONE O FILTRO RESET</font></h3><br />
        <div class="acomodar">
       ...
       <?php
        ...
        $query= "SELECT * FROM cip_nv.tbl_supervisor WHERE projeto NOT IN('saiu','GERENTE','B.I') AND tipo_supervisor IN ('VPE/TOP','VPE') ORDER BY nome";
