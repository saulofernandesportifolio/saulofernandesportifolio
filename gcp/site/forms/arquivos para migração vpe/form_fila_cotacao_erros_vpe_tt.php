<head> 
    <meta http-equiv="refresh" content="url=principal.php?&t=forms/form_fila_cotacao_erros_top_tt.php"/>
    </head>
...
?>
  <tr bgcolor="#f5f5f5"> 
    <td class="tdconteudo"><?php echo "<font size='1' color='$cor' face='Arial'><a href=\"principal.php?&id=$id&t=forms/form_cotacoes_erros_top_tt.php\">$pedido</a></font>"; ?></td>
    ...
    <td class="tdconteudo"><?php echo "<font size='1' color='$cor' face='Arial'>$status_cip</font>" ?></td>
      <td>
    <a href="principal.php?id=<?php echo $id ?>&t=controles/sql_excluir_erros_top_tt.php">EXCLUIR</a></td>
 </tr>
  <?php
  }
}
