...
$sql = "SELECT count(idtbl_usuario)as total FROM cip_nv.tbl_usuarios WHERE idtbl_usuario in($dados)               
...
<form name="form1" method="post" action="principal.php?&t=controles/sql_reset_usuario4.php" id="frm-filtro">
...
<p>
  ...
  <input type="submit" name="Submit" value="Efetuar Reset" class="sb2 bradius" />
 </p>
</form>
</div>
</div>
