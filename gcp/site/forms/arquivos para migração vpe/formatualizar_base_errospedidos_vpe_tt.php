...
<div style="border: #735D25 solid; padding: 3px 3px 3px 3px; width: 800px; left: 20%; position:relative; z-index: 0;" class="bradius">
  ...
  <p><font color="#FF0000" >
   ...
   <br/>
   <p><font color="#FF0000" >
   campo CARTEIRA: *VPG* OR *VPK* OR *TOP*</font></p>
   <br/>
   <p><font color="#FF0000" >
...
<form style="background:#E7E4D1;" class="bradius" action="principal.php?&t=controles/carregar_base_errospedidos_top_tt.php" 
