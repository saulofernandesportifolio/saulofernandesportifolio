...
$sql = "SELECT * FROM cip_nv.tbl_usuarios 
                  WHERE perfil NOT IN (4) 
                        and id_supervisor LIKE '{$_POST['sup']}' 
                        and perfil LIKE '{$_POST['setor']}' 
                        and status=1                 
...
<p><font color="#337ab7" size="4" face="Gotham Light"><strong>Lista de <?php echo $num ?> usuários</strong></font></p>
<br />
