...
//include("../../gala/bd.php");
 //include("../../bd.php");
ini_set ( 'mysql.connect_timeout' ,  '900000' ); 
ini_set ( 'default_socket_timeout' ,  '900000' );
...
<form name="form1" action="principal.php?t=controles/sql_filha_pesquisa_cotacao_input4.php" method="post" id="frm-filtro">
<br />
   ...
   <p><font color="#000000" size="3" face="Gotham Light">
    ...
    <select class="txt2comboboxgrande" class="sb" name="cotacaovinculo" id="cotacaovinculo">
          ...
          <?php
                     ...
                     $sql = "SELECT * FROM cip_nv.tbl_cotacao a 
