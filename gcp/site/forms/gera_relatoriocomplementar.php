...
if(empty($data_1) && empty($data_2) && $_POST['pesquisa'] == 1){
  ...
  $sql_servico="CALL cip_nv.consolida1complementar("."'{$data_1}'".","."'{$data_2}'".","."'{$lg2}'".","."'{$turno}'".","."'{$setor}'".")";
...
$sql_servico="CALL cip_nv.consolida2complementar("."'{$data_1}'".","."'{$data_2}'".","."'{$lg2}'".","."'{$turno}'".","."'{$setor}'".")";
 ...
 $sql_servico="CALL cip_nv.consolida3complementar("."'{$data_1}'".","."'{$data_2}'".","."'{$lg2}'".","."'{$turno}'".","."'{$setor}'".")";
