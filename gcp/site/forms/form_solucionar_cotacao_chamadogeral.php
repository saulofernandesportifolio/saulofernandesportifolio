...
$timestamp = strtotime($data . "-9 months 0 days");
// Exibe o resultado
...
if($_POST['substatusvivocorp'] == 'C'){
 ...
 $substatusvivocorp='Auditoria';  
    
}

if($_POST['substatusvivocorp'] == 'D'){
  
 $substatusvivocorp='Correção';  
    
}

if($_POST['substatusvivocorp'] == 'E'){
  
 $substatusvivocorp='Swap';  
...
$data_2=arrumadata2($_POST['data_2']);
 ...
 $sql="CALL cip_nv.visao_chamado_solucionar("."'34'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="form1" action="principal.php?&t=forms/form_solucionar_cotacao_chamadogeral2.php" method="post" id="frm-filtro">
...
while($linha_atv = mysql_fetch_array($acao)){
...
?>
     <tr>
     <td>
      <input name="ling[]" type="checkbox" id="ling[]" value="<?php echo $id_chamado; ?>"  /></td>
  ...
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?t=forms/formfiltro_redistribuicao_chamado.php'" class="sb2 bradius" />
