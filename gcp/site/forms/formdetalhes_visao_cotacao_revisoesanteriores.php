...
$cotacao_principal= (string) $_GET['cotacao_principal'];
...
if($setor == 'Analise' || $setor == 'Análise' ){
 ...
 $sql = "SELECT DISTINCT a.id_cotacao,
                ...
                WHERE  b.status_cip_analise NOT IN (3,4) AND a.cotacao_principal='{$_GET['cotacao_principal']}' 
                 AND SUBSTRING(a.criado_em,1,10) BETWEEN '$data_1' and '$data_2' 
              ORDER BY a.id_cotacao,b.dt_distribuicao DESC  ";
...
$sql = "SELECT   a.id_cotacao,
                ...
                WHERE  b.status_cip_input NOT IN (7,8) 
                AND a.cotacao_principal='{$_GET['cotacao_principal']}' 
                 AND SUBSTRING(a.criado_em,1,10) BETWEEN '$data_1' and '$data_2' 
...
$sql = "SELECT   a.id_cotacao,
                ...
                WHERE b.status_cip_auditoria NOT IN (13,14) 
                AND a.cotacao_principal='{$_GET['cotacao_principal']}' 
                AND SUBSTRING(a.criado_em,1,10) BETWEEN '$data_1' and '$data_2'   
        GROUP BY a.cotacao_principal
        ORDER BY a.id_cotacao,b.dt_distribuicao DESC ";
...
$sql = "SELECT  a.id_cotacao,
                ...
                WHERE b.status_cip_correcao NOT IN (20,21) 
                AND a.cotacao_principal='{$_GET['cotacao_principal']}' 
                AND SUBSTRING(a.criado_em,1,10) BETWEEN '$data_1' and '$data_2' 
        GROUP BY a.cotacao_principal
        ORDER BY a.id_cotacao,b.dt_distribuicao DESC ";
...
if($setor == 'chamado' || $setor == 'Chamado'){
...
$sql = "SELECT  a.id_cotacao,
                ...
                WHERE b.status_cip_chamado NOT IN (30,31)  
                AND a.cotacao_principal='{$_GET['cotacao_principal']}' 
                AND SUBSTRING(a.criado_em,1,10) BETWEEN '$data_1' and '$data_2' 
        GROUP BY a.cotacao_principal
        ORDER BY a.id_cotacao,b.dt_distribuicao DESC  ";
...
<p><font color="#337ab7" size="4" face="Gotham Light"><strong>Lista de cotações a revisões anteriores</strong></font></p>
<br />
<?php
