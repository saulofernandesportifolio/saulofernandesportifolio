...
<form name="formulario" action="principal.php?t=controles/cadastrar_remetente.php" method="post">
 
   <p align="center"><b><font color="#337ab7" size="4" face="Gotham Light">Cadastro Remetente <?php echo $page2; ?></font></b></p>
      <br />
