...
$sql = "SELECT a.cotacao_atividade_pedido,
...
<form name="form1" action="../controles/sql_atualizar_cotacoes_contestacao_status4_1.php" method="post" id="frm-filtro">

<br />

<p><font color="#337ab7" size="4" face="Gotham Light"><strong>Lista</strong></font></p>
<br />
<?php
 ...
 <p>Voc&ecirc; tem um total de <?php echo "$num_ cota&ccedil;&otilde;es"?> 
  ...
  <br />
   ...
   <br /><br /><br /><br />
    ...
    <thead> 
    <tr>
    <th><font size='1'  face='Arial'>ATIVIDADE/PEDIDO/COTAÇÃO</font></th>
