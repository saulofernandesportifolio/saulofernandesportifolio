...
if($_POST['statuscorrecao'] == '30'){
   $_POST['statuscorrecao']='33';
}

 $sql="CALL cip_nv.visao_correcao_redistribuicao("."'{$_POST['statuscorrecao']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="form1" action="principal.php?&t=forms/formredistribuicao_cotacao_correcao2.php" method="post" id="frm-filtro">
