...
foreach($_POST["ling"] as $id_setor)
{


 
$separa = explode(";",$id_setor); 
$separa[0];
$separa[1];
$separa[2];

 /*echo "este e a id cotacao: ".*/$id_cotacao=$separa[0];
 //echo '<br>';
 /*echo "este e o setor: ".*/$setor2=$separa[1];
 //echo '<br>';
 /*echo "este e a id setor: ".*/$idsetor=$separa[2];
...
<form name="form1" method="post" action="../controles/sql_detalhes_visao_cotacao_pendentes4_tl.php" id="frm-filtro">

<p align="center"><b><font color="#337ab7" size="5" face="Gotham Light"><?php echo $setor2; ?></font></b></p>
<br />
...
<br /><br />
   ...
   <tr>
    ...
    <th><font size='1'>SADMIN</font></th>
    <th><font size='1'>SETOR TRAMITE</font></th>
  </tr>
    </thead>
         <tbody>
...
if($setor2 == "Analise"){
 ...
 $sql = "SELECT DISTINCT a.id_cotacao,
                ...
                AND b.id_analise='$idsetor' 
                ORDER BY b.dt_distribuicao ASC ";   
...
<p>
 <input type="hidden" name="setor" value="<?php echo $setor2 ?>"/>   
