...
$sql_cotaanalise="CALL bd_erros_pn.fila_erros_pn("."'{$cpf}'".","."'{$_POST['status_tpf']}'".")";
...
<p><b><font color="#000000" size="2" face="Gotham Light">
  Voc&ecirc; tem um total de <?php echo "$num_analise pedidos"?> 
    ...
    <form name="myform" method="POST" action="principal.php?&t=forms/form_fila_cotacao_erros_pn.php" id="frm-filtro">
   ...
   <br /><br /><br /><br />
   <p>
   <input type="button" name="Submit2" class="sb3 bradius" value="cadastrar manualmente" onclick="window.location='principal.php?t=forms/form_cotacoes_erros_pn_manual.php'"/>
        &nbsp;&nbsp;&nbsp;Filtras por status&nbsp;
...
?>
  <tr bgcolor="#f5f5f5"> 
    <td class="tdconteudo"><?php echo "<font size='1' color='$cor' face='Arial'><a href=\"principal.php?&id=$id&t=forms/form_cotacoes_erros_pn.php\">$pedido</a></font>"; ?></td>
    ...
    <td class="tdconteudo"><?php echo "<font size='1' color='$cor' face='Arial'>$status_cip</font>" ?></td>
      <td>
    <a href="principal.php?id=<?php echo $id ?>&t=controles/sql_excluir_erros_pn.php">EXCLUIR</a></td>
 </tr>
  <?php
  }
}
