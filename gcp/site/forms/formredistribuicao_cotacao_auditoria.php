...
if($_POST['statusauditoria'] == '17'){
   $_POST['statusauditoria']='33';
}

 $sql="CALL cip_nv.visao_auditoria_redistribuicao("."'{$_POST['statusauditoria']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="form1" action="principal.php?&t=forms/formredistribuicao_cotacao_auditoria2.php" method="post" id="frm-filtro">
...
?>
 ...
 <?php
  ...
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?t=forms/formfiltro_redistribuicao_auditoria.php'" class="sb2 bradius" />
