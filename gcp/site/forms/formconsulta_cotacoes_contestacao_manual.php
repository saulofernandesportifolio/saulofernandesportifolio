...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/formconsulta_cotacoes_contestacao2_manual.php" method="POST">
        <h3 align="center" style="background: #337ab7"><font color="#FFFFFF">Pesquisar antes de cadastrar manualmente</font></h3><br />
        <div class="acomodar">
      ...
      <br/> 
        ...
        <!--principal-->
          <br/><br/>
          <form action="principal.php?t=forms/formcadastromanual_cotacoes_contestacao2.php" method="POST">
