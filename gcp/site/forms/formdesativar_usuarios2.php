...
<form name="form1" method="post" action="principal.php?&t=controles/sql_desativar_usuario4.php" id="frm-filtro">
...
?>
  ...
  <input type="submit" name="Submit" value="Desativar" class="sb2 bradius" />
 </p>
</form>
</div>
</div>
