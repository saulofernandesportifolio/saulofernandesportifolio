...
echo "
       <script type=\"text/javascript\">
        ...
        document.location.replace('principal.php?t=forms/formfiltro_redistribuicao_input.php');
      </script>
 ";
...
if($_POST['statusinput'] == '11'){
   $_POST['statusinput']='33';
}



 $sql="CALL cip_nv.visao_input_redistribuicao("."'{$_POST['statusinput']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="form1" action="principal.php?&t=forms/formredistribuicao_cotacao_input2.php" method="post" id="frm-filtro">
