...
if( $num_ == 0 && !empty($id_atv)){

echo "<script>
            alert('efetue o cadastro na base esta atividade.');
            document.location.replace('principal.php?id_atv=$id_atv&t=forms/form_diretoria_atv.php');
         </script>";

}elseif( $num_ == 1 && !empty($id_atv)){
...
<p align="center"><b><font color="#337ab7" size="3" face="Gotham Light">Resumo - atividades</font></b></p>
<br />

<p><font color="#a0873c" size="2" face="Gotham Light"><strong>Lista de Atividades</strong></font></p>
<br />


 <p><?php echo "<font color='#000000' size='2' face='Gotham Light'>Total de  $num_ atividades</font>"?>:</font></p>
  <br />
      <p>
...
while($linha_atv = mysql_fetch_assoc($acao32))
{
...
?>
    <tr>
     ...
     <td class="tdconteudo"><?php echo "<a href='principal.php?&id=$id_diretoria&t=forms/form_diretoria_tt_atv.php'><font size='1' color='$cor' face='Arial'>$cotacao_atividade</font></a>" ?></td>
