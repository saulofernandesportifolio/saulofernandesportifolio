...
/*echo "este é o cookie ".*/ $carteira=$_COOKIE['cnpj'];



$sql="CALL cip_nv.visao_pesquisa_carteira("."'{$_POST['cnpj']}'".")";
...
<p align="center"><b><font color="#a0873c" size="5" face="Gotham Light">Cliente</font></b></p>
<br />
...
?>
     ...
     <tr>
      ...
      <td>
      <a href="javascript:abrirrevisaocart('site/forms/form_atualizar_carteira3.php?cpf_cnpj=<?php echo $cpf_cnpj ?>');">EDITAR</a></td>
    </tr>
    <?php
  	}
	?>
