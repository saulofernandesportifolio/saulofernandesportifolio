...
<script type="text/javascript">
    function PreventMultipleSubmit11(){
      document.getElementById("entrar10").disabled=true;
      document.getElementById("entrar10").style.backgroundColor = "#000";
    }
...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/formretornar_distribuicao_cotacao_chamado.php" method="POST" 
    onsubmit="PreventMultipleSubmit11();showLoader10();">
        ...
        <p>Status GALA:
          ...
          <option value="30">Aguardando chamado</option>
      ...
      <br/>
      &nbsp;&nbsp;&nbsp;&nbsp; 
      <input type="submit" class="sb2 bradius" name="entrar10" id="entrar10" value="       OK       "  />
...
<div align="center" class="barraloaderimg">
 ...
 <img id="loader10" src="site/forms/img/load.gif" width="300" height="50" />
