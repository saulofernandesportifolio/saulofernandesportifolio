...
$sql = "SELECT * FROM cip_nv.tbl_usuarios b
        WHERE b.usuario IS NULL
        ORDER BY b.nome ASC LIMIT 0,20000 ";
...
<p><font color="#337ab7" size="4" face="Gotham Light"><strong>Lista de <?php echo $num ?> usuários criado acesso com sucesso</strong></font></p>
<br />
