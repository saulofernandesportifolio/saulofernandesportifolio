...
$sql="CALL cip_nv.visao_pesquisa_carteira("."'{$cnpj}'".")";
...
?>
     ...
     <tr>
      ...
      <td>
      <a href="javascript:abrirrevisaocart('site/forms/form_atualizar_carteira3.php?cpf_cnpj=<?php echo $cpf_cnpj ?>&idtbl_usuario=<?php echo $idtbl_usuario ?>');">EDITAR</a></td>
      <td>
      <a href="principal.php?cpf_cnpj=<?php echo $cpf_cnpj ?>&t=controles/sql_form_excluir_atualizar_carteira3.php">EXCLUIR</a></td>
    </tr>
    <?php
  	}
	?>
