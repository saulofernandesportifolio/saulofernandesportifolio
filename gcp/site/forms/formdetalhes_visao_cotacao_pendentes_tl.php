...
<form name="form1" action="../forms/formdetalhes_visao_cotacao_pendentes2_tl.php" method="post" id="frm-filtro">
...
while($linha_atv = mysql_fetch_assoc($acao))
{
  ...
  $id_setor           = $linha_atv["id_cotacao"].";".$linha_atv['setor'].";".$linha_atv['id_setor'];
...
?>
     <tr>
     <td>
     <?php if ($status_cip == 30 || $status_cip == 11  || $status_cip == 17 || $status_cip == 2 ){ ?>
      <input name="ling[]" type="checkbox" id="ling[]" value="<?php echo $id_setor; ?>"  disabled="true" />
    
      <?php }else{ ?>
          <input name="ling[]" type="checkbox" id="ling[]" value="<?php echo $id_setor; ?>"/>
