...
<div class="divrel bradius">
    <form id="form_rel" name="dados" method="POST" action="principal.php?t=forms/gera_relatoriocipantigo.php">
      <br />
        <p align="center"><b><font color="#FF0000">Obs.:&nbsp;Para baixar a base consolidada CIP - ANTIGO deixar o campo data inicial e data final em branco.</font></b></p>
          <br />
        <h3 align="center">
