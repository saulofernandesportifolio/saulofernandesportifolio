<head> 
    <meta http-equiv="refresh" content="url=principal.php?&t=forms/form_fila_cotacao_pn_pos_analise.php"/>
    </head>
...
$sql_cotaanalise="CALL bd_erros_pn.fila_pn_pos_analise("."'{$_COOKIE['idtbl_usuario']}'".","."'{$cpf}'".")";
...
<p><b><font color="#337ab7" size="3" face="Gotham Light">Lista 
  de portabilidades para serem analisadas na pos analises</b></font></p>
<br />
<p><b><font color="#000000" size="2" face="Gotham Light">
  Voc&ecirc; tem um total de <?php echo "$num_analise pedidos"?> 
   ...
   <br /><br /><br /><br />
     ...
     <input type="button" name="Submit2" class="sb2 bradius" value="Pos-logistica" onclick="window.location='principal.php?t=forms/form_fila_cotacao_pn_pos_logistica.php'"/>
    ...
    <form name="myform" method="post" action="principal.php?t=controles/sql.cadastro_pn.php">
...
<td>
<a href="javascript:abrir('site/forms/form_efetuar_cadastro_pn_pos_analise.php?id_pn=<?php echo $id_pn ?>&id_user=<?php echo $idtbl_usuario  ?>');">
