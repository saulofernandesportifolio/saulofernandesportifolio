...
a.visao_ilha,
a.vencimento_ilha
FROM cip_nv.tbl_cotacao a INNER JOIN cip_nv.tbl_correcao b ON b.id_cotacao=a.id_cotacao 
AND ( b.status_cip_correcao= 20 OR b.status_cip_correcao= 21 )";
...
$timestamp = strtotime($data . "-8 months 0 days");
// Exibe o resultado
...
//$sql="CALL visao_correcao_distribuicao("."'20,27'".")";
//$sql="CALL visao_correcao_distribuicao("."'20'".","."'{$carteira}'".")";
//$sql="CALL visao_correcao_distribuicao("."'27'".")";

if($carteira == '%'){
 $sql="CALL cip_nv.visao_correcao_distribuicao_TODOS("."'20'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}elseif($carteira == 'GOV'){
 $sql="CALL cip_nv.visao_correcao_distribuicao_GOV("."'20'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}elseif($carteira == 'TOP'){
 $sql="CALL cip_nv.visao_correcao_distribuicao_TOP("."'20'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}elseif($carteira == 'VIP'){
 $sql="CALL cip_nv.visao_correcao_distribuicao_VIP("."'20'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}elseif($carteira == 'TOPVIP'){
 $sql="CALL cip_nv.visao_correcao_distribuicao_TOP_VIP("."'20'".","."'{$carteira}'".","."'{$data_1}'".","."'{$data_2}'".")";
 //$sql="CALL visao_input_distribuicao("."'27'".")";
}
...
<form name="form1" action="principal.php?&t=forms/formdistribuir_cotacao_correcao2.php" method="post" id="frm-filtro">

<p align="center"><b><font color="#337ab7" size="5" face="Gotham Light">Correção</font></b></p>
<br />
 ...
 <p>Voc&ecirc; tem um total de <?php echo "$num_ cota&ccedil;&otilde;es"?> 
  ...
  <br />
   ...
   <br /><br /><br /><br />
    ...
    <table border="0" class="lista-clientes bradius">
    <thead> 
    <tr>
    <th>
...
?>
     ...
     <td>
      ...
      <td class="tdconteudo"><?php echo "<font size='1' color='$cor' face='Arial'>$cliente_tipo</font>" ?></td>
       <td class="tdconteudo">
            <a href="javascript:abrirrevisao('site/forms/formdetalhes_visao_cotacao_revisoesanteriores.php?cotacao_principal=<?php echo $cotacao_principal; ?>&setor=<?php echo 'Correcao' ?>');">
     ...
     <td><a href="principal.php?id_cotacao=<?php echo $id_cotacao ?>&cart=<?php echo $carteira ?>&t=forms/formdistribuir_cotacao_servico1_correcao.php">ABRIR</a>
   
   
    </td>
	<td>
    <a href="principal.php?id_cotacao=<?php echo $id_cotacao ?>&t=controles/sql_excluir_distribuicao_cotacao_correcao.php">EXCLUIR</a></td>    

    </tr>
    <?php

    //contagem sla
   include("site/forms/controles/sql.sla.php");
 ...
 <input type="hidden" name="cart" value="<?php echo $carteira; ?>"/>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&t=forms/formfiltro_distribuicao_correcao.php'" class="sb2 bradius" />
