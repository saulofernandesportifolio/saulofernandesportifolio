...
$selecsla="SELECT b.id_cotacao FROM cip_nv.tbl_cotacao a 
           ...
           WHERE (b.status_cip_chamado =30 OR b.status_cip_chamado =31 OR b.status_cip_chamado=33) ";
...
echo $query_linha="UPDATE cip_nv.tbl_cotacao a SET  
...
echo" <script> 
       document.location.replace('principal.php?&t=forms/formvisao2.php');
      </script>
      ";                                        
    exit();
