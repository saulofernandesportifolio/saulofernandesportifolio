...
<form name="form1" method="post" action="principal.php?&t=controles/sql_retornardistribuicao_cotacao_chamado4.php" id="frm-filtro">
...
GROUP BY b.dt_distribuicao,a.id_cotacao ASC LIMIT 0,20000";
