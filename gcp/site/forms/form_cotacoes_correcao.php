...
while($linha_atv = mysql_fetch_assoc($acao_verifica))
{
 ...
 $sql ="SELECT DISTINCT count(a.id_cotacao) as total 
                     ...
                     INNER JOIN cip_nv.tbl_correcao c
...
<br/>
<p align="center"  class="tituloform bradius"><font size="5" style="text-align: center;">Correção</font></p><br/>
...
<select name="substatus" id="substatus" onblur="ValidaEntrada(this,'combo');" class="txt2comboboxpadrao bradius">
  ...
  //seleciona a base de dados para uso
   $query= "SELECT * FROM cip_nv.tbl_substatus WHERE setor='correcao' ORDER BY id_status";
...
<select name="motivodaacao" id="motivodaacao" onblur="ValidaEntrada(this,'combo');" class="txt2comboboxpadrao bradius">
  ...
  //seleciona a base de dados para uso
   $query= "SELECT * FROM cip_nv.tbl_motivos_da_acao WHERE setor='correcao' ORDER BY id";
   $result= mysql_query($query,$conecta);
   while($dado= mysql_fetch_array($result)){
...
$sql_filha="SELECT a.id_cotacao,
             ...
             f.nome
FROM cip_nv.tbl_cotacao a
left JOIN cip_nv.tbl_correcao c
ON  c.id_cotacao=a.id_cotacao
left JOIN cip_nv.tbl_usuarios f
...
?>
<label style="padding-left: 5px;">Observação da analise:<br />&nbsp;<textarea  name="obs_analise" onblur="ValidaEntrada(this,'textarea');"  readonly=""  class="txt2textarea bradius" >
  <?php 
  while($dado= mysql_fetch_array($result)){
...
?>
<label style="padding-left: 5px;">Observação do input:<br />&nbsp;<textarea  name="obs_input" onblur="ValidaEntrada(this,'textarea');"  readonly=""  class="txt2textarea bradius" >
  <?php 
  while($dado= mysql_fetch_array($result)){
...
?>
<label style="padding-left: 5px;">Observação da auditoria:<br />&nbsp;<textarea  name="obs_auditoria" onblur="ValidaEntrada(this,'textarea');"  readonly=""  class="txt2textarea bradius" >
  <?php 
  while($dado= mysql_fetch_array($result)){
...
<p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius">
<label style="padding-left: 5px;">Obs correção:<br />&nbsp;<textarea  name="obs_correcao" onblur="ValidaEntrada(this,'textarea');" class="txt2textarea bradius" ></textarea></label>
</p>
...
<br/>
 ...
 <input name="cancelar" type="button" value="Cancelar" class="sb2 bradius" onclick="window.location='principal.php?t=forms/form_fila_cotacao_correcao.php'"/>
