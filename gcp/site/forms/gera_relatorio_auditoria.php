...
if($perfil != 1 && $perfil != 4 && $idtbl_usuario != 256 && $perfil != 18 && $perfil != 21 && $perfil != 22 && $perfil != 23){
...
$data = date("d-m-Y");
   ...
   //Você pode colocar aqui o nome do arquivo que você deseja salvar.
    $excel=new ExcelWriter("site/forms/relatorios/relatorio_auditoria_$data.$cpf.xls");
...
//Escreve o nome dos campos de uma tabela
   ...
   ini_set ('mysql.connect_timeout','6000000'); 
...
if(empty($data_1) && empty($data_2) && $_POST['pesquisa'] == 1){
  ...
  $data_2=date('Y-m-d');
   ...
   $sql_servico="CALL cip_nv.exportar_top_nv_auditoria("."'{$data_1}'".","."'{$data_2}'".","."'{$lg2}'".","."'{$turno}'".")";
 ...
 $sql_servico="CALL cip_nv.exportar_top_nv_auditoria2("."'{$data_1}'".","."'{$data_2}'".","."'{$lg2}'".","."'{$turno}'".")";
  ...
  $sql_servico="CALL cip_nv.exportar_top_nv_auditoria3("."'{$data_1}'".","."'{$data_2}'".","."'{$lg2}'".","."'{$turno}'".")";
...
if(empty($linha['renegociacao'])){
  ...
  $linha['renegociacao']=' - ';
      ...
      $myArr=array( $linha['n_da_cotacao'],
                    ...
                    arrumadatahora($linha['vencimento_ilha']),
				            $linha['TIPO_COTACAO'],
                    $linha['ofensor2'],
                    $linha['nome_colaborador'],
                    $linha['turno_op'],
                    $linha['tipo_erro2'],
                    $linha['descricao_erro2'],
                    $cliente_tipo,                    
  ...
  <?php
    ...
    "<hr>
      <div align='center'>
            <a  target=\"_blank\" href=\"site/forms/relatorios/relatorio_auditoria_$data.$cpf.xls\"><font size='2' color='#FFFFFF'>
...
$somefile="site/forms/relatorios/relatorio_auditoria_$data_1.$cpf.xls";
