...
$numusuario=mysql_num_rows($acao_operador);
...
$sql_cotaauditoria="CALL cip_nv.fila_auditoria("."'{$_COOKIE['idtbl_usuario']}'".","."'{$data_1}'".","."'{$data_2}'".")";

$acao_cotacoesauditoria = mysql_query($sql_cotaauditoria,$conecta) or die (mysql_error());

$num_auditoria= mysql_num_rows($acao_cotacoesauditoria);
...
<p><b><font color="#000000" size="2" face="Gotham Light">
  Voc&ecirc; tem um total de <?php echo "$num_auditoria cota&ccedil;&otilde;es"?> 
...
while($linha_atv = mysql_fetch_assoc($acao_cotacoesauditoria))
{
...
?>
  <tr bgcolor="#f5f5f5"> 
    <td class="tdconteudo">
      <?php echo "<font size='1' color='$cor' face='Arial'>
      <a href='principal.php?id_auditoria=$id_auditoria&id_cotacao=$id_cotacao&t=forms/form_cotacoes_auditoria.php'>
...
<?php
 ...
 mysql_free_result($acao_operador,$acao_cotacoesauditoria,$acao_query);
