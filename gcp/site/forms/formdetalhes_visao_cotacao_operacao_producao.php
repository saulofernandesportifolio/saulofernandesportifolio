...
if($setorf == 1){
 ...
 $sql = "SELECT DISTINCT a.id_cotacao,
                ...
                WHERE b.idtbl_usuario_analise='$idtbl_usuario' 
                and b.status_cip_analise NOT IN (3,4) AND b.dt_tratamento_analise BETWEEN '$data_1' AND '$data_2' 
...
$sql = "SELECT DISTINCT a.id_cotacao,
                ...
                WHERE b.idtbl_usuario_input='$idtbl_usuario'  
                 and b.status_cip_input NOT IN (7,8) AND b.dt_tratamento_input BETWEEN '$data_1' AND '$data_2'  
        ORDER BY a.id_cotacao,b.dt_distribuicao DESC LIMIT 0,20000 ";
...
$sql = "SELECT DISTINCT  a.id_cotacao,
                ...
                WHERE b.idtbl_usuario_auditoria='$idtbl_usuario' 
                 and b.status_cip_auditoria NOT IN (13,14)  AND b.dt_tratamento_auditoria BETWEEN '$data_1' AND '$data_2'   
...
$sql = "SELECT DISTINCT a.id_cotacao,
                ...
                WHERE  b.idtbl_usuario_correcao='$idtbl_usuario' 
                 and b.status_cip_correcao NOT IN (20,21)  AND b.dt_tratamento_correcao BETWEEN '$data_1' AND '$data_2'  
...
$sql = "SELECT DISTINCT a.id_cotacao,
                ...
                WHERE  b.idtbl_usuario_chamado='$idtbl_usuario' 
                 and b.status_cip_chamado NOT IN (30,31)  AND b.dt_tratamento_chamado BETWEEN '$data_1' AND '$data_2'  
...
$sql = "SELECT DISTINCT a.id_cotacao,
                ...
                a.cliente_tipo,
                a.oferta_smart_vivo,
                b.inicio_da_tratativa as dt_distribuicao,
                b.contestacao as status_cip,
                d.item as disc_status_cip,
                b.analista_contestacao as idtbl_usuario,
                c.nome
                FROM cip_nv.tbl_cotacao a INNER JOIN cip_nv.base_contestacoes_cotacao b 
                ON a.id_cotacao=b.id_cotacao
                LEFT JOIN cip_nv.cont_contestacao d 
                ON d.id= b.contestacao 
                LEFT JOIN cip_nv.tbl_usuarios c 
                ON c.idtbl_usuario= b.analista_contestacao              
                WHERE  b.analista_contestacao='$idtbl_usuario' 
                 AND b.data_tratamento BETWEEN '$data_1' AND '$data_2'  
 ...
 <p>Voc&ecirc; tem um total de <?php echo "$num_ cota&ccedil;&otilde;es"?> 
  ...
  <br />
   ...
   <br /><br /><br /><br />
    ...
    <?php } ?>
    <th><font size='1'  face='Arial'>CLIENTE TIPO</font></th>
    <th><font size='1'  face='Arial'>REVISAO</font></th>
    <th><font size='1'  face='Arial'>VISAO ILHA</font></th>
    <th><font size='1'  face='Arial'>VENCIMENTO</font></th>
    <th><font size='1'  face='Arial'>STATUS SLA</font></th>
    <th><font size='1'  face='Arial'>SLA DIAS</font></th>
    <th><font size='1'  face='Arial'>DATA DISTRIBUIÇÃO</font></th>
    <th><font size='1'  face='Arial'>SUB-STATUS COTAÇÃO</font></th>
    <th><font size='1'  face='Arial'>STATUS CIP</font></th>
    <th><font size='1'  face='Arial'>OPERADOR</font></th> 
    <th><font size='1'  face='Arial'>TIPO LINHA</font></th>
    <th><font size='1'  face='Arial'>TOTAL LINHAS</font></th>
    ...
    <th><font size='1'  face='Arial'>INFORM.</font></th>
    <th><font size='1'  face='Arial'>OFERTA SMART VIVO CORPORATE</font></th>
  </tr>
    </thead>
         <tbody>
