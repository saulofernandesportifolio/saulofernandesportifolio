...
<form name="formulario" action="../controles/cadastrar_aparelhoinicial_swap.php" method="post">
    
    <input type="hidden" name="perfil" value="<?php echo $perfil; ?>" />
   <input type="hidden" name="id_swap" value="<?php echo $id_swap; ?>" />
   <p align="center"><b><font color="#337ab7" size="4" face="Gotham Light">Cadastro Aparaelho Inicial VPG</font></b></p>
      <br />
                 
<p style="border: #FFFFFF solid; padding: 3px 3px 3px 3px;" class="bradius">
<label style="padding-left: 5px;">Aparelho inicial(DE):&nbsp;
    <input  onblur="valida(this,'text');" id="ap_inicial" name="ap_inicial"  class="txtgrande bradius"/>
</label>  
<label style="padding-left: 5px;">Qtd:&nbsp;
    <input  onblur="valida(this,'text');" id="de_qtd" name="de_qtd"   class="txtpequeno bradius"/>
</label> 
</p>
