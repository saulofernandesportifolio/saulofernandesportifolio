...
if(empty($_POST['id_complementar_da_principal'])){

  $id_complementar_da_principal=$_GET['id_complementar_da_principal'];
}else{
...
?>
 ...
 <p>Voc&ecirc; tem um total de <?php echo "$num_ cota&ccedil;&otilde;es"?> vinculadas a principal  
   ...
   <br /><br />  
    ...
    <th><font size='1'  face='Arial'>DISC STATUS CIP</font></th> 
...
{
	$id_cotacao2           = $linha_atv["id_cotacao"];
  ...
  $status_cip_input     = $linha_atv["status_cip_input"];
  $disc_status_cip_input = $linha_atv["disc_status_cip_input"];
  $motivo_da_acao        = $linha_atv["motivo_da_acao"];
...
if(empty($disc_motivo_da_acao)){

  $disc_motivo_da_acao=$disc_status_cip_input;
...
?>
    ...
    <td class="tdconteudo"><?php echo "<font size='1'  face='Arial'>$disc_status_cip_input</font>" ?></td>
    <td class="tdconteudo"><?php echo "<font size='1'  face='Arial'>$disc_motivo_da_acao</font>" ?></td>
