...
<label style="padding-left: 5px; color:#FFFFFF;">Tipo de cadastro:&nbsp;
 <select name="portabilidade" id="portabilidade" class="txt2comboboxpadrao bradius" 
         onblur="ValidaEntrada(this,'combo');" onchange="b()">
                ...
                <option value="2">Carga base</option>
              </select>
</label>
</p>    
 </form>    
...
<form name="formulario" action="../controles/cadastrar_linhas_pn.php" method="post">
    ...
    <p align="center"><b><font color="#337ab7" size="4" face="Gotham Light">Cadastro de linhas TOP</font></b></p>
      <br />
...
<div id="2" class="divs2" style="padding-left: 20px; display:none"> 
 ...
 <form style="background:#D4D4D4;" class="bradius" action="../controles/enviar_base_linhas_pn.php" 
method="post" enctype="multipart/form-data" name="form1" onsubmit="PreventMultipleSubmit();carregandobase();">
  
     <input type="hidden" name="perfil" value="<?php echo $perfil; ?>" />
    <input type="hidden" name="protocolo" value="<?php echo $protocolo; ?>" />    
     <p align="center"><b><font color="#337ab7" size="4" face="Verdana, Arial, Helvetica, sans-serif">Efetuar carga de linhas pn - TOP</font></b></p>
  
    <p><b><a href="modelos/modelocarga.zip" >Baixar modelo para carga</a></b></p>
    <p><b><font color="#FF0000">1º - Abrir o arquivo modelo e preencher os campos pedidos</font></b></p>
    <p><b><font color="#FF0000">2º - Salvar o arquivo em .csv</font></b></p>
    <p><b><font color="#FF0000">3º - Selecionar o arquivo salvo e dar um clique com o botão direito do mouse e "abrir com" selecionar bloco de notas.</font></b></p>
    <p><b><font color="#FF0000">4º - Salvar como e e selecionar a codificação UTF-8, apertar o botão salvar e efetuar a carga.</font></b></p>
   
    <p>Selecione o arquivo (extens&atilde;o .csv): <input type="file" name="file"/>
    </p>
    <br />
    <input type="submit" name="Submit" value="   Enviar  " class="sb2 bradius" id="btSubmit"/>
	<input type="button" name="Submit2" value="Cancelar" onClick="window.close();" class="sb2 bradius"/>
