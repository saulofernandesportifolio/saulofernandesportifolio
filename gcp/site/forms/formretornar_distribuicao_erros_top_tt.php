...
if($perfil != 1 && $perfil != 4 && $perfil != 17 && $perfil != 18 && $perfil != 21){
...
$data_2=arrumadata2($_POST['data_2']);
  ...
  $sql="CALL bd_erros_pn.visao_erros_retorno_top_tt("."'{$_POST['status']}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="myform" action="principal.php?&t=forms/formretornar_distribuicao_erros2_top_tt.php" method="post" id="frm-filtro">

<p align="center"><b><font color="#337ab7" size="5" face="Gotham Light">Erros TT</font></b></p>
<br />
...
<input type="hidden" name="statusanalise" value="<?php echo $_POST['status_tp'];?>"/>
 <input type="button" name="Submit2" class="sb2 bradius" value="Voltar" onclick="window.location='principal.php?t=forms/formfiltro_retorno_erros_top_tt.php'"/>
