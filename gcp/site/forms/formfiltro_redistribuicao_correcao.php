...
<script type="text/javascript">
    function PreventMultipleSubmit5(){
      document.getElementById("entrar4").disabled=true;
      document.getElementById("entrar4").style.backgroundColor = "#000";
    }


function showLoader4() {
    $('#loader4').css('visibility', 'visible');
    return true;
};
...
<div id="resolucao">
    ...
    onsubmit="PreventMultipleSubmit5();showLoader4();">
      ...
      <br/>
      &nbsp;&nbsp;&nbsp;&nbsp; 
      <input type="submit" class="sb2 bradius" name="entrar4" id="entrar4" value="       OK       "  />
...
<img id="loader4" src="site/forms/img/load.gif" width="300" height="50" />
