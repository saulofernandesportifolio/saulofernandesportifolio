...
if($setor_origem == 'Auditoria'){
 ...
 /*$sql = "SELECT a.id_cotacao,
               ...
               ON b.idtbl_usuario_chamado=c.idtbl_usuario OR b.idtbl_usuario_chamado IS NULL                         
               WHERE b.id_cotacao='$id_cotacao' 
               and  b.status_cip_chamado IN (30,31,33) 
               and (b.idtbl_usuario_chamado IS NULL OR b.idtbl_usuario_chamado='$idtbl_usuario_chamado' )
...
$linha_atv2 = mysql_fetch_assoc($acao2);*/
...
?>
  <tr bgcolor="#f5f5f5"> 
   ...
   $link="principal.php?id_cotacao={$id_cotacao}&id_chamado={$id_chamado}&setor_origem={$setor_origem}&t=forms/form_cotacoes_chamado.php";
    ...
    //$link='javascript:abrir("site/forms/form_rediustribuir.php?id_cotacao='.$id_cotacao.'&id_user='.$idtbl_usuario.'")';
