...
<div id="resolucao">
    ...
    <form action="../forms/formdetalhes_visao_cotacao_pendentes.php" method="POST">
      ...
      <br/>
            <p>Tratativa:
          <select name="filtros2" id="tram">
          <option value="" selected="selected">Selecione</option>
            <option value="%">Em tratativa</option>
          <option value="(d.status_cip_chamado=30 OR d.status_cip_chamado=31)">Aguardando chamado</option>
          <option value="d.status_cip_chamado=33">Pendente chamado</option>
        </select></p>
      <br/>
