...
$sql_limpa="DELETE FROM bd_erros_pn.base_pedidos_erros";
...
<div class="divorientacoes bradius">
  ...
  <p><font color="#FF0000" >
   ...
   <p><font color="#FF0000" >
   campo Status: *Back* OR Executado parcialmente OR BKO Aprov.com falha no envio OR BKO Aprov. com falha no envio OR Erro validação linha PF/Pré</font></p>
   <p><font color="#FF0000" >
...
<hr>
<form style="background:transparent;" class="bradius" action="principal.php?&t=controles/carregar_base_errospedidos.php" 
