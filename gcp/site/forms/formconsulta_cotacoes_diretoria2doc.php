...
$sql="CALL cip_nv.visao_pesquisa_diretoria_doc("."'{$_POST['protocolo']}'".")";

$acao = mysql_query($sql,$conecta) or die (mysql_error());
$num_ = mysql_num_rows($acao);

if( $num_ == 0){
echo $tpcadastro=$_POST['tpcadastro2'];
echo "<script>
            alert('Não encontra-se na base este cadastro relativo aos documentação!');
            document.location.replace('principal.php?tpcadastro=$tpcadastro&t=forms/form_diretoria.php');
         </script>";
...
<p align="center"><b><font color="#337ab7" size="3" face="Gotham Light">Resumo - documentação</font></b></p>
<br />
...
?>
    <tr>
     ...
     <td class="tdconteudo"><?php echo "<a href='principal.php?&id=$id_diretoria&t=forms/form_diretoria_tt.php'><font size='1' color='$cor' face='Arial'>$protocolo</font></a>" ?></td>
