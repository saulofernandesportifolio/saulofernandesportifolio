...
<form name="form1" method="post" action="principal.php?&t=controles/sql_distribuir_cotacao_auditoria4.php" id="frm-filtro">
...
$sql = "SELECT DISTINCT a.id_cotacao,
               ...
               a.oferta_smart_vivo 
                ...
                WHERE 
                      b.status_cip_auditoria IN (13,27) and a.id_cotacao='$id_cotacao' 
         ORDER BY a.vencimento_ilha,a.revisao,a.n_da_cotacao ASC LIMIT 0,20000 ";
...
<p>
  ...
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&carteira=<?php echo $_POST['cart'] ?>&t=forms/formdistribuir_cotacao_auditoria.php'" class="sb2 bradius" />
