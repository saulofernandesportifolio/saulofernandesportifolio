...
function arrumadata2($string2) {
    if($string == ''){
    $data= substr($string2,6,4)."".substr($string2,2,4)."".substr($string2,0,-8); 
...
$timestamp = strtotime($data . "-7 months -$d days");
// Exibe o resultado
...
$sql_validapd2 = "SELECT DISTINCT 
                        ...
                        WHERE a.fila NOT LIKE 3 AND SUBSTRING(a.criado_em,1,10) BETWEEN  '$data_1' AND '$data_2' 
...
//echo '<br>';
 ...
 $sql_update1 = "UPDATE bd_erros_pn.base_erros  
                   SET  tmt = '$total2'	
 ...
 $update1 = mysql_query($sql_update1,$conecta2) or die (mysql_error());
    ...
    $sql_validapd = "SELECT DISTINCT a.id,
                         ...
                         a.revisao                        
                        FROM bd_erros_pn.base_erros a 
                    WHERE a.erros_existente_pedido IS NULL AND a.fila NOT LIKE 3 AND SUBSTRING(a.criado_em,1,10) BETWEEN  '$data_1' AND '$data_2'   
                    ORDER BY a.pedido ";
...
/*
$sql1="UPDATE bd_erros_pn.base_erros a, (SELECT count(pedido) as soma FROM bd_erros_pn.base_erros_linhas WHERE pedido='$pedido' AND revisao='$revisao')b
SET a.linhas=b.soma 
...
$acao_sql1 = mysql_query($sql1,$conecta2) or die (mysql_error());*/
 ...
 $sql_validamass2="CALL bd_erros_pn.atualiza_conteudo_erros_carga("."'{$pedido}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
$sql_cotaanalise="CALL bd_erros_pn.fila_erros("."'{$cpf}'".","."'{$_POST['status_tpf']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<p><b><font color="#000000" size="2" face="Gotham Light">
  Voc&ecirc; tem um total de <?php echo "$num_analise pedidos"?> 
    ...
    <form name="myform" method="POST" action="principal.php?&t=forms/form_fila_cotacao_erros.php" id="frm-filtro">
   ...
   <br /><br /><br /><br />
   <p>
   <input type="button" name="Submit2" class="sb3 bradius" value="cadastrar manualmente" onclick="window.location='principal.php?t=forms/form_cotacoes_erros_manual.php'"/>
        &nbsp;&nbsp;&nbsp;Filtras por 
         Data Inicial: 
            <input name="data_1" type="text" id="data_1" size="15" maxlength="10"  class="txt2data bradius" onchange="this.form.submit();" 
            onkeyup="Formatadata(this,event);ValidaEntrada(this,'date');"
            onclick="displayCalendar(document.getElementById('data_1'),'dd/mm/yyyy',this,true);"  value="<?php echo arrumadata($data_1); ?>" />
     
      
      
            Data Final:&nbsp;
            <input name="data_2" type="text" id="data_2" size="15" maxlength="10"  class="txt2data bradius" onchange="this.form.submit();"
            onkeyup="Formatadata(this,event);ValidaEntrada(this,'date');" 
            onclick="displayCalendar(document.getElementById('data_2'),'dd/mm/yyyy',this,true);"  value="<?php echo arrumadata($data_2); ?>"/>
...
?>
  <tr bgcolor="#f5f5f5"> 
    <td class="tdconteudo"><?php echo "<a href=\"principal.php?&id=$id&t=forms/form_cotacoes_erros.php\"><font size='1' color='$cor' face='Arial'>$pedido</font></a>"; ?></td>
    ...
    <td>
    <a href="principal.php?id=<?php echo $id ?>&t=controles/sql_excluir_erros.php"><font size="1" color="<?php echo $cor ?>" face="Arial">EXCLUIR</font></a>
    </td>
 </tr>
  <?php
  }
