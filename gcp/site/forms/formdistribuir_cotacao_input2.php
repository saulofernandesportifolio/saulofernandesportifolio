...
<form name="form1" method="post" action="principal.php?&t=controles/sql_distribuir_cotacao_input4.php" id="frm-filtro">
...
<br />
   ...
   <br /><br /><br /><br />
    ...
    <p>  <font color="#000000" size="2" face="Gotham Light">
     Selecione o turno:</font> 
      <select name="id_filtro" id="id_filtro" class="txt2comboboxpequeno">
          ...
          <?php
                     ...
                     ?>
                     <input type="hidden" value="<?php echo $regional;?>" name="regional"/>:
                     </select>
...
$sql = "SELECT a.id_cotacao,
                ...
                ON c.id_cotacao=b.id_cotacao                
                WHERE b.status_cip_input in(7,27) and a.id_cotacao='$id_cotacao' 
         GROUP BY a.vencimento_ilha,a.revisao,a.n_da_cotacao ASC LIMIT 0,20000 ";
...
<p>
  ...
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&carteira=<?php echo $_POST['cart'] ?>&t=forms/formdistribuir_cotacao_input.php'" class="sb2 bradius" />
