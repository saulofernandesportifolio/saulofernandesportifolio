 ...
 ?> </select></td>
     ...
     <tr>
      ...
      <td>
       ...
       <td><input name="informacoes" type="text" id="informacoes" size="4" maxlength="255" value="<?php if($linha['informacoes'] == 0){ echo $linha['informacoes']=""; }else{ echo $linha['informacoes']; } ?> "/>
       </td>  
    </tr>
       <tr>
