...
<script type="text/javascript">
    function PreventMultipleSubmit13(){
      document.getElementById("entrar12").disabled=true;
      document.getElementById("entrar12").style.backgroundColor = "#000";
    }
...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/formdistribuir_cotacao_input.php" method="POST" 
    onsubmit="PreventMultipleSubmit13();showLoader12();">
		...
		<br/>
            ...
            <input type="submit" class="sb2 bradius" name="entrar12" id="entrar12" value="       OK       "  />
...
<div align="center" class="barraloaderimg">
 ...
 <img id="loader12" src="site/forms/img/load.gif" width="300" height="50"  />
