...
$sql_cotaanalise="CALL bd_erros_pn.fila_pn_conclusao("."'{$dt_diaf}'".","."'{$cpf}'".")";
...
<p><b><font color="#337ab7" size="3" face="Gotham Light">Lista 
  de portabilidades para serem analisadas na conclusao</b></font></p>
<br />
...
?>
  <tr bgcolor="#f5f5f5"> 
    ...
    <td class="tdconteudo"><?php echo "<font size='1' color='$cor' face='Arial'>$disc_status_cip</font>" ?></td>
        <td>
<a href="javascript:abrir('site/forms/form_efetuar_cadastro_pn_conclusao.php?id_pn=<?php echo $id_pn ?>&id_user=<?php echo $idtbl_usuario  ?>');">
