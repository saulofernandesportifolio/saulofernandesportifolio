...
<form name="formulario" action="principal.php?t=controles/cadastrar_reprovacao_analise.php" method="post">
    
   <input type="hidden" name="id_analise" value="<?php echo $id_analise; ?>" />
