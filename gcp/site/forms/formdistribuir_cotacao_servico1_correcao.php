...
$sql_atv = "SELECT a.id_cotacao,
                   ...
                   a.MIGRACAO_TROCA,
                   a.informacoes   
           FROM cip_nv.tbl_cotacao a,cip_nv.tbl_correcao b 
...
$acao_atv=mysql_query($sql_atv,$conecta);
   ...
   $status_cip        = $linha["status_cip_correcao"];
...
<form name="form1" method="post" action="principal.php?&t=controles/sql.distribuir_cotacao_servico1_correcao.php">
