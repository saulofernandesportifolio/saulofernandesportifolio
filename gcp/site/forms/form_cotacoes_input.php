...
return $data2;
 ...
 $sql_verifca = "SELECT a.id_cotacao,
                ...
                WHERE (b.status_cip_input = 8 OR b.status_correcao= 24) and
...
<p align="center"  class="tituloform bradius"><font size="5" style="text-align: center;">Input</font></p><br/>
<br>
...
$sql_filha="SELECT DISTINCT a.id_cotacao,
             a.n_da_cotacao,
             a.revisao,
             a.regional_atribuida,
             a.uf,
...
}elseif($statusfilha == "Distribuido"){
   
   $substatusfilha= "Distribuido";
}else{
...
<?php 
 $sql_verifca2 = "SELECT a.id_cotacao,
                        d.obs_correcao
                  FROM cip_nv.tbl_cotacao a 
                  INNER JOIN cip_nv.tbl_correcao d 
                  ON d.id_cotacao='$id_cotacao' and  d.id_cotacao=a.id_cotacao 
...
<?php
 ...
 mysql_free_result($acao_operador,$acao_verifica,$acao_filha,$result,$acao_verifica2);
 mysql_close($conecta);  
