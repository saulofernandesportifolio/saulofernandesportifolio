...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/form_solucionar_cotacao_chamadogeral.php" method="POST" 
    onsubmit="PreventMultipleSubmit6();showLoader5();">
        <h3 align="center" style="background: #337ab7"><font color="#FFFFFF">FILTRO CHAMADO GERAL-SOLUCIONAR</font></h3><br />
        <div class="acomodar3">
          <p>Setor:
          ...
          <option value="D"><?php echo 'Correção input'; ?></option>
          <option value="E">Swap</option>
          </select></p>
          <br />
           <p>
...
<div align="center" class="barraloaderimg">
 ...
 <img id="loader5" src="site/forms/img/load.gif" width="300" height="50"  />
