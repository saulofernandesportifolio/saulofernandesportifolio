...
$data_2=arrumadata2($_POST['data_2']);
  ...
  $sql="CALL cip_nv.visao_analise_redistribuicao("."'{$_POST['statusanalise']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
...
<form name="form1" action="principal.php?&t=forms/formredistribuicao_cotacao_analise2.php" method="post" id="frm-filtro">

<p align="center"><b><font color="#337ab7" size="5" face="Gotham Light">Análise</font></b></p>
<br />

<p><font color="#337ab7" size="3" face="Gotham Light"><strong>Lista de cotações a redisdistribuir</strong></font></p>
<br />
<?php
...
?>
 ...
 <?php
  ...
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?t=forms/formfiltro_redistribuicao_analise.php'" class="sb2 bradius" />
