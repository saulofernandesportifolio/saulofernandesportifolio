...
<div class="divorientacoes3 bradius">
  ...
  <p align="center">Tipo: <font color="#FF0000" ><?php echo $_GET['cotacaopri']; ?></font><p>
  <p align="center">Tipo: <font color="#FF0000" >Cotação</font><p>
...
<hr>
<form style="background:transparent;" class="bradius" action="../controles/enviar_base_filhas.php" 
