...
<form name="form1" method="post" action="principal.php?&t=controles/sql_redistribuicao_cotacao_auditoria4.php" id="frm-filtro">
...
$sql = "SELECT  a.id_cotacao,
                ...
                WHERE carteira LIKE '$canal' and 
                      b.status_cip_auditoria NOT IN (13,27) and a.id_cotacao='$id_cotacao' 
        ORDER BY b.dt_distribuicao,a.revisao,a.n_da_cotacao ASC LIMIT 0,20000 ";
...
while($linha_atv = mysql_fetch_assoc($acao))
{
  ...
  $usuario_auditoria   = $linha_atv["idtbl_usuario_auditoria"];
