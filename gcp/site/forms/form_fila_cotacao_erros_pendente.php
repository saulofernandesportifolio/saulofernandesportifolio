...
echo $sql_cotaanalise="CALL bd_erros_pn.fila_erros_pendente()";
...
?>
  <tr bgcolor="#f5f5f5"> 
    <td class="tdconteudo"><?php echo "<font size='1' color='$cor' face='Arial'><a href=\"principal.php?&id=$id&t=forms/form_cotacoes_erros.php\">$pedido</a></font>"; ?></td>
