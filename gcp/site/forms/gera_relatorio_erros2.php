...
$data = date("d-m-Y");
   ...
   //Você pode colocar aqui o nome do arquivo que você deseja salvar.
    $excel=new ExcelWriter("site/forms/relatorios/relatorio_erros_$data.$cpf.xls");
...
if(empty($data_1) && empty($data_2) && $_POST['pesquisa'] == 1){
 ...
 echo  $sql_servico="CALL exportar_top_nv_erros("."'{$data_1}'".","."'{$data_2}'".")";
 ...
 $sql_servico="CALL exportar_top_nv_erros("."'{$data_1}'".","."'{$data_2}'".")";
...
if($_POST['pesquisa'] == 5){
 ...
 $sql_servico="CALL exportar_top_nv_erros2("."'{$data_1}'".","."'{$data_2}'".")";
  ...
  echo"
     ...
     if($consulta_servico ==true){
      ...
      $myArr=array(
                  ...
                  $linha['revisao'],
                  $linha['regional'],
                  arrumadata($linha['criado_em']),
                  $linha['alta'],
                  $linha['portabilidade'],
                  $linha['troca'],
                  $linha['transferencia_titularidade'],
                  arrumadata($linha['data_correcao']),
                  $linha['ofensor'],
                  $linha['adabas'],
                  $linha['usuario'],
                  $linha['fila'],
  ...
  <?php
    ...
    "<hr>
      <div align='center'>
            <a  target=\"_blank\" href=\"site/forms/relatorios/relatorio_erros_$data.$cpf.xls\">
...
$somefile="site/forms/relatorios/relatorio_erros_$data_1.$cpf.xls";
