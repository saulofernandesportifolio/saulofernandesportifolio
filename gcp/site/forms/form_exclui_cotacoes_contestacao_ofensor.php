...
?>
    <tr>
    <td class="tdconteudo"><?php echo "<font size='1' face='Arial'>".$linha_atv['cotacao_principal']."</font>"?></td>
    <td class="tdconteudo"><?php echo "<font size='1' face='Arial'>".$linha_atv['n_da_cotacao']."</font>"?></td>
    ...
    <td>
    <a href="../controles/sql_excluir_cotacoes_contestacao_ofensor4.php?id_erro=<?php echo $linha_atv['id'] ?>&id_contestacao_cotacao=<?php echo $linha_atv['id_contestacao_cotacao'] ?>"><font size='1' face='Arial'>EXCLUIR</font></a></td>
    </tr>
    <?php
    }
  ?>
