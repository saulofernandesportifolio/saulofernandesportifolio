...
/*$sql = "SELECT  a.id_cotacao,
                ...
                AND a.id_complementar_da_principal IS NULL 
                AND b.status_cip_auditoria <> 14 
                      AND b.status_cip_auditoria <> 13 
                      AND b.status_cip_auditoria <> 15 
                      AND b.status_cip_auditoria <> 16 
                      AND b.status_cip_auditoria <> 17 
                      AND b.status_cip_auditoria <> 18
                     AND b.status_cip_auditoria <> 19 
                AND a.TIPO_COTACAO='Complementar'  ";
$acao = mysql_query($sql,$conecta) or die (mysql_error());
$numteste= mysql_num_rows($acao);*/
...
/*$sql = "SELECT DISTINCT a.id_cotacao,
                ...
                AND a.id_complementar_da_principal IS NULL  
                AND a.TIPO_COTACAO='Complementar'  ";
$acao1 = mysql_query($sql,$conecta) or die (mysql_error());
$numteste= mysql_num_rows($acao1);*/
 ...
 $sql = "SELECT DISTINCT a.id_cotacao,
                ...
                a.TIPO_COTACAO
                FROM cip_nv.tbl_cotacao a             
                WHERE  a.cotacao_principal='{$_POST['n_da_cotacao']}' and a.id_complementar_da_principal IS NULL
                AND a.TIPO_COTACAO='Complementar' 
        ORDER BY a.id_cotacao DESC ";
...
<form name="form1" action="principal.php?t=forms/formfilhas_pesquisa_cotacao_input2.php" method="post" id="frm-filtro">
<br />
...
?>
 ...
 <input type="hidden" value="<?php echo $cotacao_principal ?>"" name="cotacao_principal"/>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&t=forms/formconsulta_cotacoes_vinculo.php'" class="sb2 bradius" />
