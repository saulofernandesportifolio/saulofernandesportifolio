...
function selecionar_todas(retorno) {
  ...
  $sql_operador="SELECT * FROM cipnv.tbl_usuarios WHERE idtbl_usuario='{$_COOKIE['idtbl_usuario']}'";
...
$sql = "SELECT count(id) as total, id,fila,nome_completo 
      FROM cip_nv.ativos WHERE fila IS NULL and id IN ($dados)                  
...
<form name="form1" method="post" action="principal.php?&t=controles/sql_criar_usuario4.php" id="frm-filtro">

<p align="center"><b><font color="#a0873c" size="5" face="Gotham Light">Usuários</font></b></p>
<br />

<p><font color="#337ab7" size="4" face="Gotham Light"><strong>Lista de <?php echo $num ?> usuários para criação de acesso</strong></font></p>
<br />
...
<p><font color="#000000" size="3" face="Gotham Light">
  ...
  //seleciona a base de dados para uso
   $query= "SELECT * FROM cip_nv.tbl_supervisor WHERE projeto NOT IN('saiu','GERENTE','B.I')  ORDER BY nome";
...
$sql = "SELECT * FROM cip_nv.ativos 
        WHERE fila IS NULL and id='$id'                  
        ORDER BY nome_completo ASC LIMIT 0,20000 ";
...
<p>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?t=forms/formcriar_usuarios.php'" class="sb2 bradius" />

  <input type="submit" name="Submit" value="Criar Acesso" class="sb2 bradius" />
 </p>
</form>
</div>
</div>
