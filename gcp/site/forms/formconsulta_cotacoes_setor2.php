...
if($perfil != 1 && $perfil != 4 && $perfil != 15 && $perfil != 18 && $perfil != 21 && $perfil != 22 && $perfil != 23){
...
$sql="CALL cip_nv.visao_pesquisa("."'{$_POST['n_da_cotacao']}'".")";
...
<p align="center"><b><font color="#337ab7" size="5" face="Gotham Light">Resumo Por Setor</font></b></p>
<br />

<p><font color="#337ab7" size="3" face="Gotham Light"><strong>Lista de Cotações</strong></font></p>
<br />
<?php
...
if(empty($cliente_tipo)){
 ...
 if($setor == 'Auditoria'){
  ...
  if($setor == 'Analise/Auditoria'){
    ...
    if( $disc_status_cip == 'Procedente' ||  $disc_status_cip == 'Improcedente'){

      $setor=$setor."-"."contestado";
    }
