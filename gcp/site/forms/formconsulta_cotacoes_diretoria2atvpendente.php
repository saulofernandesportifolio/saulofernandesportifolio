...
$sql23="CALL cip_nv.visao_pesquisa_diretoria_atv_pendente()";



$acao23 = mysql_query($sql23,$conecta) or die (mysql_error());
$num_ = mysql_num_rows($acao23);
...
<p><font color="#337ab7" size="2" face="Gotham Light"><strong>Lista de Atividades</strong></font></p>
<br />
...
while($linha_atv = mysql_fetch_assoc($acao23))
{
