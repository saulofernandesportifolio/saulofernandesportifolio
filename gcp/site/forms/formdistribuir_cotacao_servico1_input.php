...
$sql_atv = "SELECT a.id_cotacao,
                   ...
                   a.MIGRACAO_TROCA,
                   a.informacoes  
           FROM cip_nv.tbl_cotacao a,cip_nv.tbl_input b 
...
$acao_atv=mysql_query($sql_atv,$conecta);
   ...
   $status_cip        = $linha["status_cip_input"];
	
 if($linha["segmento"] == 'TOP'){
...
<form name="form1" method="post" action="principal.php?&t=controles/sql.distribuir_cotacao_servico1_input.php">
