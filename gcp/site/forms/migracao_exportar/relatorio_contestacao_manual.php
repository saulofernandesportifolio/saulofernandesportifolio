...
<div class="divrel bradius">
    <form id="form_rel" name="dados" method="post" action="principal.php?t=forms/gera_relatorio_contestacao_manual.php">
      <br />
        <p align="center"><b><font color="#FF0000">Obs.:&nbsp;Para baixar a base consolidada deixar o campo data inicial e data final em branco.</font></b></p>
          <br />
        <h3 align="center">
            <strong>Gerar Relat&#243;rio contesta&ccedil;&atilde;o manual</strong>
        </h3>
        <p align="center">&nbsp;</p>
        <p>
            <strong>Tipo</strong>: 
            ...
            <font color="464646" size="2" face="Arial, Helvetica, sans-serif">Data do recebimemto</font>
                      ...
                      //seleciona a base de dados para uso
                       ...
                       while($dado= mysql_fetch_array($result)){
                             echo "<option value=\"{$dado['id']}\">
                                   {$dado['substatus']}{$dado['item']}</option>";
                       }
                    ?>
                </select>
            </p>
