...
<?php if($perfil == 1 || $perfil == 4 || $perfil == 7 || $perfil == 16 || $perfil == 19 || $perfil == 17){ ?>
<li class="menubar-item">
    <a class="menubar-item-target" href="javascript:void(0)"><?php echo ("Upload");?></a>
    <ul class="menu">
    <?php if($perfil == 1 || $perfil == 4 || $perfil == 7 || $perfil != 16 && $perfil != 19 && $perfil != 17){ ?>
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/formatualizar_base_vpe.php" rel="modal"><?php echo ("Base Cotaçao");?></a></li>
     <?php } ?>
      <?php if($perfil == 1 || $perfil == 4 || $perfil == 7 || $perfil == 16 || $perfil != 19 && $perfil != 17){ ?> 
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/formatualizar_base_errospedidos_pn.php" rel="modal"><?php echo ("Base PN ERROS");?></a></li>
    <?php } ?>

      <?php if($perfil == 4 ){ ?> 
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/formatualizar_base_pn.php" rel="modal"><?php echo ("Base PN - B.I");?></a></li>
     <?php } ?>


    <?php if($perfil == 1 || $perfil == 4 || $perfil == 19 || $perfil != 17 && $perfil != 16){ ?> 
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/formatualizar_base_errospedidos_vpe.php" rel="modal"><?php echo ("Base Erros");?></a></li>
    <?php } ?>

   <?php if($perfil == 1 || $perfil == 4 || $perfil == 17 || $perfil != 19 && $perfil != 16){ ?> 
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/formatualizar_base_errospedidos_vpe_tt.php" rel="modal"><?php echo ("Base Erros TT");?></a></li>
    <?php } ?>
     

      <?php if( $perfil == 4 ){ ?> 
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/formatualizar_base_carteira.php" rel="modal"><?php echo ("Base Carteiras - VPE");?></a></li>
    <?php } ?>

          <?php if( $perfil == 4 || $perfil == 1){ ?> 
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/form_atualizar_carteira.php" rel="modal"><?php echo ("Atualizar Carteira - VPE");?></a></li>
    <?php } ?>

        <?php if( $perfil == 4 || $perfil == 1 || $perfil == 19 || $perfil == 17){ ?> 
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/form_atualizar_carteira_erros.php" rel="modal"><?php echo ("Atualizar Carteira - VPE ERROS");?></a></li>
    <?php } ?>
...
<li class="menubar-item">
  ...
  <?php } ?>
   ...
   <?php if($perfil == 1 || $perfil == 4 || $perfil == 7 || $perfil == 19 ){ ?>
<li class="menubar-item">
    ...
    <?php } ?> 
    <?php if($perfil == 1 || $perfil == 4 || $perfil == 7 || $perfil == 19 ){ ?>
    <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/formfiltro_retorno_erros_vpe.php"><?php echo ("Retornar distribuição erros");?></a></li>
       <?php } ?>
    </ul>
  </li>
  <?php } ?> 
...
<li class="menubar-item">
  ...
  <?php } ?>
      ...
      <?php if($perfil == 1 || $perfil == 4 || $perfil == 7 || $perfil == 16 || $perfil == 17 || $perfil == 19 || $idtbl_usuario == 518 || $idtbl_usuario == 428 || $idtbl_usuario == 432){ ?>
<li class="menubar-item">
    ...
    <?php } ?>  
     ...
     <?php if($perfil == 1 || $perfil == 4 || $perfil == 7 || $idtbl_usuario == 518 || $idtbl_usuario == 428 || $idtbl_usuario == 432){ ?>
    ...
    <?php } ?>  
     ...
     <?php if($perfil == 1 || $perfil == 4 || $perfil == 7 || $perfil == 16 ){ ?>
    ...
    <?php if($perfil == 1 || $perfil == 4 || $perfil == 19 || $perfil == 17){ ?>
    ...
    <?php } ?> 
       ...
       <?php if($perfil == 1 || $perfil == 4 || $perfil == 7 || $perfil == 20 ){ ?>
    ...
    <?php if($perfil == 4 ){ ?>
    <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/relatorio_bi.php"><?php echo ("Gerar relatórios bi");?></a></li>
    <?php } ?>
     </ul>
  </li>
  <?php } ?> 
...
<li class="menubar-item">
  ...
  <li class="menubar-item">
    ...
    <ul class="menu">
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/sql.sla_chamado.php"><?php echo ("Cotações");?></a></li>
       ...
       <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/formfiltro_vpe_tt_chamado.php"><?php echo ("Cotações com chamado TT");?></a></li>
      <li class="menu-separator"></li>
      <li class="menu-item"><a class="menu-item-target" href="logout.php">Logout</a></li>
    </ul>
  </li>
  ...
  <li class="menubar-item">
    <a class="menubar-item-target" href="javascript:void(0)"><?php echo ("Operação");?></a>
    <ul class="menu">
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/formconsulta_cotacoes_diretoria.php"><?php echo ("Cotações");?></a></li>
      <li class="menu-separator"></li>
      <li class="menu-item"><a class="menu-item-target" href="logout.php">Logout</a></li>
    </ul>
  </li>
  ...
  <li class="menubar-item">
    <a class="menubar-item-target" href="javascript:void(0)"><?php echo ("Operação");?></a>
    <ul class="menu">
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/form_fila_cotacao_erros_vpe_tt.php"><?php echo ("Fila erros - TT");?></a></li>

       <li class="menu-separator"></li>
         <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/form_cadastro_motivos_tt.php"><?php echo ("Cadastro motivos - TT");?></a></li>   
      </ul>
  </li>
  <?php } ?>
  ...
  <li class="menubar-item">
    <a class="menubar-item-target" href="javascript:void(0)"><?php echo ("Produção");?></a>
    <ul class="menu">
      <li class="menu-item"><a class="menu-item-target" href="principal.php?t=forms/form_producao_erros_vpe_tt.php"><?php echo ("Pedidos");?></a></li>
 ...
 <li class="menubar-item">
  ...
  <li class="menubar-item">
    ...
    <?php if($perfil == 4 || $perfil == 1){ ?>
      ...
      <?php } ?> 
      <?php if($perfil == 4 || $perfil == 2 || $perfil == 1){ ?>
      ...
      <?php } ?> 
      <?php if($perfil == 4 || $perfil == 3 || $perfil == 1){ ?>
      ...
      <?php } ?>
      <?php if($perfil == 4 || $perfil == 5 || $perfil == 1){ ?> 
      ...
      <?php } ?> 
         <?php if($perfil == 4 || $perfil == 6 || $perfil == 1){ ?> 
      ...
      <?php } ?>
         <?php if($perfil == 4 || $perfil == 14 || $perfil == 1){ ?>
     ...
     <?php } ?> 
        <?php if($perfil == 4 || $perfil == 19 || $perfil == 1){ ?>
     ...
     <?php } ?>  
        <?php if($perfil == 4 || $perfil == 16 || $perfil == 1){ ?>
