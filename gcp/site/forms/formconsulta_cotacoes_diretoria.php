  ...
  <div id="resolucao">
    ...
    <div id="filtro" class="form bradius">
     ...
     <div id="1" class="divs1" style="padding-left: 20px; display:none"> 
         <br>  
       <form action="principal.php?t=forms/formconsulta_cotacoes_diretoria2atvvalidafila.php" method="POST">
        <h3 align="center" style="background: #337ab7"><font color="#FFFFFF">Pesquisar Atividade</font></h3><br />
       <div class="acomodar">
        <p>Atividade:</p><br />
         <p>
         <input type="text" name="n_da_atv" id="n_da_atv"  class="txt bradius"/>
        </p>
        <br/>
     ...
     <div id="2" class="divs2" style="padding-left: 20px; display:none">  
         <br>  
       <form action="principal.php?t=forms/formconsulta_cotacoes_diretoria2validafila.php" method="POST">
     ...
     <div id="3" class="divs3" style="padding-left: 20px; display:none"> 
         <br>
        ...
        <h3 align="center" style="background: #337ab7"><font color="#FFFFFF">Documentação</font></h3><br />
       <div class="acomodar">
           <p>Nº protocolo:</p><br />
         <p>
