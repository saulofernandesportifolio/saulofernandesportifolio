...
<script type="text/javascript">
    function PreventMultipleSubmit12(){
      document.getElementById("entrar11").disabled=true;
      document.getElementById("entrar11").style.backgroundColor = "#000";
    }
...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/formdistribuir_cotacao_analise.php" method="POST" 
    onsubmit="PreventMultipleSubmit12();showLoader11();">
        <h3 align="center" style="background: #337ab7"><font color="#FFFFFF">SELECIONE O FILTRO ANALISE</font></h3>
        <div class="acomodar">
  	  <br /> 
		  <p>Carteira:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
