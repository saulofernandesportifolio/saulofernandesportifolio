...
if(empty($_POST['sup']) || empty($_POST['setor'])){
  $sup=$sup;
  $setor=$setor;
...
<p align="center"><b><font color="#337ab7" size="5" face="Gotham Light">Ativar Usuários</font></b></p>
<br />
...
<?php
 ...
 mysql_free_result($acao_operador,$acao,$result);
 mysql_close($conecta);
...
<input type="hidden" name="setor" value=<?php echo $setor; ?> >
  ...
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?t=forms/formfiltro_ativar_usuario.php'" class="sb2 bradius" />
