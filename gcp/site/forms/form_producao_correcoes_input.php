...
while($linha_op = mysql_fetch_assoc($acao_op))
{
	$id_cotacao		    	    = $linha_op["id_cotacao"];
	$cotacao_principal    	= $linha_op["n_da_cotacao"];
	$disc_status_cip_input  = $linha_op["disc_status_correcao"];
...
<?php
 ...
 <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&t=forms/form_fila_cotacao_input.php'"/>
 </div>
 </div>
</body>
</html>
