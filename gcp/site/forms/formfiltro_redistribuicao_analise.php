...
<script type="text/javascript">
    function PreventMultipleSubmit3(){
      document.getElementById("entrar2").disabled=true;
      document.getElementById("entrar2").style.backgroundColor = "#000";
    }
...
<div id="resolucao">
    ...
    <form action="principal.php?t=forms/formredistribuicao_cotacao_analise.php" method="POST" 
    onsubmit="PreventMultipleSubmit3();showLoader2();">
        <h3 align="center" style="background: #337ab7"><font color="#FFFFFF">SELECIONE O FILTRO AN&Aacute;LISE</font></h3><br />
        <div class="acomodar3">
          <p>Sub-Status:
          ...
          <br />
        <p>Status GALA:
          <select name="statusanalise" id="statusanalise" class="txt2comboboxmenor bradius">
          <option value="%" selected="selected">Selecione</option>
          <option value="4">Distribu&iacute;do</option>
          <option value="5">Reprovado an&aacute;lise</option>
          <option value="6">Aprovado an&aacute;lise</option>
          </select></p>
       <br />
        ...
        <p>
         ...
         <br />
        <p>Cota&ccedil;&atilde;o Principal:</p><br />
         <p>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp; 
      <input type="submit" class="sb2 bradius" name="entrar2" id="entrar2" value="       OK       "  />
...
<div align="center" class="barraloaderimg">
 ...
 <img id="loader2" src="site/forms/img/load.gif" width="300" height="50"  />
