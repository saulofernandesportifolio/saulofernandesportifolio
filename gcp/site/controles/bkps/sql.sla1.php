...
echo $query_linhas= "SELECT a.id_cotacao,
                ...
                b.dt_tratamento_analise
                 FROM tbl_cotacao a 
                     ...
                     ON a.n_da_cotacao= b.cotacao_principal 
                          WHERE b.id_cotacao ='$id_cotacao' and a.TIPO_COTACAO='Principal' ";
      ...
      while($linha = mysql_fetch_array($consulta_servico)){
         ...
         $MIGACAO= $linha["MIGRACAO_TROCA"]+$linha["MIGRACAO"];
             ...
             if($ALTAS != 0 && $TROCAS == 0 && $TT == 0 && $MIGACAO == 0 ){
                  ...
                  if($TROCAS != 0 && $TROCAS > $MIGRACAO && $TROCAS > $TT){
                     ...
                     $linha['total_linhas_cip']= $TROCAS;  
                        ...
                        if($TT != && $TT > $TROCAS  && $TT > $MIGACAO){
                           ...
                           if($MIGACAO != 0 && $MIGACAO > $TROCAS && $MIGACAO > $TT){
...
$datater=$linha['dt_tratamento_analise'];

$datafiltroter=$datater;

//$data2=$calcula_datahorafutura= date("Y-m-d");
//$data2=$calcula_datahorafutura= date("Y-m-d");
$data2=$calcula_datahorafutura= $datater;
/*echo '<br>';
