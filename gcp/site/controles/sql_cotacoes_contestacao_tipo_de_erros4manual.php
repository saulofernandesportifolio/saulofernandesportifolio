...
window.close();
opener.location.href="../../principal.php?&idcont=<?php echo $id_contestacao_cotacao; ?>&t=forms/formcadastromanual_cotacoes_contestacao_att.php";
}
</script>
</head>
<?php
...
else
{
 ...
 $nome1= $consulta['nome'];
    ...
    $sql_valida ="SELECT * FROM cip_nv.base_contestacoes_cotacao_manual
                             WHERE id_contestacao_cotacao = '$id_contestacao_cotacao'  ";
...
$sql = "SELECT 
    ...
    END +1 as qtd_cont
      ...
      WHERE id_contestacao_cotacao='".$tabela['id_contestacao_cotacao']."' AND revisao='".$tabela['revisao']."'";
...
$sql = "INSERT INTO cip_nv.base_erros_cotacao_contestacao_manual(
               ...
               tmt,
               qtd_contestacoes )
     VALUES( '".$tabela['id_contestacao_cotacao']."','".
            $tabela['ofensor']."','".
...
$sqlup = "UPDATE cip_nv.base_contestacoes_cotacao_manual SET
