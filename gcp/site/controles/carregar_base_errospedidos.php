...
$naocarregar='';
     foreach($valores as $idx => $vlr){
      ...
      $dados=substr($dados, 0, strlen($dados) - 1);
           ...
           $sql="INSERT IGNORE INTO bd_erros_pn.base_pedidos_erros({$cb},
                                                        data_base,
                                                        hora_base,
                                                        operador_base
                                                         )VALUES({$dados},
...
// fim - Atualiza o tipo das atividades na tabela tratamento 
   ...
   $sql_valida = "SELECT DISTINCT a.id_pedido,
                         ...
                         b.nu_do_pedido,
                         b.revisao 
                  FROM bd_erros_pn.base_pedidos_erros a INNER JOIN bd_erros_pn.base_pedidos_erros_historico b
                  ...
                  if($linha_valida > 0)
                  {
                     ...
                     $sql_valida9 = "DELETE FROM bd_erros_pn.base_pedidos_erros   
...
$sql_validamass="CALL bd_erros_pn.carrega_base_pedidos_erros_historico()";
...
echo"
<script>
document.location.replace('principal.php?t=forms/formatualizar_base_erros.php');
</script>
 	";
...
<p>
    ...
    onclick="window.location='principal.php?t=forms/formatualizar_base_errospedidos.php'" />
</p>
</div>    
</body>
</html>