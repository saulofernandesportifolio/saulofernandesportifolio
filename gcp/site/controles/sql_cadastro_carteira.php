...
$sql_adabas="SELECT count(cpf_cnpj) as total FROM cip_nv.carteira WHERE cpf_cnpj='{$_POST['cnpj']}' ";
...
if($num == 0 ){
   ...
   $sql_inserir3 ="INSERT INTO cip_nv.carteira(cliente,
                                                       carteira,
                                                       tipo_de_cliente,
...
echo" <script> 
      ...
      document.location.replace('principal.php?&t=forms/form_atualizar_carteira.php');
      </script>
      ";                                        
    exit();
