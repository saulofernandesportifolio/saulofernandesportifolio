...
if (empty($_POST['login_operador_input']))
{
...
$sql_verifica="SELECT * FROM cip_nv.tbl_chamado a 
               ...
               WHERE a.status_cip_chamado IN (31,33) and a.setor_origem='Input' AND b.id_cotacao='$id_cotacao' ";
...
$sql_update1 = "UPDATE cip_nv.tbl_input SET
                    status_cip_input =8,
                    disc_status_cip_input='Redistribuido',
                    obs_input = NULL,
                    motivo_da_acao = NULL,
...
$sql_user = "SELECT idtbl_usuario,nome FROM cip_nv.tbl_usuarios 
					WHERE idtbl_usuario = '{$_POST['login_operador_input']}' ";
