            ...
            $cb.=$legenda[$idx].",";
              ...
              $cotacao=$vlr;
                 ...
                 FROM cip_nv.base_diretoria a 
                  ...
                  $linha_validaidpri = mysql_fetch_assoc($acao_validaidpri));
                  
                    $id_pri=$linha_validaidpri['id'];   

                  }elseif(!empty($_POST['idpri'])){        
                  $id_pri=$_POST['idpri'];  
...
<p>
    <input type="button" name="Submit2" value="Voltar" onclick="window.close();" />
