...
$naocarregar='';
     foreach($valores as $idx => $vlr){
      ...
      $dados=substr($dados, 0, strlen($dados) - 1);
             ...
             $sql="INSERT IGNORE INTO bd_erros_pn.base_erros_linhas_filtro_manual_top_tt({$cb},
                                                        usuario,
                                                        fila,
                                                        nome2,
                                                        tramite,
...
// fim - Atualiza o tipo das atividades na tabela tratamento 
   ...
   $sql_valida = "SELECT DISTINCT a.id,
                         ...
                         b.revisao,
                         b.tipo 
                  FROM bd_erros_pn.base_erros_linhas_top_tt a INNER JOIN bd_erros_pn.base_erros_linhas_filtro_manual_top_tt b  
                  ON a.pedido = b.pedido and a.revisao = b.revisao and a.tipo_vivocorp=b.tipo_vivocorp ";
                  ...
                  //Se localizar pedidos no banco de dados, não é realizada nenhuma ação
                  if($linha_valida > 0)
                  {
                     ...
                     $sql_valida9 = "DELETE FROM bd_erros_pn.base_erros_linhas_filtro_manual_top_tt  
...
$sql_validapetro = "SELECT DISTINCT a.cnpj,a.pedido,a.revisao FROM bd_erros_pn.base_erros_linhas_filtro_manual_top_tt a INNER JOIN cip_nv.raizes b
...
$num_testepetro = mysql_num_rows($acao_validapetro);
        ...
        if( $num_testepetro > 0){
               ...
               while($linha_updatepetro = mysql_fetch_array($acao_validapetro)){
                  ...
                  $sql_valida9petro = "DELETE FROM bd_erros_pn.base_erros_linhas_filtro_manual_top_tt  
   ...
   $sql_validapd = "SELECT DISTINCT a.id,
                         a.pedido                        
                        FROM bd_erros_pn.base_erros_linhas_filtro_manual_top_tt a ORDER BY a.pedido LIMIT 1 ";
...
while($linha_updatepd= mysql_fetch_assoc($acao_validapd)){
 ...
 $sql_validamass="CALL bd_erros_pn.carregamento_erros_linhas_manual_top_tt("."'{$pedido}'".")";
 $resultmass = mysql_query($sql_validamass,$conecta2) or die(mysql_error());
 
 
 $sql_validamass2="CALL bd_erros_pn.atualiza_conteudo_erros_top_tt("."'{$pedido}'".")";
...
<p>
    ...
    onclick="window.location='principal.php?t=forms/form_fila_cotacao_erros_top_tt.php'" />
</p>
</div>    
</body>
</html>