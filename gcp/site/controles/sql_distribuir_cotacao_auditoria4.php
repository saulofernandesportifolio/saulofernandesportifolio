...
if($_POST['login_operador_auditoria'] == '0'){ 
   ...
   if($status_cip_auditoria == 13){
              $sql_valida = "SELECT id_cotacao     
                  ...
                  if($linha_valida > 0)
                  {
                       ...
                       $sql_valida9 = "DELETE FROM cip_nv.tbl_auditoria
                                       WHERE id_cotacao=$id_cotacao";
...
$usuario_op="SELECT * FROM cip_nv.tbl_usuarios WHERE idtbl_usuario ='{$_POST['login_operador_auditoria']}'";
