...
$sql="SELECT * FROM cip_nv.tbl_swap_aparelho WHERE aparelho='{$_POST['ap_final']}' ";	
...
$sql = "SELECT 
        ...
        WHERE id_swap ='{$_POST['id_swap']}' AND tipo='final' ";
...
$queryup="UPDATE cip_nv.tbl_swap 
        SET para_aparelho_final='{$_POST['ap_final']}',	
