...
{
$disc_status_cip="Corrigida a correção analise";
$enviado_ilha ="Enviado ilha de input";
$sub_status_ilha="Correção input";
}
...
$sql_cota="SELECT * FROM cip_nv.tbl_analise WHERE id_analise='$id_analise'";
...
$sql_update="UPDATE cip_nv.tbl_correcao b
             SET b.status_cip_correcao=21,
                 b.disc_status_cip_correcao='Corrigida na analise' 
                 WHERE b.id_cotacao='$id_cotacao2'";
$acao_update= mysql_query($sql_update,$conecta) or die (mysql_error());
...
mysql_free_result($acao_operador,$acao_update,$acao_cota);
mysql_close($conecta);
