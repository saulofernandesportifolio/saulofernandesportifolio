...
$acao_operador = mysql_query($sql_operador) or die (mysql_error());
     ...
     while($linha_operador = mysql_fetch_assoc($acao_operador))
     {
      ...
      if(!empty($_POST['mtreprobko'])){
          ...
          $motivo_erro= $_POST['mtreproinput'];
          $usuario= $_POST['usuario_ci_input'];
          $discstaus=$_POST['disc_status_ci_input'];
  ...
  $observacao =trim($data_cadastro_comentario)." : ".trim($observacao)." "."-"." ".trim($nome);
...
//echo '<br>';
 ...
 $query="INSERT INTO cip_nv.base_diretoria_atv(
                                  cotacao_atividade,
                                  regional,
                                  uf,
                                  criado_em,
...
/*
 ...
 $query="INSERT INTO cip_nv.base_diretoria_atv_historico(
                                  cotacao_atividade,
                                  regional,
                                  uf,
                                  criado_em,
