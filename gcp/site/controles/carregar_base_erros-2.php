...
ini_set('mysql.connect_timeout', '999999999999999999');
ini_set('default_socket_timeout','999999999999999999'); 
...
$naocarregar='';
     foreach($valores as $idx => $vlr){
      ...
      $dados=substr($dados, 0, strlen($dados) - 1);
             ...
             $sql="INSERT IGNORE INTO bd_erros_pn.base_erros_filtro({$cb},
                                                        usuario,
                                                        fila,
                                                        nome2,
                                                        tramite,
...
// fim - Atualiza o tipo das atividades na tabela tratamento 
   ...
   $sql_valida = "SELECT DISTINCT a.id,
                         ...
                         b.revisao,
                         b.tipo 
                  FROM bd_erros_pn.base_erros a INNER JOIN bd_erros_pn.base_erros_filtro b
                  ...
                  if($linha_valida > 0)
                  {
                     ...
                     $sql_valida9 = "DELETE FROM bd_erros_pn.base_erros_filtro 
...
$sql_validapetro = "SELECT DISTINCT a.cnpj,a.pedido,a.revisao FROM bd_erros_pn.base_erros_filtro a INNER JOIN cip_nv.raizes b
...
$num_testepetro = mysql_num_rows($acao_validapetro);
        ...
        if( $num_testepetro > 0){
               ...
               while($linha_updatepetro = mysql_fetch_array($acao_validapetro)){
                  ...
                  $sql_valida9petro = "DELETE FROM bd_erros_pn.base_erros_filtro
...
//$sql_validamass="CALL bd_erros_pn.exclui_massivo()";
//$resultmass = mysql_query($sql_validamass,$conecta2) or die(mysql_error());


/*

$sql_validavpe="CALL bd_erros_pn.exclui_vpe()";
$resultvpe = mysql_query($sql_validavpe,$conecta2) or die(mysql_error());


$sql_validagov="CALL bd_erros_pn.exclui_gov()";
$resultgov = mysql_query($sql_validagov,$conecta2) or die(mysql_error());

*/                                                                            

//$sql1="CALL bd_erros_pn.carrega_base_erros2()";
...
<p>
    ...
    onclick="window.location='principal.php?t=forms/formatualizar_base_erros.php'" />
</p>
</div>    
</body>
</html>