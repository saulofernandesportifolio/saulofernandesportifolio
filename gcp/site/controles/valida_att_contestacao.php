...
//$data_do_recebimento=$_POST['data_do_recebimento']=substr($_POST['data_entrada'],6,4)."-".substr($_POST['data_entrada'],3,2)."-".substr($_POST['data_entrada'],0,2);
 ...
 $sql = "UPDATE cip_nv.base_contestacoes_cotacao SET 
               ...
               data_do_enviovivo= '".arrumadata($_POST['data_do_enviovivo'])."',
               hora_do_enviovivo= '".$_POST['hora_do_enviovivo']."', 
 ...
 $select_id_contes="SELECT  id_cotacao, 
  ...
  $id_cotacao2=$consulta_id_contes['id_cotacao'];
