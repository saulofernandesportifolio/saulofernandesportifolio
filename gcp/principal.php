...
$acao_operador = mysql_query($sql_operador) or die (mysql_error());
        ...
        $regional          =$linha_operador["regional"];
		}
if($perfil == 1 )
{
    $page="GCP: Supervisor";
 ...
 /*filtro operador input por turno*/
      $(document).ready(function(){
         $("select[name=id_filtro]").change(function(){
            ...
            $.post("principal.php?&regional=<?php echo $regional; ?>&t=forms/processa_input.php", 
                  {id_filtro:$(this).val()},
                  function(valor){
...
$(document).ready(function(){
         $("select[name=id_filtro]").change(function(){
            ...
            $.post("principal.php?&regional=<?php echo $regional; ?>&t=forms/processa_auditoria.php", 
                  {id_filtro:$(this).val()},
                  function(valor){
...
$(document).ready(function(){
         $("select[name=id_filtro]").change(function(){
            ...
            $.post("principal.php?&regional=<?php echo $regional; ?>&t=forms/processa_analise.php", 
                  {id_filtro:$(this).val()},
                  function(valor){
...
$(document).ready(function(){
         $("select[name=id_filtro]").change(function(){
            ...
            $.post("principal.php?&regional=<?php echo $regional; ?>&t=forms/processa_correcao.php", 
                  {id_filtro:$(this).val()},
                  function(valor){
...
$(document).ready(function(){
         $("select[name=id_filtro]").change(function(){
            ...
            $.post("principal.php?&regional=<?php echo $regional; ?>&t=forms/processa_chamado.php", 
                  {id_filtro:$(this).val()},
                  function(valor){
...
$(document).ready(function(){
         $("select[name=id_filtro]").change(function(){
            $("select[name=login_operador_analise]").html('<option value="0">Carregando...</option>');
            $.post("principal.php?&regional=<?php echo $regional; ?>&t=forms/processa_operadores.php", 
                  {id_filtro:$(this).val()},
                  function(valor){
...
<td width="20%">
<table>
<td class="logo2mapa bradius"><img src="css/imagem/logoempznovo.png" width="130" height="90"  /></td>
</table>
</td>
<td width="80%">
...
<td class="logo2 bradius"><img src="css/imagem/logo_mundogira.gif" width="90" height="90" /></td>
</table>
