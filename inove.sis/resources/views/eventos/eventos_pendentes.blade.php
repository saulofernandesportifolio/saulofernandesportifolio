         ...
         <div class="col-xs-12">
             <div class="box">
                 <div class="box-header">
                     <h3 class="box-title">Lista de Eventos Pendentes</h3>
                 </div>
                <!-- /.box-header -->
                 <div class="box-body">
                     @include('eventos.success')
                     @include('eventos.erros')
                     <p><button type="button" class="btn" onclick="window.location='{{ url('/listaevento') }}'" style="height: 30px; font-size: 12px;">
