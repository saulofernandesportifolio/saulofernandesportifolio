         ...
         <div class="col-xs-12">
             <div class="box">
                 <div class="box-header">
                     <h3 class="box-title">Lista de Eventos Abertos</h3>
                 </div>
                <!-- /.box-header -->
                 <div class="box-body">
                     @include('eventos.success')
                     @include('eventos.erros')
                     <p><button type="button" class="btn" onclick="window.location='{{ url('/evento/cadastro') }}'" style="height: 30px; font-size: 12px;">
                         ...
                         <button type="button" class="btn btn-danger" onclick="window.location='{{ url('/evento/gerabart') }}'" style="height: 30px; font-size: 12px;">
                             <i class="glyphicon glyphicon-cd"> Gerar-Escala</i></button>
                         <button type="button" class="btn btn-success" onclick="window.location='{{ url('/listaeventofechado') }}'" style="height: 30px; font-size: 12px;">
                             <i class="glyphicon glyphicon-ok"> Realizados</i></button>
                     </p>
