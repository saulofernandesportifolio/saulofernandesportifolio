...
class RegistrarController extends Controller
{
    ...
    public function verificarregistrar(Request $request){
        ...
        $this->validate($request, [
            ...
            if ($cont != 0) {
                ...
                return view('usuario.register', compact('erros_bd'));
            }
            ...
            return redirect('/registrar')->with('message', 'Usuário Cadastrado com Sucesso, e-mail com a senha e usuario enviado para a conta cadastrada !');
    ...
    public function formemail()
    {
        ...
        if(!Session::has('login')){
            ...
            //pagina parceiro
            return view('email.altera_email');
