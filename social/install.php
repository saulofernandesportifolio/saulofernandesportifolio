...
if (isset($_POST['submit'])) {
  ...
  $structure = "
    ...
    (147, 'ftp_path', './'),
    (148, 'ftp_endpoint', ''),
    (149, 'session_hash', '6tE73tZOp-4tZPm-4DjWB-48ZZl-3RLK3-22b50ae9fb7c'),
    ...
    (354, 'invitation_send_method', 'both'),
    ...
    (1288, 'backblaze_region', 'us-east-005'),
    (1289, 'backblaze_key', ''),
    ...
    (1835, 'gifts_permission', 'everyone'),
    (1836, 'system_logo_dark', ''),
    (1837, 'monetization_enabled', '0'),
    (1838, 'monetization_permission', ''),
    ...
    (1845, 'packages_ads_free_enabled', '1'),
    (1846, 'videos_upload_permission', 'everyone'),
    (1847, 'audios_upload_permission', 'everyone'),
    (1848, 'files_upload_permission', 'everyone'),
    (1849, 'colored_posts_permission', 'everyone'),
    (1850, 'activity_posts_permission', 'everyone'),
    (1851, 'polls_posts_permission', 'everyone'),
    (1852, 'geolocation_posts_permission', 'everyone'),
    (1853, 'anonymous_posts_permission', 'everyone'),
    (1854, 'gif_posts_permission', 'everyone'),
    (1855, 'watch_enabled', '1'),
    (1929, 'tips_enabled', '0'),
    (1930, 'tips_permission', 'everyone'),
    ...
    INSERT INTO `system_reactions` (`reaction_id`, `reaction`, `title`, `color`, `image`, `reaction_order`) VALUES
    (1, 'like', 'Like', '#1e8bd2', 'reactions/like.png', 1),
    (2, 'love', 'Love', '#f25268', 'reactions/love.png', 2),
    (3, 'haha', 'Haha', '#f3b715', 'reactions/haha.png', 3),
    (4, 'yay', 'Yay', '#F3B715', 'reactions/yay.png', 4),
    (5, 'wow', 'Wow', '#f3b715', 'reactions/wow.png', 5),
    (6, 'sad', 'Sad', '#f3b715', 'reactions/sad.png', 6),
    (7, 'angry', 'Angry', '#f7806c', 'reactions/angry.png', 7);
    ...
    --
    ALTER TABLE `system_options`
      MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2780;
