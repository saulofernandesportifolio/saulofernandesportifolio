<div class="card">
  <div class="card-header with-icon">
    <i class="fa fa-coins mr5"></i>{__("Content Monetization")}
    ...
    <form class="js_ajax-forms" data-url="admin/monetization.php?do=settings">
      <div class="card-body">
        <div class="form-table-row">
          ...
          <div>
            <div class="form-label h6">{__("Content Monetization Enabled")}</div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            <div class="form-check form-check-inline">
              <input type="checkbox" class="form-check-input" name="method_mercadopago" id="method_mercadopago" {if in_array("mercadopago", $system['monetization_payment_method_array'])}checked{/if}>
