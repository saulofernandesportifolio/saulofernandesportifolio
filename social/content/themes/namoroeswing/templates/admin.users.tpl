  ...
  <div class="card-header with-icon">
    ...
    {elseif $sub_view == "edit"}
      <div class="float-end">
        ...
        <a target="_blank" href="{$system['system_url']}/{$data['user_name']}" class="btn btn-md btn-info">
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-12 col-md-5 mb20">
          <ul class="list-group">
            <li class="list-group-item">
              <span class="float-end badge badge-lg rounded-pill badge-secondary" style="color:#000">{$data['user_id']}</span>
              {__("User ID")}
            </li>
            <li class="list-group-item">
              <span class="float-end badge badge-lg rounded-pill badge-secondary" style="color:#000">{$data['user_registered']|date_format:"%e %B %Y"}</span>
              {__("Joined")}
            </li>
            <li class="list-group-item">
              <span class="float-end badge badge-lg rounded-pill badge-secondary" style="color:#000">{$data['user_last_seen']|date_format:"%e %B %Y"}</span>
              {__("Last Login")}
            </li>
          </ul>
        </div>
        <div class="col-12 col-md-5 mb20">
          <ul class="list-group">
            <li class="list-group-item">
              <span class="float-end badge badge-lg rounded-pill badge-secondary" style="color:#000">{$data['friends']}</span>
              {__("Friends")}
            </li>
            <li class="list-group-item">
              <span class="float-end badge badge-lg rounded-pill badge-secondary" style="color:#000">{$data['followings']}</span>
              {__("Followings")}
            </li>
            <li class="list-group-item">
              <span class="float-end badge badge-lg rounded-pill badge-secondary" style="color:#000">{$data['followers']}</span>
              {__("Followers")}
            </li>
          </ul>
        </div>
            ...
            <div class="pl-md-4">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select name="user_relationship" class="form-control" id="user_relationship">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="user_country" disabled>
                    ...
                    {/foreach}
                    <input type="hidden" name="user_country" id="country" value="30">
                  </select>
                </div>
                ...
                <div class="row">
                  <div class="col">
                    <select class="form-control" name="birth_month_companions" id="birth_month_companions">
                      <option value="none">{__("Select Month")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '1'}selected{/if} value="1">{__("Jan")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '2'}selected{/if} value="2">{__("Feb")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '3'}selected{/if} value="3">{__("Mar")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '4'}selected{/if} value="4">{__("Apr")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '5'}selected{/if} value="5">{__("May")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '6'}selected{/if} value="6">{__("Jun")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '7'}selected{/if} value="7">{__("Jul")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '8'}selected{/if} value="8">{__("Aug")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '9'}selected{/if} value="9">{__("Sep")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '10'}selected{/if} value="10">{__("Oct")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '11'}selected{/if} value="11">{__("Nov")}</option>
                      <option {if $data['user_birthdate_companions_parsed']['month'] == '12'}selected{/if} value="12">{__("Dec")}</option>
                    </select>
                  </div>
                  <div class="col">
            ...
            <div class="pl-md-4">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                      ...
                      {$ciTy= explode(' - ', $data['user_current_city'])}
                      <select id="listaState2" name="state" class="form-control select2" style="width:100%; border: var(--bs-border-width) solid var(--bs-border-color);">
                    ...
                    <div class="form-group col-md-9">
                      ...
                      <select id="city2" name="user_current_city" class="form-control select2" style="width:100%; border: var(--bs-border-width) solid var(--bs-border-color);">
                         <option selected value="{$data['user_current_city']}">{$ciTy[0]}</option>
                      </select>
                    </div> 
                </div>
              ...
              <!--<div class="form-group">
                ...
                <input type="hidden" class="form-control"  id="hometown" name="user_hometown" value="{$data['user_hometown']}">
              <!--</div>-->
            ...
            <div class="form-table-row">
              ...
              <div class="text-end">
                <label class="switch" for="user_privacy_newsletter">
                  <input type="checkbox" name="user_privacy_newsletter" id="user_privacy_newsletter" {if $data['user_privacy_newsletter']}checked{/if}>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
