  ...
  {elseif $sub_view == "posts"}
    ...
    <form class="js_ajax-forms" data-url="admin/settings.php?edit=posts">
      <div class="card-body">
        ...
        <div class="form-table-row">
          <div class="avatar">
            {include file='__svg_icons.tpl' icon="youtube" class="main-icon" width="40px" height="40px"}
          </div>
          <div>
              ...
              <div>
                ...
                <div class="text-end">  
                  <label class="switch" for="age_restriction_companions">
                    <input type="checkbox" name="age_restriction_companions" id="age_restriction_companions" {if $system['age_restriction_companions']}checked{/if}>
            ...
            <div class="row form-group">
              ...
              <div class="col-md-9">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="email_post_likes">{__("Someone liked his post")}</label>
                </div>
                <div class="form-check">
      ...
      <div class="tab-pane" id="Cloud">
        <div class="card-body">
          ...
          <form class="js_ajax-forms" data-url="admin/settings.php?edit=s3">
            <div class="form-table-row">
              <div class="avatar">
                {include file='__svg_icons.tpl' icon="aws_s3" class="main-icon" width="40px" height="40px"}
              </div>
              <div>
          ...
          <form class="js_ajax-forms" data-url="admin/settings.php?edit=google_cloud">
            <div class="form-table-row">
              <div class="avatar">
                {include file='__svg_icons.tpl' icon="google_cloud" class="main-icon" width="40px" height="40px"}
              </div>
              <div>
          ...
          <form class="js_ajax-forms" data-url="admin/settings.php?edit=digitalocean">
            <div class="form-table-row">
              <div class="avatar">
                {include file='__svg_icons.tpl' icon="digitalocean" class="main-icon" width="40px" height="40px"}
              </div>
              <div>
          ...
          <form class="js_ajax-forms" data-url="admin/settings.php?edit=wasabi">
            <div class="form-table-row">
              <div class="avatar">
                {include file='__svg_icons.tpl' icon="wasabi" class="main-icon" width="40px" height="40px"}
              </div>
              <div>
          ...
          <form class="js_ajax-forms" data-url="admin/settings.php?edit=backblaze">
            <div class="form-table-row">
              <div class="avatar">
                {include file='__svg_icons.tpl' icon="backblaze" class="main-icon" width="40px" height="40px"}
              </div>
              <div>
          ...
          <div class="card-body">
            ...
            <div>
              <div class="form-table-row">
                ...
                <div>
                  <div class="form-label h6">{__("2Checkout Enabled")}</div>
            ...
            <div>
              <div class="form-table-row">
                ...
                <div>
                  <div class="form-label h6">{__("SecurionPay Enabled")}</div>
