{strip}
  ...
  <script id="modal-upgrade" type="text/template">
    <div class="modal-header">
      <h4 class="modal-title" style="padding-left: 36%;">
        <b>{__("Attention !")}</b>
      </h4>
      ...
      <div class="alert alert-warning" >
        ...
        <div class="text">
          <strong>{__("Membership")}</strong><br>
            {__("Have access to all options, choose the best plan for you, and have all the advantages of being Plus. Check the available packages?")} 
        </div>
      </div>
      <!-- upgrade -->
    </div>
    <div class="modal-footer" style="justify-content: center;">
        ...
        {if !$profile['name']}
          <a href="{$system['system_url']}/" class="btn btn-primary btn btn-block"><i class="fa fa-check mr5"></i>{__("Continue Free")}</a>
        {else}
          <a href="{$system['system_url']}/{$profile['user_name']}" class="btn btn-primary btn btn-block"><i class="fa fa-check mr5"></i>{__("Continue Free")}</a>
        {/if}  
        </div>
        <div class="text-center">
         <a href="{$system['system_url']}/packages" class="btn btn-primary btn btn-block"><i class="fa fa-rocket mr5"></i>{__("Check Pro Packages")}</a>
        </div>   
    </div>
  </script>
  ...
  {else}
        ...
        <div class="tab-content">
          <div class="tab-pane tab-emojis active" id="tab-emojis-{literal}{{id}}{/literal}">
            <div class="js_scroller" data-slimScroll-height="180">
              {foreach $user->get_emojis() as $emoji_index => $emoji }
        ...
        <div class="chat-sidebar-content">
          ...
          {foreach $sidebar_friends as $_user}
              {if $system['packages_enabled'] && !$user->_data['user_subscribed'] || $user->_data['user_package'] == 5 && $user->_data['user_subscribed']}
                <div class="chat-avatar-wrapper clickable" href="{$system['system_url']}/upgrade/posts" data-toggle="modal" data-url="core/upgradepost.php">
              {else}        
                <div class="chat-avatar-wrapper clickable js_chat-start" data-uid="{$_user['user_id']}" data-name="{if $system['show_usernames_enabled']}{$_user['user_name']}{else}{$_user['user_firstname']} {$_user['user_lastname']}{/if}" data-link="{$_user['user_name']}">
              {/if}
         ...
         <div class="chat-sidebar-footer">
          {if $system['packages_enabled'] && !$user->_data['user_subscribed'] || $user->_data['user_package'] == 5 && $user->_data['user_subscribed']}
            <a class="btn btn-chat rounded-circle mb10" href="{$system['system_url']}/upgrade/posts" data-toggle="modal" data-url="core/upgradepost.php">
        ...
        <div class="chat-widget-content">
          ...
          <div class="x-form chat-form invisible">
            <div class="chat-form-message">
              {if $system['packages_enabled'] && !$user->_data['user_subscribed'] || $user->_data['user_package'] == 5 && $user->_data['user_subscribed']}
                <textarea class="js_autosize" dir="auto" rows="1" placeholder='{__("Write a message")}' href="{$system['system_url']}/upgrade/posts" data-toggle="modal" data-url="core/upgradepost.php"></textarea>
              {else}        
            ...
            <ul class="x-form-tools clearfix">
              {if $system['chat_photos_enabled']}
                <li class="x-form-tools-attach">
                  {if $system['packages_enabled'] && !$user->_data['user_subscribed'] || $user->_data['user_package'] == 5 && $user->_data['user_subscribed']}
                    <i class="far fa-image fa-lg fa-fw" data-handle="chat" href="{$system['system_url']}/upgrade/posts" data-toggle="modal" data-url="core/upgradepost.php"></i>
                  {else}        
              ...
              {if $system['voice_notes_chat_enabled']}
                  {if $system['packages_enabled'] && !$user->_data['user_subscribed'] || $user->_data['user_package'] == 5 && $user->_data['user_subscribed']}
                    <li class="x-form-tools-voice" href="{$system['system_url']}/upgrade/posts" data-toggle="modal" data-url="core/upgradepost.php">
              ...
              {/if}
              {if $system['packages_enabled'] && !$user->_data['user_subscribed'] || $user->_data['user_package'] == 5 && $user->_data['user_subscribed']}
                <li class="x-form-tools-emoji" href="{$system['system_url']}/upgrade/posts" data-toggle="modal" data-url="core/upgradepost.php">
        ...
        <div class="chat-widget-head">
          ...
          <div class="chat-head-btns">
            ...
            {if $system['audio_call_enabled'] && $user->_data['can_start_audio_call']}
              {if $system['packages_enabled'] && !$user->_data['user_subscribed'] || $user->_data['user_package'] == 5 && $user->_data['user_subscribed']}
                <span class="chat-head-btn" href="{$system['system_url']}/upgrade/posts" data-toggle="modal" data-url="core/upgradepost.php">
        ...
        <div class="chat-widget-content">
          ...
          <div class="x-form chat-form">
            ...
            <ul class="x-form-tools clearfix">
              ...
              {/if}  
              {if $system['packages_enabled'] && !$user->_data['user_subscribed'] || $user->_data['user_package'] == 5 && $user->_data['user_subscribed']}         
                <li class="x-form-tools-colors" href="{$system['system_url']}/upgrade/posts" data-toggle="modal" data-url="core/upgradepost.php">
        ...
        <form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_withdraw_points">
          <div class="modal-body">
            <div class="form-group">
              ...
              <div>
                <span class="badge badge-lg bg-info">{print_money((((1/$system['points_per_currency'])*$user->_data['user_points'])|number_format:2))}</span>
              </div>
            </div>
            <div class="form-group">
              <label class="form-label" for="amount">{__("Amount")}</label>
    ...
    <!-- Payments -->
    {if $page == "packages" || $page == "ads" || $page == "wallet" || ($page == "index" || $page == "profile" || $page == "page" || $page == "group" || $page == "post" || $page == "directory" || $page == "search" || $page == "movies")}
      <!-- Payment Method -->
        ...
        <div class="modal-body text-center">
          <div class="row justify-content-center">
            ...
            {if $system['razorpay_enabled']}
              <div class="col-12 col-sm-6 mb10">
                <div class="d-grid">
                  <button class="btn btn-md btn-payment" data-toggle="modal" data-url="#razorpay" data-options='{ "handle": "{literal}{{handle}}{/literal}", "id": "{literal}{{id}}{/literal}", "price": "{literal}{{price}}{/literal}" }'>
            ...
            {/if}
            {if $page == "packages" && $system['packages_enabled'] && $system['packages_wallet_payment_enabled'] && $system['wallet_enabled']}
              <div class="col-12 col-sm-6 mb10">
                <div class="d-grid">
            ...
            {/if}
            {if ($page != "packages" && $page != "wallet") && $system['monetization_enabled'] && $system['monetization_wallet_payment_enabled'] && $system['wallet_enabled']}
