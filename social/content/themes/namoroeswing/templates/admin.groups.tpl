        ...
        <div class="col-12 col-md-10 mb20">
          <ul class="list-group">
            <li class="list-group-item">
              <span class="float-end badge badge-lg rounded-pill badge-secondary">{$data['group_id']}</span>
              {__("Group ID")}
            </li>
            <li class="list-group-item">
              <span class="float-end badge badge-lg rounded-pill badge-secondary">{$data['group_members']}</span>
              {__("Members")}
            </li>
            <li class="list-group-item">
