{strip}
  ...
  <script>
    ...
    __['Follow'] = "{__('Follow')}";
    __['Disrecommend'] = "{__('Disrecommend')}";
    __['Recommend'] = "{__('Recommend')}";
  ...
  <script src="{$system['system_url']}/content/themes/namoroeswing/bootstrap-5.3.0-alpha3-dist/js/bootstrap.bundle.min.js" {if !$user->_logged_in}defer{/if}>
    
  </script>

  <!--<script src="{$system['system_url']}/content/themes/namoroeswing/bootstrap-5.3.3-dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous" {if !$user->_logged_in}defer{/if}>
  </script>-->
  ...
  {if $user->_logged_in}
    ...
    <!-- Tagify -->
    {if $page =="packages" || $page == "settings"}
