        ...
        <div class="card-body">
          ...
          <div class="js_wizard-content" id="step-1">
            ...
            <div class="clearfix mt20">
              <button id="activate-step-2" class="btn btn-primary float-end">{__("Next Step")}<i class="fas fa-arrow-circle-right ml5"></i></button>
            </div>
            <!-- buttons -->
          </div>
                ...
                {if $system['location_info_enabled']}
                  <div class="row">
                    <div class="form-group col-md-2">
                      ...
                      <select id="listaState" name="state" class="form-control select2" style="width:100%">
                      </select>
                    </div>            
