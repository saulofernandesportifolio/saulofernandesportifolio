<div class="card-header with-icon">
  {include file='__svg_icons.tpl' icon="funding" class="main-icon mr15" width="24px" height="24px"}{__("Funding")}
</div>
<div class="card-body">
      ...
      <form class="js_ajax-forms" data-url="users/withdraw.php?type=funding">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            {/if}
            {if in_array("mercadopago", $system['funding_payment_method_array'])}
              <div class="form-check form-check-inline">
                <input type="radio" name="method" id="method_mercadopago" value="mercadopago" class="form-check-input">
            ...
            {if in_array("custom", $system['funding_payment_method_array'])}
              <div class="form-check form-check-inline">
                ...
                <label class="form-check-label" for="method_custom">{__($system['funding_payment_method_custom'])}</label>
              </div>
            {/if}
          </div>
        </div>
