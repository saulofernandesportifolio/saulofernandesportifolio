      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          {if $view == ""}
            ...
            <!-- upgrade options -->
            {if $upgrade_options}
              {include file='_upgrade_post.tpl' post=$upgrade_options}
            {/if}
            <!-- upgrade post -->            
          ...
          {elseif $view == "upgrade_posts"}
            {if $user->_is_admin || $user->_data['user_subscribed'] || !$user->_data['user_subscribed'] && !$user->_data['user_package'] || !$user->_data['user_subscribed'] && $user->_data['user_package'] == 5}
                <!-- upgrade -->
          ...
          {elseif $view == "boosted_posts"}
            {if $user->_is_admin || $user->_data['user_subscribed'] && $user->_data['user_package'] != 5}
              <!-- Email para Divulgação -->
              <div class="page-header mini rounded mb10">
                <div class="circle-1"></div>
                <div class="circle-2"></div>
                <div class="inner">
                  <h2>{__("Enviar email para: ")}</h2>
                  <p class="text-lg"><h7>{__("contato@namoroeswing.com.br")}</h7></p>
                </div>
              </div>
              <!-- Email para Divulgação -->
              <!-- boosted posts -->
