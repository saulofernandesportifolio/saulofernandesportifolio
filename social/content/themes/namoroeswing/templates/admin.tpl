          ...
          <ul class="side-nav">
            ...
            <li {if $view == "posts"}class="active" {/if}>
              ...
              <div class='collapse {if $view == "posts"}show{/if}' id="posts">
                <ul>
                  ...
                  <li {if $view == "posts" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/{$control_panel['url']}/posts/categories">
            ...
            <li {if $view == "market"}class="active" {/if}>
              <a href="#market" data-bs-toggle="collapse" {if $view == "market"}aria-expanded="true" {/if}>
                <i class="fa fa-shopping-bag fa-lg fa-fw mr10" style="color: #F44336"></i>{__("Marketplace")}
              </a>
            ...
            <ul class="side-nav">
              ...
              <li {if $view == "pro"}class="active" {/if}>
                ...
                <div class='collapse {if $view == "pro"}show{/if}' id="pro">
                  <ul>
                    ...
                    <li {if $view == "pro" && $sub_view == "earnings"}class="active" {/if}>
                      <a href="{$system['system_url']}/{$control_panel['url']}/pro/earnings">
                        {__("Earnings")}
                      </a>
                    </li>
                  </ul>
              ...
              <li {if $view == "monetization"}class="active" {/if}>
                <a href="#monetization" data-bs-toggle="collapse" {if $view == "monetization"}aria-expanded="true" {/if}>
                  <i class="fa fa-coins fa-lg fa-fw mr10" style="color: #4CAF50"></i>{__("Content Monetization")}
                </a>
