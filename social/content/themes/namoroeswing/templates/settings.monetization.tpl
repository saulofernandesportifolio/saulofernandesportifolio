        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            <div class="payment-plans">
              ...
              {/foreach}
              <div data-toggle="modal" data-url="monetization/controller.php?do=add&node_id={$user->_data['user_id']}&node_type=profile" class="payment-plan new">{__("Add new plan")} </div>
            </div>
          </div>
        </div>
      ...
      <form class="js_ajax-forms" data-url="users/withdraw.php?type=monetization">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            {/if}
            {if in_array("mercadopago", $system['monetization_payment_method_array'])}
              <div class="form-check form-check-inline">
