{if !$standalone}<li>{/if}
  ...
  <div class="post 
    ...
    {if $standalone && $upgrade}
      <div class="chat-icon" data-bs-toggle="tooltip" title="{__("Promoted")}">
        <i class="fa fa-bullhorn"></i>
      </div>
    {/if}
    ...
    <div class="post-body">
      ...
      {if !$post['needs_subscription'] && !$post['needs_pro_package']}
        <!-- post stats -->
          ...
          <span class="float-end">
            ...
            {if $system['posts_views_enabled']}
              <span class="pointer ml10">
                <i class="fa fa-eye"></i> {$post['views']} {__("Views")}
              </span>
            {/if}
            <!-- views -->
        ...
        {if $user->_logged_in && $_get != "posts_information"}
          <div class="post-actions">
            ...
            <!-- tips -->
            {if $user->_logged_in && $post['author_id'] != $user->_data['user_id'] && $post['tips_enabled']}
