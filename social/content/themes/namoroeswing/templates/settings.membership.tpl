  ...
  {if $user->_data['user_subscribed']}
    ...
    <div class="pl-md-4">
      ...
      <div class="row form-group">
        ...
        <div class="col-md-9">
          <p class="form-control-plaintext">
            {$user->_data['user_boosted_posts']}/{$user->_data['boost_posts']} (<a href="{$system['system_url']}/upgrade/posts">{__("Manage")}</a>)
          </p>
    ...
    <div class="pl-md-4">
      <div class="text-center">
        <a href="{$system['system_url']}/packages" class="btn btn-md btn-success">{__("Upgrade Package")}</a>
      </div>
    </div>
  {else}
    <div class="text-center">
