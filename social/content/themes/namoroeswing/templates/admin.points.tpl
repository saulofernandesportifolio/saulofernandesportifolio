      ...
      <div class="card-body">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            <div class="form-check form-check-inline">
              <input type="checkbox" class="form-check-input" name="method_mercadopago" id="method_mercadopago" {if in_array("mercadopago", $system['points_payment_method_array'])}checked{/if}>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            <div class="form-text">
              {__("How many points user will get for each new post view")}<br>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            <div class="form-text">
              {__("How many points user will get for each follower")}
            </div>
          </div>
        </div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            <div class="form-text">
              {__("How many points user will get for each referred user")}<br>
  ...
  {elseif $sub_view == "payments"}
    ...
    <div class="card-body">
      ...
      <div class="alert alert-info">
        ...
        <div class="text pt5">
          {__("You will need to make the payments from your Paypal, Skrill, Bank Account... etc")}. {__("After making the payment you can mark the payment request as paid")}.
        </div>
      </div>
