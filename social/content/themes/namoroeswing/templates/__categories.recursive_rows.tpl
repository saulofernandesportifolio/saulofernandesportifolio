<tr class="treegrid-{$row['category_id']} {if $row['category_parent_id'] != '0'}treegrid-parent-{$row['category_parent_id']}{/if}">
  ...
  <td>
    <a data-bs-toggle="tooltip" title='{__("Edit")}' href="{$system['system_url']}/{$control_panel['url']}/{$_url}/edit_category/{$row['category_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
