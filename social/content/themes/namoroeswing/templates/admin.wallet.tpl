      ...
      <div class="card-body">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            <div class="form-check form-check-inline">
              <input type="checkbox" class="form-check-input" name="method_mercadopago" id="method_mercadopago" {if in_array("mercadopago", $system['wallet_payment_method_array'])}checked{/if}>
