    ...
    <div class="col-12 sg-offcanvas-mainbar">
          ...
          {if $group['i_admin']}
            ...
            <div class="profile-avatar-change">
              ...
              <div class="dropdown-menu action-dropdown-menu">
                ...
                <!-- upload -->
                <!-- select -->
                <div class="dropdown-item pointer" data-toggle="modal" data-url="users/photos.php?type=group&id={$group['group_id']}">
                  <div class="action">
      ...
      <div class="row">
        ...
        {if $view == ""}
          ...
          <!-- monetization alert -->
          {if $user->_logged_in && $system['monetization_enabled'] && $group['group_monetization_enabled'] && ($user->_data['user_group'] < 3 || $group['i_admin'])}
            <div class="col-sm-12">
              <div class="alert alert-info">
                ...
                <div class="text pt5">
                  {if !$group['i_admin']}
                    {__("This group enabled content monetization however you can see the content as you are admin/modertaor")}.
                  {else}
            ...
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  ...
                  {if $system['monetization_enabled'] && $group['group_monetization_enabled']}
                    <li class="nav-item">
          ...
          <div class="col-lg-9">
            ...
            <div class="card">
              {if $sub_view == ""}
                ...
                <form class="js_ajax-forms" data-url="pages_groups_events/create.php?type=group&do=edit&edit=settings&id={$group['group_id']}">
                  <div class="card-body">
              ...
              {elseif $sub_view == "monetization"}
                ...
                <div class="card-body">
                  ...
                  <div class="pl-md-4">
                    <form class="js_ajax-forms" data-url="pages_groups_events/create.php?type=group&do=edit&edit=monetization&id={$group['group_id']}">
                      <div class="form-table-row">
                        <div class="avatar">
