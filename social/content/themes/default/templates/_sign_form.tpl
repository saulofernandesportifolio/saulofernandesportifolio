    ...
    <div class="card-body">
      ...
      <form class="js_ajax-forms" data-url="core/signin.php" method="POST">
        ...
        <div class="form-group d-grid">
          <button type="submit" class="btn btn-lg btn-primary bg-gradient-blue">{__("Login")}</button>
        </div>
        <!-- submit -->
        <!-- error -->
  ...
  <div class="js_panel {if $do != 'up'}x-hidden{/if}">
    ...
    <div class="card-body">
      <form class="js_ajax-forms" data-url="core/signup.php" method="POST">
        ...
        <!-- submit -->
        <div class="form-group d-grid">
          <button type="submit" class="btn btn-lg btn-success bg-gradient-green">{__("Sign Up")}</button>
        </div>
        <!-- submit -->
        <!-- error -->
        <div class="alert alert-danger mt15 mb0 x-hidden"></div>
