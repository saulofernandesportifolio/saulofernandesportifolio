          ...
          {if $user_data['information']}
            ...
            <ul class="list-group mb20">
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$user_data['information']['user_id']}</span>
                {__("User ID")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$user_data['information']['user_name']}</span>
                {__("User Name")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$user_data['information']['user_firstname']}</span>
                {__("User First Name")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$user_data['information']['user_lastname']}</span>
                {__("User Last Name")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$user_data['information']['user_email']}</span>
                {__("User Email")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$user_data['information']['user_phone']}</span>
                {__("User Phone")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{__($user_data['information']['user_gender'])}</span>
                {__("User Gender")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$user_data['information']['user_registered']|date_format:"%e %B %Y"}</span>
                {__("Joined")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$user_data['information']['user_last_seen']|date_format:"%e %B %Y"}</span>
                {__("Last Login")}
              </li>
            </ul>
            <!-- information -->
