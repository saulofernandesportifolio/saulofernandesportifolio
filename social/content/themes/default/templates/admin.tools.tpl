              ...
              {foreach $rows['friend'] as $node}
                <div class="auto-connect-node">
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <select class="form-control mb10" name="auto_friend_country_{$node['country_id']}">
                        {foreach $countries as $country}
              ...
              {foreach $rows['like'] as $node}
                <div class="auto-connect-node">
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <select class="form-control mb10" name="auto_like_country_{$node['country_id']}">
                        {foreach $countries as $country}
                          <option {if $node['country_id'] == $country['country_id']}selected{/if} value="{$country['country_id']}">{$country['country_name']}</option>
                        {/foreach}
                      </select>
              ...
              {foreach $rows['join'] as $node}
                <div class="auto-connect-node">
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <select class="form-control mb10" name="auto_join_country_{$node['country_id']}">
                        {foreach $countries as $country}
                          <option {if $node['country_id'] == $country['country_id']}selected{/if} value="{$country['country_id']}">{$country['country_name']}</option>
                        {/foreach}
                      </select>
