<div class="card">
  <div class="card-header with-icon">
    ...
    {elseif $sub_view == "categories"}
      <div class="float-end">
        <a href="{$system['system_url']}/{$control_panel['url']}/posts/add_category" class="btn btn-md btn-primary">
    ...
    {elseif $sub_view == "add_category" || $sub_view == "edit_category"}
      <div class="float-end">
        <a href="{$system['system_url']}/{$control_panel['url']}/posts/categories" class="btn btn-md btn-light">
    ...
    {if $sub_view == "categories"} &rsaquo; {__("Videos Categories")}{/if}
    {if $sub_view == "add_category"} &rsaquo; {__("Videos Categories")} &rsaquo; {__("Add New Category")}{/if}
    {if $sub_view == "edit_category"} &rsaquo; {__("Videos Categories")} &rsaquo; {$data['category_name']}{/if}
  </div>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover js_treegrid">
          ...
          <tbody>
            {if $rows}
              {foreach $rows as $row}
                {include file='__categories.recursive_rows.tpl' _url="posts" _handle="video_category"}
              {/foreach}
            {else}
              <tr>
  ...
  {elseif $sub_view == "edit_category"}
    ...
    <form class="js_ajax-forms" data-url="admin/posts.php?do=edit_category&id={$data['category_id']}">
      <div class="card-body">
        <div class="row form-group">
          <label class="col-md-3 form-label">
            {__("Name")}
