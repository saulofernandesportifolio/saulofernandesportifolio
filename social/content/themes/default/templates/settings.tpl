      ...
      <div class="card">
        <div class="card-body with-nav">
          <ul class="side-nav">
            ...
            {if $system['packages_enabled'] || $user->_data['can_monetize_content'] || $user->_data['can_invite_users'] || $system['affiliates_enabled'] || $system['points_enabled'] || $user->_data['can_raise_funding'] || $system['coinpayments_enabled'] || $system['bank_transfers_enabled']}
              <div class="divider mtb5"></div>
            {/if}
