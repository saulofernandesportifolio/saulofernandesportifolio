      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-12 col-md-5 mb20">
            <ul class="list-group">
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$data['event_id']}</span>
                {__("Event ID")}
              </li>
              <li class="list-group-item">
          ...
          <div class="col-12 col-md-5 mb20">
            <ul class="list-group">
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$data['event_interested']}</span>
                {__("Interested")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$data['event_going']}</span>
                {__("Going")}
              </li>
              <li class="list-group-item">
                <span class="float-end badge badge-lg rounded-pill badge-secondary">{$data['event_invited']}</span>
                {__("Invited")}
              </li>
            </ul>
          </div>
