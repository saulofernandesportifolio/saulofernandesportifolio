...
try {
  ...
  $inputs['tips_enabled'] = ($_POST['handle'] != 'page' && $user->_data['can_receive_tip'] && $_POST['tips_enabled'] == "true") ? '1' : '0';
  if ($_POST['handle'] == 'user') {
    ...
    if ($user->_data['can_add_anonymous_posts'] && $_POST['handle'] == 'me' && $_POST['is_anonymous'] == "true") {
