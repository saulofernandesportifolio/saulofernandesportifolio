...
try {
  ...
  switch ($_GET['edit']) {
    case 'account':
      ...
      // return
      return_json(array('success' => true, 'message' => __("Your account settings have been updated")));
      break;
    ...
    case 'basic':
      ...
      if (is_null($_POST['birth_month_companions'])){
        ...
        $_POST['birth_year_companions'] = 'none';     
      }
      ...
      // return
      return_json(array('success' => true, 'message' => __("Your profile info have been updated")));
      break;
    ...
    case 'membership':
      ...
      // return
      return_json(array('success' => true, 'message' => __("Your membership settings have been updated")));
      break;
    ...
    case 'monetization':
      ...
      // return
      return_json(array('success' => true, 'message' => __("Your monetization settings have been updated")));
      break;
