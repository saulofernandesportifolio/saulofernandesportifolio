...
Route::get('historic/recebido/{id}','Admin\BalancoController@recebidoStore')->name('recebido.store');
...
Route::get('historic/excluir/{id}', 'Admin\BalancoController@historicexcluir')->name('historic.excluir');
