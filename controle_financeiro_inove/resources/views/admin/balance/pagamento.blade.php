...
<div class="box">
        ...
        <div class="box-body">    
            ...
            <form action="{{ url('admin/pagar') }}" method="POST">
                {!! csrf_field() !!}
                <div class="form-group">
                <div class="input-group" class="form-control">
                    <span class="input-group-addon">R$</span>
                    <input type="text" name="valor" class="form-control" placeholder="Valor do pagamento somente numeros">
                ...
                <div class="form-group">
                    <input type="text" name="Descricao_do_Pagamento" class="form-control" placeholder="Descrição do Pagamento">
                </div>
                <div class="form-group">
