...
$sql = "SELECT  a.id_cotacao,
                ...
                WHERE a.carteira ='$canal' and 
                      b.status_cip_correcao IN ($status_cip_correcao) and
...
<form name="form1" action="../forms/formdetalhes_visao_cotacao_correcao2.php" method="post" id="frm-filtro">
...
$cor = '#464646';
 ...
 $sql = "SELECT a.id_cotacao,
               ...
               WHERE a.carteira = '$canal' and 
                      b.status_cip_correcao IN ($status_cip_correcao) and
                      ( a.dt_inclusao_bd_cip2 BETWEEN '".arrumadata($data_1)."' AND '".arrumadata($data_2)."' )  
         GROUP BY a.cotacao_principal
...
?>
     <tr>
     <td> <td class="tdconteudo"><?php echo "$revisao"?></td>
