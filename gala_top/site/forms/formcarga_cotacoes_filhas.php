...
$id_cotacao       = $linha_cota['id_cotacao'];
      ...
      //Monta SQL para select
       $sql ="SELECT * FROM tbl_cotacao a INNER JOIN tbl_input b
              ON a.id_cotacao='$id_cotacao' 
              WHERE b.idtbl_usuario_input ='$idtbl_usuario' OR b.idtbl_usuario_input <> '$idtbl_usuario' 
...
<form style="background:#E7E4D1;" class="bradius" action="principal.php?id_cotacao=<?php echo $id_cotacao ?>&t=controles/sql_importar_cotacoes_filhas.php" method="post" enctype="multipart/form-data" name="form1" >
  ...
  <p align="center">
	...
	<input type="button" name="Submit2" value="Cancelar" onclick="window.location='principal.php'" class="sb2 bradius"/>
