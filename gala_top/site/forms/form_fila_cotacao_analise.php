...
$teste=include "site/controles/sql_fila_cotacoes_analise.php";
if(empty($teste))
{
...
if($status_cip =='4' || $status_correcao =='25'){
...
?>
  <tr bgcolor="#f5f5f5"> 
    <td class="tdconteudo"><?php echo "<a href='principal.php?id_cotacao=$id_cotacao&t=forms/form_cotacoes_analise.php'>$cotacao_principal</a>"; ?></td>
