...
if(empty($totalaprovado)){
 ...
 $total_geral=$total/($totalreprovado)*100;

 $total_geral2=$total/($totalaprovado)*100;
...
$(function () {
    ...
    $('#containerg1').highcharts({
        ...
        title: {
            text: '<?php echo utf8_encode("Backlog")?>',
           style: {
              font: '9',
              fontFamily: 'Gotham Light'
        ...
        series: [{
            ...
            colorByPoint: true,
             data: [{
                name: 'Dentro',
                y: <?php echo $total_geral2 ?>,
                drilldown: 'Aprovado'
               
            }, {
                name: 'Fora',
                y:<?php echo $total_geral ?>,
                drilldown: 'Reprovado'
...
<div id="containerg1" style="min-width:300; height:250; margin-left: 0px;"></div>
