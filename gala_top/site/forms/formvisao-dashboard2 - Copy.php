...
$sql3="SELECT c.setor,c.id_cotacao,d.SLA_DIAS 
       FROM tbl_analise c 
...
UNION 
SELECT c.setor,c.id_cotacao,d.SLA_DIAS 
FROM tbl_input c
  INNER JOIN tbl_cotacao d
       ON c.id_cotacao=d.id_cotacao
       WHERE d.dt_inclusao_bd_cip2 BETWEEN '$data_1' AND '$data_2' 
...
$venced3=0;
 ...
 $query_linha="UPDATE tbl_acumulada a SET a.vence_hoje  ='$Hoje',
                                         a.vence_D_1   ='$vence1',
                                         a.vence_D_2   ='$vence2',
