...
$data_2=arrumadata2($_POST['data_2']);
 ...
 echo $sql="CALL visao_chamado_redistribuicao("."'{$_POST['statuschamado']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
}elseif(!empty($_POST['n_da_cotacao'])){

 $sql="CALL visao_chamado_redistribuicao("."'{$_POST['statuschamado']}'".","."'{$substatusvivocorp}'".","."'{$_POST['n_da_cotacao']}'".","."'{$data_1}'".","."'{$data_2}'".")";
