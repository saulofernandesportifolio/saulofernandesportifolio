...
$sql = "SELECT  a.id_cotacao,
                ...
                WHERE a.carteira = '$canal' and 
                      b.status_cip_auditoria IN ($status_cip_auditoria) and
                      ( b.dt_distribuicao BETWEEN '".arrumadata($data_1)."' AND '".arrumadata($data_2)."' )   
        GROUP BY a.cotacao_principal
        ORDER BY a.id_cotacao DESC,b.dt_distribuicao LIMIT 0,20000 ";
...
<form name="form1" action="../forms/formdetalhes_visao_cotacao_auditoria2.php" method="post" id="frm-filtro">

<p align="center"><b><font color="#a0873c" size="5" face="Gotham Light">Auditoria</font></b></p>
<br />
