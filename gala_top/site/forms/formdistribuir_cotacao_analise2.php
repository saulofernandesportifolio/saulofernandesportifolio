      ...
      function SomaDiasUteis($xDataInicial,$xSomarDias){
         for($ii=0; $ii<=$xSomarDias; $ii++){
            ...
            if(date("w", dataToTimestamp($xDataInicial))=="5"){
                    ...
                    //SE DIA FOR SABADO, SOMA -1
               $xDataInicial=Soma1diasetxta($xDataInicial);
...
$sql = "SELECT  a.id_cotacao,
         ...
         GROUP BY a.criado_em,a.id_cotacao ASC LIMIT 0,2000 ";
...
?>
  ...
  <br />
<p>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?t=forms/formdistribuir_cotacao_analise.php'" class="sb2 bradius" />
