...
if(empty($sup) || empty($setor) || empty($turno)){
 ...
 $sql = "SELECT * FROM tbl_usuarios WHERE perfil NOT IN (1,4) and id_supervisor LIKE '$sup%' and perfil LIKE '$setor%' and status NOT IN (0)               
...
<p align="center"><b><font color="#a0873c" size="5" face="Gotham Light">Desativar Usuários</font></b></p>
<br />
