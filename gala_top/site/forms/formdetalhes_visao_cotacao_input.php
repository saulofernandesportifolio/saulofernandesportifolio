...
$sql = "SELECT  a.id_cotacao,
                ...
                WHERE a.carteira = '$canal' and 
                      b.status_cip_input IN ($status_cip_input) and 
...
<form name="form1" action="../forms/formdetalhes_visao_cotacao_input2.php" method="post" id="frm-filtro">
...
while($linha_atv = mysql_fetch_assoc($acao))
{
  ...
  $usuario_analise      = $linha_atv["idtbl_usuario_input"];
