...
$sql = "SELECT * FROM tbl_usuarios WHERE perfil NOT IN (4) and id_supervisor LIKE '{$_POST['sup']}' and perfil LIKE '{$_POST['setor']}'              
...
<form name="form1" method="post" action="principal.php?&t=forms/formeditar_usuarios2.php" id="frm-filtro">

<p align="center"><b><font color="#a0873c" size="5" face="Gotham Light">Editar Usuários</font></b></p>
<br />

<p><font color="#a0873c" size="4" face="Gotham Light"><strong>Lista de <?php echo $num ?> usuários</strong></font></p>
<br />
...
?>
  ...
  <br />
<p>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?&t=forms/formfiltro_edita_usuario.php'" class="sb2 bradius" />
