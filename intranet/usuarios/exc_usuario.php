...
<center><p>Você tem certeza que deseja excluir este usuário?</p>
<table class="no_format"><tr>
<td colspan="2"><form id="exc_usuario" method="post" action="usuarios/envia_usuario.php?action=exclusao"></td></tr>
