<?php 
require_once '../fixa_top/app/Model/SolicitacaoPreTramitacao.php';
require_once '../fixa_top/app/Model/SolicitacaoTramitacao.php';
require_once '../fixa_top/app/Model/SolicitacaoPosTramitacao.php';
//cria objeto
