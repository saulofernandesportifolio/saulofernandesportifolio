...
<select 
    name="mesRelatorioTramitacao" 
    id="mesRelatorioTramitacao"  
...
$(document).ready(function() {
  ...
  document.title = 'Tramitação' + ' ' + getCurrentDate();
...
<table border="0" id="tabela3"  width="auto" class="display table_tramitacao">
        <thead>
            <tr>
              <th>Data Preenchimento Tramitação</th> 
              <th>Operador</th>                   
              <th>Siscom/Protocolo</th>                     
              <th>Data Entrada Siscom</th>
              <th>Data receb. solicitação</th>          
              <th>Canal Entrada</th>               
              <th>Produto</th>                    
              <th>Serviço</th>                   
