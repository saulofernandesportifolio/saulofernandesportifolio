...
<body>
	<div class="div_forms" id="form_solicitacao_manual">
		...
		<button onclick="gerarProtocoloSolicitacao('apoio')" style="color: white; width: 5%; margin-top: 0%; background-color: #7b682e" type="button" id="avancar_solicitacao_manual">Avançar</button>
	</div>
	<div id="solicitacao_manual_nova" style="display: none"> 
	    ...
	    <label class="textoParagrafo">Data recebimento/retorno da solicitação*:</label>
			<input 
				...
				required
			>
			<input name="bt_enviar" onclick="enviarSolicitacao(this, '<?php echo $id_usuario?>', 'solicitacao_manual', 'apoio');" id="bto_enviar" type="button" value="Salvar" class="sb2 bradius" />
	</div>
