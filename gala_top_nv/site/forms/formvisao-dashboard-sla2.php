...
$(function () {
    ...
    $('#containersla2').highcharts({
        ...
        title: {
            text: '<?php echo utf8_encode("Trocas"); ?>',
           style: {
              font: '9',
              fontFamily: 'Gotham Light'
...
<div id="containersla2" style="min-width:170px; height:170px; margin-left: 0px;"></div>
