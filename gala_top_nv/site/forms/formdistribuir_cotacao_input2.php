...
<p align="center"><b><font color="#a0873c" size="5" face="Gotham Light">Input</font></b></p>
<br />

<p><font color="#a0873c" size="5" face="Gotham Light"><strong>Lista de Cotações a distribuir</strong></font></p>
<br />
...
$sql = "SELECT a.id_cotacao,
                ...
                WHERE carteira LIKE '$canal' and 
                      b.status_cip_input in(7,27) and a.id_cotacao='$id_cotacao' 
         GROUP BY a.criado_em,a.id_cotacao ASC LIMIT 0,20000 ";
...
?>
  ...
  <br />
<p>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?t=forms/formdistribuir_cotacao_input.php'" class="sb2 bradius" />
