...
$atv_op="SELECT count(a.substatus_da_cotacao)as total,
 ...
 switch($PRAZO_DIAS){
     ...
     case 'Fora do prazo': /*echo "aprovado:".*/ $totalreprovado= $total*100; 
                                 
            //echo '<br\>';
             break;
           
     case 'Dentro do prazo': /*echo "aprovado:".*/ $totalaprovado= $total*100; 
...
$(function () {
    ...
    $('#containerg2').highcharts({
        ...
        title: {
            text: '<?php echo utf8_encode("Visão Sla"); ?>',
           style: {
              font: '9',
              fontFamily: 'Gotham Light'
...
<div id="containerg2" style="min-width:300px; height:250px; margin-left: 0px;"></div>
