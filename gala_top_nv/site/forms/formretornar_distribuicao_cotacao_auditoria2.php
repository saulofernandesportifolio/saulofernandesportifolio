...
<form name="form1" method="post" action="principal.php?&t=controles/sql_retornardistribuicao_cotacao_auditoria4.php" id="frm-filtro">
...
while($linha_atv = mysql_fetch_assoc($acao))
{
  ...
  $datater              = $linha_atv["dt_tratamento_auditoria"];
...
if($status_cip != 13 AND $status_cip != 14){
$data2=$datater;
