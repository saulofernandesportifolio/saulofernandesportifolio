...
Chamado
<input type="radio" value="5" align="LEFT"  name="filtro" id="5" title="correcao" />
</p>   
...
while($linha_atv = mysql_fetch_assoc($acao))
{
 $id_cotacao           = $linha_atv["id_cotacao"];
  ...
  $datater              = $linha_atv["dt_tratamento_chamado"];
...
$cor = '#464646';
 ...
 $sql = "SELECT a.id_cotacao,
               ...
               ON c.idtbl_usuario='$usuario_chamado'                               
               WHERE b.id_cotacao='$id_cotacao' 
        GROUP BY a.cotacao_principal,a.revisao
         ORDER BY a.id_cotacao,b.dt_distribuicao,a.cotacao_principal DESC LIMIT 0,20000";
