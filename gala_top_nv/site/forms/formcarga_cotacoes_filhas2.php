...
$id_cotacao       = $linha_cota['id_cotacao'];
      ...
      //Monta SQL para select
       $sql ="SELECT * FROM tbl_cotacao a INNER JOIN tbl_correcao b
              ON a.id_cotacao='$id_cotacao' 
              WHERE b.idtbl_usuario_correcao ='$idtbl_usuario' OR b.idtbl_usuario_correcao <> '$idtbl_usuario' 
...
<form style="background:#E7E4D1;" class="bradius" action="principal.php?id_cotacao=<?php echo $id_cotacao ?>&t=controles/sql_importar_cotacoes_filhas2.php" method="post" enctype="multipart/form-data" name="form1" >
