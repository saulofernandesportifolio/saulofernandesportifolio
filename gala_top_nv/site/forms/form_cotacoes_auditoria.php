...
<label style="padding-left: 5px;">Principal:&nbsp;<a href="javascript:abrir('site/forms/form_cotacoes_auditoria_tipo_de_erros.php?id_auditoria=<?php echo $id_auditoria ?>');"><?php echo $cotacao_principal; ?></a></label>
<?php }else ?>
<?php if($cotacao_principal != $n_da_cotacao){ ?>
<label style="padding-left: 5px;">Principal:&nbsp;<?php echo $cotacao_principal; ?></a></label>

<label style="padding-left: 5px;">Complementar:&nbsp;<a href="javascript:abrir('site/forms/form_cotacoes_auditoria_tipo_de_erros.php?id_auditoria=<?php echo $id_auditoria ?>');"><?php echo $n_da_cotacao; ?></a></label>
<?php } ?>
...
<select name="substatus" id="substatus" onblur="ValidaEntrada(this,'combo');" class="txt2comboboxpadrao bradius">
  ...
  //seleciona a base de dados para uso
   $query= "SELECT * FROM tbl_substatus WHERE setor='auditoria' ORDER BY id_status";
...
<select name="motivodaacao" id="motivodaacao" onblur="ValidaEntrada(this,'combo');" class="txt2comboboxpadrao bradius">
  ...
  //seleciona a base de dados para uso
   $query= "SELECT * FROM tbl_motivos_da_acao where setor='auditoria' ORDER BY id";
   $result= mysql_query($query,$conecta);
   while($dado= mysql_fetch_array($result)){
