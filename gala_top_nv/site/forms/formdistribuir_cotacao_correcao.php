...
$sql="CALL visao_correcao_distribuicao("."'20'".")";
...
?>
   ...
   <td class="tdconteudo"><?php echo "$cotacao_principal"?></td>
    ...
    <td class="tdconteudo"><?php echo "$TIPO_COTACAO" ?></td>
     ...
     <td><a href="principal.php?id_cotacao=<?php echo $id_cotacao ?>&t=forms/formdistribuir_cotacao_servico1_correcao.php">ABRIR</a>
