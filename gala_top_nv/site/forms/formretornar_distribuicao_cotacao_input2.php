...
<form name="form1" method="post" action="principal.php?&t=controles/sql_retornardistribuicao_cotacao_input4.php" id="frm-filtro">
...
$id_cotacao           = $linha_atv["id_cotacao"];
  ...
  $datater              = $linha_atv["dt_tratamento_input"];
...
$cor = '#464646';
 ...
 $sql = "SELECT a.id_cotacao,
               ...
               ON c.idtbl_usuario='$usuario_input'                               
               WHERE  b.id_cotacao='$id_cotacao'  
        GROUP BY a.cotacao_principal,a.revisao
         ORDER BY a.id_cotacao,a.dt_inclusao_bd_cip,a.cotacao_principal DESC LIMIT 0,20000";
...
if($status_cip != 7 AND $status_cip != 8 ){
$data2=$datater;
