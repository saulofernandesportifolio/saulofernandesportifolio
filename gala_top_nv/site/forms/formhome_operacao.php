 ...
 <head> 
    <meta http-equiv="refresh" content="30;url=principal.php?&filtro=<?php echo $filtro ?>&filtro2=<?php echo $filtro2 ?>&filtro3=<?php echo $filtro3 ?>&t=forms/formhome_operacao.php"/>
    </head>
...
<form name="myform" method="post" action="principal.php?&filtro=<?php echo $filtro ?>&filtro2=<?php echo $filtro2 ?>&filtro3=<?php echo $filtro3 ?>&t=forms/formhome_operacao.php">
...
if($canal == '%' ){
 ...
 $usuario_op="SELECT a.idtbl_usuario,
              ...
              CASE 
                  ...
                  END AS perfil 
              FROM tbl_usuarios a
            WHERE  a.perfil NOT IN(1,4) and a.perfil LIKE '%$filtro%' and a.situacao2 IS NOT NULL and a.turno LIKE '$filtro2%' and a.situacao2 LIKE '$filtro3%' and  a.status=1
...
<?php
 ...
 $usuario_op="SELECT a.idtbl_usuario,
              ...
              CASE
                  ...
                  END AS perfil 
              FROM tbl_usuarios a
            WHERE  a.perfil NOT IN(1,4) and a.perfil LIKE '%$filtro%' and a.situacao2 IS NOT NULL and a.turno LIKE '$filtro2%' and a.situacao2 LIKE '$filtro3%' a.status=1
            ORDER BY a.nome,a.situacao";
$acao_op=mysql_query($usuario_op,$conecta);
