...
$teste=include "site/controles/sql_fila_cotacoes_chamado.php";
if(empty($teste))
{
...
<p>Voc&ecirc; tem um total de <?php echo "$num_ cota&ccedil;&otilde;es"?> 
  ...
  <form method="POST" action="exemplo.html" id="frm-filtro">
   ...
   <br /><br /><br /><br />
    ...
    <th>STATUS SLA</th>
    <th>SLA DIAS</th>
    <th><?php echo utf8_encode('SUB-STATUS COTAÇÃO')?></th>
    <th>STATUS CIP</th> 
    <th>TIPO LINHA</th>
    <th>TOTAL LINHAS</th>
    <th>TIPO</th>
    <th>CLIENTE</th>
    <th><?php echo utf8_encode('TIPO COTAÇÃO') ?></th> 
...
?>
  <tr bgcolor="#f5f5f5"> 
   <td class="tdconteudo"><?php echo "<a href='principal.php?id_cotacao=$id_cotacao&t=forms/form_cotacoes_chamado.php'>$cotacao_principal</a>"; ?></td>
    <td class="tdconteudo"><?php echo "<a href='principal.php?id_cotacao=$id_cotacao&t=forms/form_cotacoes_chamado.php'>$n_da_cotacao</a>"; ?></td>
