...
<h3 align="center">RESUMO PRODU&Ccedil;&Atilde;O</h3>
  ...
  $sql = 'call pivotwizard("c.nome,b.setor" ,"date_format(b.dt_tratamento_analise,\'%d/%m\')","1", "tbl_cotacao a,tbl_analise b,tbl_usuarios c", "a.id_cotacao=b.id_cotacao and b.idtbl_usuario_analise=c.idtbl_usuario" );';
  criaPivotTable($sql, "Tipo");
 }
 elseif($_POST['setor']==2){
   mysql_query("SET lc_time_names = 'pt_BR';");
  $sql = 'call pivotwizard("c.nome,b.setor" ,"date_format(b.dt_tratamento_input,\'%d/%m\')","1", "tbl_cotacao a,tbl_input b,tbl_usuarios c", "a.id_cotacao=b.id_cotacao and b.idtbl_usuario_input=c.idtbl_usuario" );';
  criaPivotTable($sql, "Tipo");
 }
 elseif($_POST['setor']==3){
   mysql_query("SET lc_time_names = 'pt_BR';");
  $sql = 'call pivotwizard("c.nome,b.setor" ,"date_format(b.dt_tratamento_auditoria,\'%d/%m\')","1", "tbl_cotacao a,tbl_auditoria b,tbl_usuarios c", "a.id_cotacao=b.id_cotacao and b.idtbl_usuario_auditoria=c.idtbl_usuario" );';
  criaPivotTable($sql, "Tipo");
 } 
 elseif($_POST['setor']==4){
 
   mysql_query("SET lc_time_names = 'pt_BR';");
 $sql = 'call pivotwizard("c.nome,b.setor" ,"date_format(b.dt_tratamento_correcao,\'%d/%m\')","1", "tbl_cotacao a,tbl_correcao b,tbl_usuarios c", "a.id_cotacao=b.id_cotacao and b.idtbl_usuario_correcao=c.idtbl_usuario" );';
   criaPivotTable($sql, "Tipo");
