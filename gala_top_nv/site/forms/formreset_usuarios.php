...
$sql = "SELECT * FROM tbl_usuarios WHERE perfil NOT IN (4) and id_supervisor LIKE '$sup' and perfil LIKE '$setor'                 
...
<form name="form1" method="post" action="principal.php?&t=forms/formreset_usuarios2.php" id="frm-filtro">

<p align="center"><b><font color="#a0873c" size="5" face="Gotham Light">Reset Usuários</font></b></p>
<br />
...
?>
  ...
  <br />
<p>
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?t=forms/formfiltro_reset_usuario.php'" class="sb2 bradius" />
