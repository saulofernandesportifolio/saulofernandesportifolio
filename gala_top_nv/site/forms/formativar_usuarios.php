...
$sql = "SELECT * FROM tbl_usuarios 
        WHERE perfil NOT IN (1,4) and id_supervisor LIKE '$sup' and perfil LIKE '$setor' and status IN (0)                
...
<form name="form1" method="post" action="principal.php?&t=forms/formativar_usuarios2.php" id="frm-filtro">
...
<input type="hidden" name="setor" value=<?php echo $setor; ?> >
  ...
  <input type="button" name="Submit2" value="Voltar" onclick="window.location='principal.php?filtro=%&t=forms/formfiltro_ativar_usuario.php'" class="sb2 bradius" />
