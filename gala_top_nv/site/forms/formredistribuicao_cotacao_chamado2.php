...
<form name="form1" method="post" action="principal.php?&t=controles/sql_redistribuicao_cotacao_chamado4.php" id="frm-filtro">
...
$sql = "SELECT  a.id_cotacao,
                ...
                WHERE b.status_cip_chamado NOT IN (30) and a.id_cotacao='$id_cotacao' 
...
while($linha_atv = mysql_fetch_assoc($acao))
{
  ...
  $usuario_analise      = $linha_atv["idtbl_usuario_chamado"];
...
$cor = '#464646';
 ...
 $sql = "SELECT a.id_cotacao,
               ...
               WHERE a.carteira LIKE '$canal%' and 
                      b.status_cip_chamado NOT IN (30)  
