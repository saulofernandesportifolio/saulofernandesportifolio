...
$sql="CALL visao_auditoria_distribuicao("."'13'".")";
...
<p align="center"><b><font color="#a0873c" size="5" face="Gotham Light">Análise de input</font></b></p>
<br />
...
?>
    ...
    <td class="tdconteudo"><?php echo "$TIPO_COTACAO" ?></td>
       ...
       <td><a href="principal.php?id_cotacao=<?php echo $id_cotacao ?>&t=forms/formdistribuir_cotacao_servico1_auditoria.php">ABRIR</a>
   
   
    </td>
	<td>
    <a href="principal.php?id_cotacao=<?php echo $id_cotacao ?>&t=controles/sql_excluir_distribuicao_cotacao_auditoria.php">EXCLUIR</a></td>   

    </tr>
    <?php

    //header("principal.php?&t=controles/sql.sla.php"); 
