...
$sql = "SELECT * FROM ativos a  INNER JOIN tbl_usuarios b 
...
<p><font color="#a0873c" size="4" face="Gotham Light"><strong>Lista de <?php echo $num ?> usuários para criação de acesso com sucesso</strong></font></p>
<br />
