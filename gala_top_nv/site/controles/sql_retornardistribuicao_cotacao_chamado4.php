...
$acao_delete1 = mysql_query($sql_delete1) or die (mysql_error()); 
$sql_delete1 = "DELETE FROM tbl_chamado 
					WHERE id_cotacao = $id_cotacao";
...
echo utf8_encode("<script>alert('Pedidos distribuidos para o login: $nome'); 
	              alert('Data/Hora De Retorno Distribuição: $dt_distribuicao2');	
	               document.location.replace('principal.php?t=forms/formretornar_distribuicao_cotacao_correcao.php');
                  </script>\n");
	exit;
