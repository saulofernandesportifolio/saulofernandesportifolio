...
else
{
  ...
  if($_POST['setor_user'] == 1){
     ...
     $disc_perfil="Supervisor";   
       ...
       $usuario_op="SELECT * FROM ativos WHERE id ='$id'";
       ...
       $sql_inserir ="INSERT INTO tbl_usuarios(usuario,
                                                   senha,
                                                    nome,
                                                  perfil,
                                             disc_perfil,
              ...
              $sql_update ="UPDATE ativos 
                      SET fila=1 
                      WHERE id='$id' ";
              $result1 = mysql_query($sql_update) or die(mysql_error());  
