...
$sql_verifca = "SELECT a.id_cotacao,
                ...
                WHERE a.carteira LIKE '%' and 
                       b.status_cip_chamado = 30 
                       OR b.status_cip_chamado = 31 and  idtbl_usuario_chamado = '{$_COOKIE['idtbl_usuario']}' 
                       OR b.status_cip_chamado = 33 and  idtbl_usuario_chamado = '{$_COOKIE['idtbl_usuario']}'
