 ...
 */
    ...
    $sql_atualiza2 ="SELECT * FROM tbl_cotacao a 
                    ...
                    ON a.id_cotacao=b.id_cotacao
                     WHERE a.carteira LIKE '$canal%' and b.status_cip_correcao = 20 and a.id_cotacao= '$id_cotacao'";
    ...
    $sql = "DELETE FROM tbl_correcao
    WHERE id_cotacao=' $id_cotacao2'
    and status_cip_auditoria = 20";
    
     $acao = mysql_query($sql) or die (mysql_error());
     
    $sql = "DELETE FROM tbl_input 
    WHERE id_cotacao=' $id_cotacao2'";
